...
- `reasoning_delta`, `reasoning_complete`, `assistant_image_appended`,
  ...
  `interaction_callback_pending`, `peer_content_ingested`,
  `provider_cache_breakpoints_discarded`, and `boundary_append_applied` are
  inventory-known but have no typed
