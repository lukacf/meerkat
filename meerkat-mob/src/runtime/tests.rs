...
struct MobRuntimeParitySnapshotSummary {
    ...
    member_startup_binding_requested: BTreeSet<String>,
    member_startup_runtime_ready: BTreeSet<String>,
    ...
    member_kickoff_error: BTreeMap<String, String>,
...
async fn mob_runtime_parity_snapshot_summary(
    ...
    let startup_kickoff = handle.debug_startup_kickoff_snapshot().await.ok();
    ...
    let startup_kickoff = startup_kickoff.unwrap_or_default();
    formal_available_fields.insert(
        "member_startup_binding_requested".into(),
        serde_json::to_string(&startup_kickoff.member_startup_binding_requested)
            .expect("serialize member_startup_binding_requested"),
    );
    formal_available_fields.insert(
        "member_startup_runtime_ready".into(),
        serde_json::to_string(&startup_kickoff.member_startup_runtime_ready)
            .expect("serialize member_startup_runtime_ready"),
    );
    formal_available_fields.insert(
        "member_startup_ready".into(),
        serde_json::to_string(&startup_kickoff.member_startup_ready)
            .expect("serialize member_startup_ready"),
    );
    formal_available_fields.insert(
    ...
    formal_available_fields.insert(
        "member_kickoff_starting".into(),
        serde_json::to_string(&startup_kickoff.member_kickoff_starting_ids)
    ...
    formal_available_fields.insert(
        "member_kickoff_failed".into(),
        serde_json::to_string(&startup_kickoff.member_kickoff_failed_ids)
            .expect("serialize member_kickoff_failed"),
    );
    formal_available_fields.insert(
        "member_kickoff_cancelled".into(),
        serde_json::to_string(&startup_kickoff.member_kickoff_cancelled_ids)
            .expect("serialize member_kickoff_cancelled"),
    );
    formal_available_fields.insert(
        "member_kickoff_error".into(),
        serde_json::to_string(&startup_kickoff.member_kickoff_error)
            .expect("serialize member_kickoff_error"),
    );
    ...
    Some(MobRuntimeParitySnapshotSummary {
        ...
        member_kickoff_error: startup_kickoff.member_kickoff_error,
...
fn mob_runtime_parity_field_value(
    ...
    match field {
        ...
        "member_startup_binding_requested" => Some(MobRuntimeParityExprValue::Set(
            snapshot.member_startup_binding_requested.clone(),
        )),
        "member_startup_runtime_ready" => Some(MobRuntimeParityExprValue::Set(
            snapshot.member_startup_runtime_ready.clone(),
        )),
        "member_startup_ready" => Some(MobRuntimeParityExprValue::Set(
            snapshot.member_startup_ready.clone(),
        )),
        "member_kickoff_pending" => Some(MobRuntimeParityExprValue::Set(
            snapshot.member_kickoff_pending.clone(),
        )),
        ...
        "member_kickoff_failed" => Some(MobRuntimeParityExprValue::Set(
            snapshot.member_kickoff_failed.clone(),
        )),
        "member_kickoff_cancelled" => Some(MobRuntimeParityExprValue::Set(
            snapshot.member_kickoff_cancelled.clone(),
        )),
        "member_kickoff_error" => Some(MobRuntimeParityExprValue::Map(
            snapshot
