...
CONSTANTS AdmissionEffectValues, AsyncOpRefValues, BooleanValues, ContentShapeValues, HandlingModeValues, NatValues, OperationIdValues, RequestIdValues, ReservationKeyValues, RunIdValues, StringValues, SurfaceDeltaOperationValues, SurfaceIdValues, TurnNumberValues, WorkIdValues
...
VARIABLES external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_surface_completion, obligation_surface_snapshot_alignment, model_step_count, pending_inputs, observed_inputs, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs
vars == << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_surface_completion, obligation_surface_snapshot_alignment, model_step_count, pending_inputs, observed_inputs, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
BaseInit ==
    ...
    /\ external_tool_surface_staged_intent_sequence = [x \in {} |-> None]
    /\ external_tool_surface_next_staged_intent_sequence = 1
    /\ external_tool_surface_pending_task_sequence = [x \in {} |-> None]
    /\ external_tool_surface_pending_lineage_sequence = [x \in {} |-> None]
    /\ external_tool_surface_next_pending_task_sequence = 1
    ...
    /\ external_tool_surface_snapshot_epoch = 0
    /\ external_tool_surface_snapshot_aligned_epoch = 0
    ...
    /\ obligation_surface_completion = {}
    /\ obligation_surface_snapshot_alignment = {}
    /\ model_step_count = 0
    /\ pending_routes = <<>>
    /\ delivered_routes = {}
    /\ emitted_effects = {}
...
WitnessInit_surface_completion_feedback ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<[machine |-> "external_tool_surface", variant |-> "StageAdd", payload |-> [surface_id |-> "default_surface"], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:2", source_machine |-> "external_entry", source_effect |-> "StageAdd", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "StartConversationRun", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:3", source_machine |-> "external_entry", source_effect |-> "StartConversationRun", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "PrimitiveApplied", payload |-> [admitted_content_shape |-> "TextOnly", image_tool_results_enabled |-> FALSE, run_id |-> "runid_1", vision_enabled |-> FALSE], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:4", source_machine |-> "external_entry", source_effect |-> "PrimitiveApplied", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "LlmReturnedTerminal", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:5", source_machine |-> "external_entry", source_effect |-> "LlmReturnedTerminal", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "BoundaryComplete", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:6", source_machine |-> "external_entry", source_effect |-> "BoundaryComplete", effect_id |-> 0], [machine |-> "external_tool_surface", variant |-> "PendingSucceeded", payload |-> [applied_at_turn |-> "turn_1", operation |-> "Add", pending_task_sequence |-> 1, staged_intent_sequence |-> 1, surface_id |-> "default_surface"], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:7", source_machine |-> "external_entry", source_effect |-> "PendingSucceeded", effect_id |-> 0], [machine |-> "external_tool_surface", variant |-> "SnapshotAligned", payload |-> [snapshot_epoch |-> 1], source_kind |-> "entry", source_route |-> "witness:surface_completion_feedback:8", source_machine |-> "external_entry", source_effect |-> "SnapshotAligned", effect_id |-> 0]>>
...
external_tool_surface__PendingLineageSequence(surface_id) == (IF ~((surface_id \in DOMAIN external_tool_surface_pending_lineage_sequence)) THEN 0 ELSE (IF surface_id \in DOMAIN external_tool_surface_pending_lineage_sequence THEN external_tool_surface_pending_lineage_sequence[surface_id] ELSE 0))

external_tool_surface__PendingTaskSequence(surface_id) == (IF ~((surface_id \in DOMAIN external_tool_surface_pending_task_sequence)) THEN 0 ELSE (IF surface_id \in DOMAIN external_tool_surface_pending_task_sequence THEN external_tool_surface_pending_task_sequence[surface_id] ELSE 0))

external_tool_surface__StagedIntentSequence(surface_id) == (IF ~((surface_id \in DOMAIN external_tool_surface_staged_intent_sequence)) THEN 0 ELSE (IF surface_id \in DOMAIN external_tool_surface_staged_intent_sequence THEN external_tool_surface_staged_intent_sequence[surface_id] ELSE 0))
...
external_tool_surface_StageAdd(arg_surface_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ external_tool_surface_staged_intent_sequence' = MapSet(external_tool_surface_staged_intent_sequence, packet.payload.surface_id, external_tool_surface_next_staged_intent_sequence)
       /\ external_tool_surface_next_staged_intent_sequence' = (external_tool_surface_next_staged_intent_sequence + 1)
       /\ UNCHANGED << external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       ...
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
...
external_tool_surface_ApplyBoundaryAdd(arg_surface_id, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ (external_tool_surface__PendingOp(packet.payload.surface_id) = "None")
       ...
       /\ external_tool_surface_staged_intent_sequence' = MapSet(external_tool_surface_staged_intent_sequence, packet.payload.surface_id, 0)
       /\ external_tool_surface_pending_task_sequence' = MapSet(external_tool_surface_pending_task_sequence, packet.payload.surface_id, external_tool_surface_next_pending_task_sequence)
       /\ external_tool_surface_pending_lineage_sequence' = MapSet(external_tool_surface_pending_lineage_sequence, packet.payload.surface_id, external_tool_surface__StagedIntentSequence(packet.payload.surface_id))
       /\ external_tool_surface_next_pending_task_sequence' = (external_tool_surface_next_pending_task_sequence + 1)
       ...
       /\ UNCHANGED << external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_next_staged_intent_sequence, external_tool_surface_inflight_calls, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       ...
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "external_tool_surface", variant |-> "ScheduleSurfaceCompletion", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Add", pending_task_sequence |-> external_tool_surface__PendingTaskSequence(packet.payload.surface_id), staged_intent_sequence |-> external_tool_surface__PendingLineageSequence(packet.payload.surface_id), surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "ApplyBoundaryAdd"], [machine |-> "external_tool_surface", variant |-> "EmitExternalToolDelta", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Add", persisted |-> FALSE, phase |-> "Pending", surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "ApplyBoundaryAdd"] }
       ...
       /\ obligation_surface_completion' = obligation_surface_completion \cup {[surface_id |-> packet.payload.surface_id, operation |-> "Add", pending_task_sequence |-> external_tool_surface__PendingTaskSequence(packet.payload.surface_id), staged_intent_sequence |-> external_tool_surface__PendingLineageSequence(packet.payload.surface_id), applied_at_turn |-> packet.payload.applied_at_turn]}
       /\ UNCHANGED << obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1
...
external_tool_surface_ApplyBoundaryReload(arg_surface_id, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "external_tool_surface", variant |-> "ScheduleSurfaceCompletion", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Reload", pending_task_sequence |-> external_tool_surface__PendingTaskSequence(packet.payload.surface_id), staged_intent_sequence |-> external_tool_surface__PendingLineageSequence(packet.payload.surface_id), surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "ApplyBoundaryReload"], [machine |-> "external_tool_surface", variant |-> "EmitExternalToolDelta", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Reload", persisted |-> FALSE, phase |-> "Pending", surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "ApplyBoundaryReload"] }
       ...
       /\ obligation_surface_completion' = obligation_surface_completion \cup {[surface_id |-> packet.payload.surface_id, operation |-> "Reload", pending_task_sequence |-> external_tool_surface__PendingTaskSequence(packet.payload.surface_id), staged_intent_sequence |-> external_tool_surface__PendingLineageSequence(packet.payload.surface_id), applied_at_turn |-> packet.payload.applied_at_turn]}
       /\ UNCHANGED << obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1
...
external_tool_surface_ApplyBoundaryRemoveDraining(arg_surface_id, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ external_tool_surface_staged_op' = MapSet(external_tool_surface_staged_op, packet.payload.surface_id, "None")
       /\ external_tool_surface_staged_intent_sequence' = MapSet(external_tool_surface_staged_intent_sequence, packet.payload.surface_id, 0)
       /\ external_tool_surface_pending_task_sequence' = MapSet(external_tool_surface_pending_task_sequence, packet.payload.surface_id, 0)
       /\ external_tool_surface_pending_lineage_sequence' = MapSet(external_tool_surface_pending_lineage_sequence, packet.payload.surface_id, 0)
       ...
       /\ external_tool_surface_snapshot_epoch' = (IF (external_tool_surface_snapshot_epoch = external_tool_surface_snapshot_aligned_epoch) THEN (external_tool_surface_snapshot_epoch + 1) ELSE external_tool_surface_snapshot_epoch)
       /\ UNCHANGED << external_tool_surface_next_staged_intent_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_control", variant |-> "ExternalToolDeltaReceived", payload |-> [tag |-> "unit"], source_kind |-> "route", source_route |-> "surface_delta_notifies_runtime_control", source_machine |-> "external_tool_surface", source_effect |-> "EmitExternalToolDelta", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "ExternalToolDeltaReceived", payload |-> [tag |-> "unit"], source_kind |-> "route", source_route |-> "surface_delta_notifies_runtime_control", source_machine |-> "external_tool_surface", source_effect |-> "EmitExternalToolDelta", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "surface_delta_notifies_runtime_control", source_machine |-> "external_tool_surface", effect |-> "EmitExternalToolDelta", target_machine |-> "runtime_control", target_input |-> "ExternalToolDeltaReceived", payload |-> [tag |-> "unit"], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "ApplyBoundaryRemoveDraining"] }
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "external_tool_surface", variant |-> "RefreshVisibleSurfaceSet", payload |-> [snapshot_epoch |-> (IF (external_tool_surface_snapshot_epoch = external_tool_surface_snapshot_aligned_epoch) THEN (external_tool_surface_snapshot_epoch + 1) ELSE external_tool_surface_snapshot_epoch)], effect_id |-> (model_step_count + 1), source_transition |-> "ApplyBoundaryRemoveDraining"], [machine |-> "external_tool_surface", variant |-> "EmitExternalToolDelta", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Remove", persisted |-> FALSE, phase |-> "Draining", surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "ApplyBoundaryRemoveDraining"] }
       ...
       /\ obligation_surface_snapshot_alignment' = obligation_surface_snapshot_alignment \cup {[snapshot_epoch |-> (IF (external_tool_surface_snapshot_epoch = external_tool_surface_snapshot_aligned_epoch) THEN (external_tool_surface_snapshot_epoch + 1) ELSE external_tool_surface_snapshot_epoch)]}
...
external_tool_surface_ApplyBoundaryRemoveNoop(arg_surface_id, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ external_tool_surface_pending_task_sequence' = MapSet(external_tool_surface_pending_task_sequence, packet.payload.surface_id, 0)
       /\ external_tool_surface_pending_lineage_sequence' = MapSet(external_tool_surface_pending_lineage_sequence, packet.payload.surface_id, 0)
       /\ UNCHANGED << external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_next_staged_intent_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
external_tool_surface_PendingSucceededAdd(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "external_tool_surface"
       /\ packet.variant = "PendingSucceeded"
       /\ packet.payload.surface_id = arg_surface_id
       /\ packet.payload.operation = arg_operation
       /\ packet.payload.pending_task_sequence = arg_pending_task_sequence
       /\ packet.payload.staged_intent_sequence = arg_staged_intent_sequence
       /\ packet.payload.applied_at_turn = arg_applied_at_turn
       /\ ~HigherPriorityReady("surface_boundary")
       /\ external_tool_surface_phase = "Operating"
       /\ (packet.payload.operation = "Add")
       /\ (external_tool_surface__PendingOp(packet.payload.surface_id) = packet.payload.operation)
       /\ (external_tool_surface__PendingTaskSequence(packet.payload.surface_id) = packet.payload.pending_task_sequence)
       /\ (external_tool_surface__PendingLineageSequence(packet.payload.surface_id) = packet.payload.staged_intent_sequence)
       /\ external_tool_surface_phase' = "Operating"
       /\ external_tool_surface_known_surfaces' = (external_tool_surface_known_surfaces \cup {packet.payload.surface_id})
       ...
       /\ external_tool_surface_snapshot_epoch' = (IF (external_tool_surface_snapshot_epoch = external_tool_surface_snapshot_aligned_epoch) THEN (external_tool_surface_snapshot_epoch + 1) ELSE external_tool_surface_snapshot_epoch)
       /\ UNCHANGED << external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_control", variant |-> "ExternalToolDeltaReceived", payload |-> [tag |-> "unit"], source_kind |-> "route", source_route |-> "surface_delta_notifies_runtime_control", source_machine |-> "external_tool_surface", source_effect |-> "EmitExternalToolDelta", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "ExternalToolDeltaReceived", payload |-> [tag |-> "unit"], source_kind |-> "route", source_route |-> "surface_delta_notifies_runtime_control", source_machine |-> "external_tool_surface", source_effect |-> "EmitExternalToolDelta", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "surface_delta_notifies_runtime_control", source_machine |-> "external_tool_surface", effect |-> "EmitExternalToolDelta", target_machine |-> "runtime_control", target_input |-> "ExternalToolDeltaReceived", payload |-> [tag |-> "unit"], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "PendingSucceededAdd"] }
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "external_tool_surface", variant |-> "RefreshVisibleSurfaceSet", payload |-> [snapshot_epoch |-> (IF (external_tool_surface_snapshot_epoch = external_tool_surface_snapshot_aligned_epoch) THEN (external_tool_surface_snapshot_epoch + 1) ELSE external_tool_surface_snapshot_epoch)], effect_id |-> (model_step_count + 1), source_transition |-> "PendingSucceededAdd"], [machine |-> "external_tool_surface", variant |-> "EmitExternalToolDelta", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Add", persisted |-> TRUE, phase |-> "Applied", surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "PendingSucceededAdd"] }
...
external_tool_surface_PendingSucceededReload(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "external_tool_surface"
       /\ packet.variant = "PendingSucceeded"
       /\ packet.payload.surface_id = arg_surface_id
       ...
       /\ ~HigherPriorityReady("surface_boundary")
       /\ external_tool_surface_phase = "Operating"
       /\ (packet.payload.operation = "Reload")
       /\ (external_tool_surface__PendingOp(packet.payload.surface_id) = packet.payload.operation)
       /\ (external_tool_surface__PendingTaskSequence(packet.payload.surface_id) = packet.payload.pending_task_sequence)
       /\ (external_tool_surface__PendingLineageSequence(packet.payload.surface_id) = packet.payload.staged_intent_sequence)
       /\ external_tool_surface_phase' = "Operating"
       ...
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "external_tool_surface", variant |-> "RefreshVisibleSurfaceSet", payload |-> [snapshot_epoch |-> (IF (external_tool_surface_snapshot_epoch = external_tool_surface_snapshot_aligned_epoch) THEN (external_tool_surface_snapshot_epoch + 1) ELSE external_tool_surface_snapshot_epoch)], effect_id |-> (model_step_count + 1), source_transition |-> "PendingSucceededReload"], [machine |-> "external_tool_surface", variant |-> "EmitExternalToolDelta", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Reload", persisted |-> TRUE, phase |-> "Applied", surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "PendingSucceededReload"] }
...
external_tool_surface_PendingFailedAdd(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "external_tool_surface"
       ...
       /\ UNCHANGED << external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_control", variant |-> "ExternalToolDeltaReceived", payload |-> [tag |-> "unit"], source_kind |-> "route", source_route |-> "surface_delta_notifies_runtime_control", source_machine |-> "external_tool_surface", source_effect |-> "EmitExternalToolDelta", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "ExternalToolDeltaReceived", payload |-> [tag |-> "unit"], source_kind |-> "route", source_route |-> "surface_delta_notifies_runtime_control", source_machine |-> "external_tool_surface", source_effect |-> "EmitExternalToolDelta", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
...
external_tool_surface_PendingFailedReload(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "external_tool_surface"
       /\ packet.variant = "PendingFailed"
       /\ packet.payload.surface_id = arg_surface_id
...
external_tool_surface_CallStartedActive(arg_surface_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
external_tool_surface_FinalizeRemovalClean(arg_surface_id, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "external_tool_surface", variant |-> "CloseSurfaceConnection", payload |-> [surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "FinalizeRemovalClean"], [machine |-> "external_tool_surface", variant |-> "RefreshVisibleSurfaceSet", payload |-> [snapshot_epoch |-> (IF (external_tool_surface_snapshot_epoch = external_tool_surface_snapshot_aligned_epoch) THEN (external_tool_surface_snapshot_epoch + 1) ELSE external_tool_surface_snapshot_epoch)], effect_id |-> (model_step_count + 1), source_transition |-> "FinalizeRemovalClean"], [machine |-> "external_tool_surface", variant |-> "EmitExternalToolDelta", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Remove", persisted |-> TRUE, phase |-> "Applied", surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "FinalizeRemovalClean"] }
...
external_tool_surface_FinalizeRemovalForced(arg_surface_id, arg_applied_at_turn) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "external_tool_surface", variant |-> "CloseSurfaceConnection", payload |-> [surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "FinalizeRemovalForced"], [machine |-> "external_tool_surface", variant |-> "RefreshVisibleSurfaceSet", payload |-> [snapshot_epoch |-> (IF (external_tool_surface_snapshot_epoch = external_tool_surface_snapshot_aligned_epoch) THEN (external_tool_surface_snapshot_epoch + 1) ELSE external_tool_surface_snapshot_epoch)], effect_id |-> (model_step_count + 1), source_transition |-> "FinalizeRemovalForced"], [machine |-> "external_tool_surface", variant |-> "EmitExternalToolDelta", payload |-> [applied_at_turn |-> packet.payload.applied_at_turn, operation |-> "Remove", persisted |-> TRUE, phase |-> "Forced", surface_id |-> packet.payload.surface_id], effect_id |-> (model_step_count + 1), source_transition |-> "FinalizeRemovalForced"] }
...
external_tool_surface_SnapshotAligned(arg_snapshot_epoch) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "external_tool_surface"
       /\ packet.variant = "SnapshotAligned"
       /\ packet.payload.snapshot_epoch = arg_snapshot_epoch
       /\ ~HigherPriorityReady("surface_boundary")
       /\ external_tool_surface_phase = "Operating"
       /\ (packet.payload.snapshot_epoch = external_tool_surface_snapshot_epoch)
       /\ (external_tool_surface_snapshot_epoch > external_tool_surface_snapshot_aligned_epoch)
       /\ external_tool_surface_phase' = "Operating"
       /\ external_tool_surface_snapshot_aligned_epoch' = packet.payload.snapshot_epoch
       /\ UNCHANGED << external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "external_tool_surface", transition |-> "SnapshotAligned", actor |-> "surface_boundary", step |-> (model_step_count + 1), from_phase |-> external_tool_surface_phase, to_phase |-> "Operating"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1
...
external_tool_surface_visible_surfaces_subset_of_known_surfaces == (\A surface_id \in external_tool_surface_visible_surfaces : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_base_state_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_base_state : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_pending_op_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_pending_op : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_staged_op_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_staged_op : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_staged_intent_sequence_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_staged_intent_sequence : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_pending_task_sequence_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_pending_task_sequence : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_pending_lineage_sequence_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_pending_lineage_sequence : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_inflight_calls_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_inflight_calls : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_last_delta_operation_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_last_delta_operation : (surface_id \in external_tool_surface_known_surfaces))
external_tool_surface_last_delta_phase_keys_subset_of_known_surfaces == (\A surface_id \in DOMAIN external_tool_surface_last_delta_phase : (surface_id \in external_tool_surface_known_surfaces))
...
external_tool_surface_staged_sequence_matches_staged_presence == (\A surface_id \in external_tool_surface_known_surfaces : (((external_tool_surface__StagedOp(surface_id) = "None") /\ (external_tool_surface__StagedIntentSequence(surface_id) = 0)) \/ ((external_tool_surface__StagedOp(surface_id) # "None") /\ (external_tool_surface__StagedIntentSequence(surface_id) > 0))))
external_tool_surface_pending_lineage_matches_pending_presence == (\A surface_id \in external_tool_surface_known_surfaces : (((external_tool_surface__PendingOp(surface_id) = "None") /\ (external_tool_surface__PendingTaskSequence(surface_id) = 0) /\ (external_tool_surface__PendingLineageSequence(surface_id) = 0)) \/ ((external_tool_surface__PendingOp(surface_id) # "None") /\ (external_tool_surface__PendingTaskSequence(surface_id) > 0) /\ (external_tool_surface__PendingLineageSequence(surface_id) > 0))))
external_tool_surface_snapshot_alignment_epoch_not_ahead == (external_tool_surface_snapshot_aligned_epoch <= external_tool_surface_snapshot_epoch)
...
runtime_control_Initialize ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
turn_execution_StartConversationRun(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ turn_execution_extraction_attempts' = 0
       /\ turn_execution_max_extraction_retries' = 0
       /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
turn_execution_PrimitiveAppliedConversationTurn(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
turn_execution_PrimitiveAppliedImmediateAppend(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "PrimitiveAppliedImmediateAppend"] }
...
turn_execution_PrimitiveAppliedImmediateAppendCancelsAfterBoundary(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "PrimitiveAppliedImmediateAppendCancelsAfterBoundary"] }
...
turn_execution_PrimitiveAppliedImmediateContext(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "PrimitiveAppliedImmediateContext"] }
...
turn_execution_PrimitiveAppliedImmediateContextCancelsAfterBoundary(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "PrimitiveAppliedImmediateContextCancelsAfterBoundary"] }
...
turn_execution_ToolCallsResolved(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "ToolCallsResolved"] }
...
turn_execution_LlmReturnedTerminal(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "LlmReturnedTerminal"] }
...
turn_execution_ExtractionStart(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "turn_execution"
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "turn_execution", variant |-> "CheckCompaction", payload |-> [tag |-> "unit"], effect_id |-> (model_step_count + 1), source_transition |-> "ExtractionStart"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "turn_execution", transition |-> "ExtractionStart", actor |-> "turn_executor", step |-> (model_step_count + 1), from_phase |-> turn_execution_phase, to_phase |-> "CallingLlm"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1


turn_execution_ExtractionValidationFailed(arg_run_id, arg_error) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "turn_execution"
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "turn_execution", variant |-> "CheckCompaction", payload |-> [tag |-> "unit"], effect_id |-> (model_step_count + 1), source_transition |-> "ExtractionValidationFailed"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "turn_execution", transition |-> "ExtractionValidationFailed", actor |-> "turn_executor", step |-> (model_step_count + 1), from_phase |-> turn_execution_phase, to_phase |-> "CallingLlm"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1
...
turn_execution_TurnLimitReachedFromApplyingPrimitive(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromApplyingPrimitive"] }
...
turn_execution_TurnLimitReachedFromCallingLlm(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromCallingLlm"] }
...
turn_execution_TurnLimitReachedFromWaitingForOps(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromWaitingForOps"] }
...
turn_execution_TurnLimitReachedFromDrainingBoundary(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromDrainingBoundary"] }
...
turn_execution_TurnLimitReachedFromExtracting(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromExtracting"] }
...
turn_execution_TurnLimitReachedFromErrorRecovery(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromErrorRecovery"] }
...
turn_execution_BudgetExhaustedFromApplyingPrimitive(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromApplyingPrimitive"] }
...
turn_execution_BudgetExhaustedFromCallingLlm(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromCallingLlm"] }
...
turn_execution_BudgetExhaustedFromWaitingForOps(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromWaitingForOps"] }
...
turn_execution_BudgetExhaustedFromDrainingBoundary(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromDrainingBoundary"] }
...
turn_execution_BudgetExhaustedFromExtracting(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromExtracting"] }
...
turn_execution_BudgetExhaustedFromErrorRecovery(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromErrorRecovery"] }
...
turn_execution_TimeBudgetExceededFromApplyingPrimitive(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "turn_execution"
       ...
       /\ turn_execution_phase' = "Completed"
       /\ turn_execution_boundary_count' = (turn_execution_boundary_count) + 1
       /\ turn_execution_terminal_outcome' = "TimeBudgetExceeded"
       /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_cancel_after_boundary, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromApplyingPrimitive"] }
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "turn_execution", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromApplyingPrimitive"], [machine |-> "turn_execution", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromApplyingPrimitive"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "turn_execution", transition |-> "TimeBudgetExceededFromApplyingPrimitive", actor |-> "turn_executor", step |-> (model_step_count + 1), from_phase |-> turn_execution_phase, to_phase |-> "Completed"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1


turn_execution_TimeBudgetExceededFromCallingLlm(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "turn_execution"
       /\ packet.variant = "TimeBudgetExceeded"
       /\ packet.payload.run_id = arg_run_id
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromCallingLlm"] }
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "turn_execution", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromCallingLlm"], [machine |-> "turn_execution", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromCallingLlm"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "turn_execution", transition |-> "TimeBudgetExceededFromCallingLlm", actor |-> "turn_executor", step |-> (model_step_count + 1), from_phase |-> turn_execution_phase, to_phase |-> "Completed"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1


turn_execution_TimeBudgetExceededFromWaitingForOps(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "turn_execution"
       /\ packet.variant = "TimeBudgetExceeded"
       /\ packet.payload.run_id = arg_run_id
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromWaitingForOps"] }
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "turn_execution", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromWaitingForOps"], [machine |-> "turn_execution", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromWaitingForOps"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "turn_execution", transition |-> "TimeBudgetExceededFromWaitingForOps", actor |-> "turn_executor", step |-> (model_step_count + 1), from_phase |-> turn_execution_phase, to_phase |-> "Completed"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1


turn_execution_TimeBudgetExceededFromDrainingBoundary(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "turn_execution"
       /\ packet.variant = "TimeBudgetExceeded"
       /\ packet.payload.run_id = arg_run_id
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromDrainingBoundary"] }
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "turn_execution", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromDrainingBoundary"], [machine |-> "turn_execution", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromDrainingBoundary"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "turn_execution", transition |-> "TimeBudgetExceededFromDrainingBoundary", actor |-> "turn_executor", step |-> (model_step_count + 1), from_phase |-> turn_execution_phase, to_phase |-> "Completed"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1


turn_execution_TimeBudgetExceededFromExtracting(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "turn_execution"
       /\ packet.variant = "TimeBudgetExceeded"
       /\ packet.payload.run_id = arg_run_id
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromExtracting"] }
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "turn_execution", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromExtracting"], [machine |-> "turn_execution", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromExtracting"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "turn_execution", transition |-> "TimeBudgetExceededFromExtracting", actor |-> "turn_executor", step |-> (model_step_count + 1), from_phase |-> turn_execution_phase, to_phase |-> "Completed"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1


turn_execution_TimeBudgetExceededFromErrorRecovery(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "turn_execution"
       /\ packet.variant = "TimeBudgetExceeded"
       /\ packet.payload.run_id = arg_run_id
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> "owner_val", surface_id |-> "owner_val"], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromErrorRecovery"] }
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "turn_execution", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromErrorRecovery"], [machine |-> "turn_execution", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromErrorRecovery"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "turn_execution", transition |-> "TimeBudgetExceededFromErrorRecovery", actor |-> "turn_executor", step |-> (model_step_count + 1), from_phase |-> turn_execution_phase, to_phase |-> "Completed"]}
       /\ UNCHANGED << obligation_surface_completion, obligation_surface_snapshot_alignment >>
       /\ model_step_count' = model_step_count + 1
...
turn_execution_terminal_states_match_terminal_outcome == (((turn_execution_phase # "Completed") \/ (turn_execution_terminal_outcome = "Completed") \/ (turn_execution_terminal_outcome = "BudgetExhausted") \/ (turn_execution_terminal_outcome = "TimeBudgetExceeded")) /\ ((turn_execution_phase # "Failed") \/ (turn_execution_terminal_outcome = "Failed")) /\ ((turn_execution_phase # "Cancelled") \/ (turn_execution_terminal_outcome = "Cancelled")))
...
Inject_control_initialize ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_surface_completion, obligation_surface_snapshot_alignment, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
Inject_pending_succeeded(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn) ==
    /\ ~([machine |-> "external_tool_surface", variant |-> "PendingSucceeded", payload |-> [applied_at_turn |-> arg_applied_at_turn, operation |-> arg_operation, pending_task_sequence |-> arg_pending_task_sequence, staged_intent_sequence |-> arg_staged_intent_sequence, surface_id |-> arg_surface_id], source_kind |-> "entry", source_route |-> "pending_succeeded", source_machine |-> "external_entry", source_effect |-> "PendingSucceeded", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "external_tool_surface", variant |-> "PendingSucceeded", payload |-> [applied_at_turn |-> arg_applied_at_turn, operation |-> arg_operation, pending_task_sequence |-> arg_pending_task_sequence, staged_intent_sequence |-> arg_staged_intent_sequence, surface_id |-> arg_surface_id], source_kind |-> "entry", source_route |-> "pending_succeeded", source_machine |-> "external_entry", source_effect |-> "PendingSucceeded", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "PendingSucceeded", payload |-> [applied_at_turn |-> arg_applied_at_turn, operation |-> arg_operation, pending_task_sequence |-> arg_pending_task_sequence, staged_intent_sequence |-> arg_staged_intent_sequence, surface_id |-> arg_surface_id], source_kind |-> "entry", source_route |-> "pending_succeeded", source_machine |-> "external_entry", source_effect |-> "PendingSucceeded", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_surface_completion, obligation_surface_snapshot_alignment, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_pending_failed(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn) ==
    /\ ~([machine |-> "external_tool_surface", variant |-> "PendingFailed", payload |-> [applied_at_turn |-> arg_applied_at_turn, operation |-> arg_operation, pending_task_sequence |-> arg_pending_task_sequence, staged_intent_sequence |-> arg_staged_intent_sequence, surface_id |-> arg_surface_id], source_kind |-> "entry", source_route |-> "pending_failed", source_machine |-> "external_entry", source_effect |-> "PendingFailed", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "external_tool_surface", variant |-> "PendingFailed", payload |-> [applied_at_turn |-> arg_applied_at_turn, operation |-> arg_operation, pending_task_sequence |-> arg_pending_task_sequence, staged_intent_sequence |-> arg_staged_intent_sequence, surface_id |-> arg_surface_id], source_kind |-> "entry", source_route |-> "pending_failed", source_machine |-> "external_entry", source_effect |-> "PendingFailed", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "PendingFailed", payload |-> [applied_at_turn |-> arg_applied_at_turn, operation |-> arg_operation, pending_task_sequence |-> arg_pending_task_sequence, staged_intent_sequence |-> arg_staged_intent_sequence, surface_id |-> arg_surface_id], source_kind |-> "entry", source_route |-> "pending_failed", source_machine |-> "external_entry", source_effect |-> "PendingFailed", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_surface_completion, obligation_surface_snapshot_alignment, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
Inject_snapshot_aligned(arg_snapshot_epoch) ==
    /\ ~([machine |-> "external_tool_surface", variant |-> "SnapshotAligned", payload |-> [snapshot_epoch |-> arg_snapshot_epoch], source_kind |-> "entry", source_route |-> "snapshot_aligned", source_machine |-> "external_entry", source_effect |-> "SnapshotAligned", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "external_tool_surface", variant |-> "SnapshotAligned", payload |-> [snapshot_epoch |-> arg_snapshot_epoch], source_kind |-> "entry", source_route |-> "snapshot_aligned", source_machine |-> "external_entry", source_effect |-> "SnapshotAligned", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "SnapshotAligned", payload |-> [snapshot_epoch |-> arg_snapshot_epoch], source_kind |-> "entry", source_route |-> "snapshot_aligned", source_machine |-> "external_entry", source_effect |-> "SnapshotAligned", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_surface_completion, obligation_surface_snapshot_alignment, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
DeliverQueuedRoute ==
    ...
    /\ LET route == Head(pending_routes) IN
       ...
       /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_surface_completion, obligation_surface_snapshot_alignment, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
CoreNext ==
    ...
    \/ \E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_PendingSucceededAdd(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)
    \/ \E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_PendingSucceededReload(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)
    \/ \E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_PendingFailedAdd(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)
    \/ \E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_PendingFailedReload(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)
    ...
    \/ \E arg_snapshot_epoch \in 0..2 : external_tool_surface_SnapshotAligned(arg_snapshot_epoch)
    \/ external_tool_surface_Shutdown
    \/ runtime_control_Initialize
    \/ runtime_control_AttachFromIdle
    \/ runtime_control_DetachToIdle
    ...
    \/ \E arg_run_id \in RunIdValues : turn_execution_ExtractionStart(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : \E arg_error \in {"alpha", "beta"} : turn_execution_ExtractionValidationFailed(arg_run_id, arg_error)
    ...
    \/ \E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromApplyingPrimitive(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromCallingLlm(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromWaitingForOps(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromDrainingBoundary(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromExtracting(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromErrorRecovery(arg_run_id)
    \/ turn_execution_ForceCancelNoRunFromReady
    \/ turn_execution_ForceCancelNoRunFromApplyingPrimitive
    \/ turn_execution_ForceCancelNoRunFromCallingLlm
    \/ turn_execution_ForceCancelNoRunFromWaitingForOps
...
InjectNext ==
    ...
    \/ \E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : Inject_pending_succeeded(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)
    \/ \E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : Inject_pending_failed(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)
    ...
    \/ \E arg_snapshot_epoch \in 0..2 : Inject_snapshot_aligned(arg_snapshot_epoch)
...
WitnessNext_surface_completion_feedback ==
    \/ CoreNext
    \/ WitnessInjectNext_surface_completion_feedback
...
boundary_application_reaches_surface_authority == \A input_packet \in observed_inputs : ((input_packet.machine = "external_tool_surface" /\ input_packet.variant = "ApplyBoundary" /\ input_packet.source_route = "turn_boundary_applies_surface_changes") => (/\ input_packet.source_kind = "route" /\ input_packet.source_machine = "turn_execution" /\ input_packet.source_effect = "BoundaryApplied" /\ \E effect_packet \in emitted_effects : /\ effect_packet.machine = "turn_execution" /\ effect_packet.variant = "BoundaryApplied" /\ effect_packet.effect_id = input_packet.effect_id /\ \E route_packet \in RoutePackets : /\ route_packet.route = "turn_boundary_applies_surface_changes" /\ route_packet.source_machine = "turn_execution" /\ route_packet.effect = "BoundaryApplied" /\ route_packet.target_machine = "external_tool_surface" /\ route_packet.target_input = "ApplyBoundary" /\ route_packet.effect_id = input_packet.effect_id /\ route_packet.payload = input_packet.payload))
...
surface_snapshot_alignment_protocol_covered == TRUE

NoOpenObligationsOnTerminal_surface_completion == (external_tool_surface_phase = "Shutdown") => obligation_surface_completion = {}
NoFeedbackWithoutObligation_surface_completion == \A input_packet \in observed_inputs : ((((input_packet.machine = "external_tool_surface" /\ input_packet.variant = "PendingSucceeded")) => ((\E record \in obligation_surface_completion : (record.surface_id = input_packet.payload.surface_id /\ record.operation = input_packet.payload.operation /\ record.pending_task_sequence = input_packet.payload.pending_task_sequence /\ record.staged_intent_sequence = input_packet.payload.staged_intent_sequence /\ record.applied_at_turn = input_packet.payload.applied_at_turn)))) /\ (((input_packet.machine = "external_tool_surface" /\ input_packet.variant = "PendingFailed")) => ((\E record \in obligation_surface_completion : (record.surface_id = input_packet.payload.surface_id /\ record.operation = input_packet.payload.operation /\ record.pending_task_sequence = input_packet.payload.pending_task_sequence /\ record.staged_intent_sequence = input_packet.payload.staged_intent_sequence /\ record.applied_at_turn = input_packet.payload.applied_at_turn)))))
NoOpenObligationsOnTerminal_surface_snapshot_alignment == (external_tool_surface_phase = "Shutdown") => obligation_surface_snapshot_alignment = {}
NoFeedbackWithoutObligation_surface_snapshot_alignment == \A input_packet \in observed_inputs : ((((input_packet.machine = "external_tool_surface" /\ input_packet.variant = "SnapshotAligned")) => ((\E record \in obligation_surface_snapshot_alignment : (record.snapshot_epoch = input_packet.payload.snapshot_epoch)))))
...
OwnerFeedback_surface_completion ==
    ...
    /\ \E token \in obligation_surface_completion :
        /\ ((/\ pending_inputs' = Append(pending_inputs, [machine |-> "external_tool_surface", variant |-> "PendingSucceeded", source_kind |-> "owner", source_machine |-> "external_tool_surface", source_effect |-> "ScheduleSurfaceCompletion", source_route |-> "none", effect_id |-> token, payload |-> [surface_id |-> token.surface_id, operation |-> token.operation, pending_task_sequence |-> token.pending_task_sequence, staged_intent_sequence |-> token.staged_intent_sequence, applied_at_turn |-> token.applied_at_turn]]) /\ obligation_surface_completion' = obligation_surface_completion \ {token}) \/ (/\ pending_inputs' = Append(pending_inputs, [machine |-> "external_tool_surface", variant |-> "PendingFailed", source_kind |-> "owner", source_machine |-> "external_tool_surface", source_effect |-> "ScheduleSurfaceCompletion", source_route |-> "none", effect_id |-> token, payload |-> [surface_id |-> token.surface_id, operation |-> token.operation, pending_task_sequence |-> token.pending_task_sequence, staged_intent_sequence |-> token.staged_intent_sequence, applied_at_turn |-> token.applied_at_turn]]) /\ obligation_surface_completion' = obligation_surface_completion \ {token}))
    /\ UNCHANGED << external_tool_surface_phase, external_tool_surface_known_surfaces, external_tool_surface_visible_surfaces, external_tool_surface_base_state, external_tool_surface_pending_op, external_tool_surface_staged_op, external_tool_surface_staged_intent_sequence, external_tool_surface_next_staged_intent_sequence, external_tool_surface_pending_task_sequence, external_tool_surface_pending_lineage_sequence, external_tool_surface_next_pending_task_sequence, external_tool_surface_inflight_calls, external_tool_surface_last_delta_operation, external_tool_surface_last_delta_phase, external_tool_surface_snapshot_epoch, external_tool_surface_snapshot_aligned_epoch, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_barrier_operation_ids, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_surface_snapshot_alignment, model_step_count, observed_inputs, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

\* Liveness: eventual snapshot acknowledgement under surface host liveness
OwnerFeedback_surface_snapshot_alignment ==
    /\ obligation_surface_snapshot_alignment /= {}
    /\ \E token \in obligation_surface_snapshot_alignment :
        /\ ((/\ pending_inputs' = Append(pending_inputs, [machine |-> "external_tool_surface", variant |-> "SnapshotAligned", source_kind |-> "owner", source_machine |-> "external_tool_surface", source_effect |-> "RefreshVisibleSurfaceSet", source_route |-> "none", effect_id |-> token, payload |-> [snapshot_epoch |-> token.snapshot_epoch]]) /\ obligation_surface_snapshot_alignment' = obligation_surface_snapshot_alignment \ {token}))
...
CiStateConstraint == /\ model_step_count <= 6 /\ Len(pending_inputs) <= 1 /\ Cardinality(observed_inputs) <= 4 /\ Len(pending_routes) <= 1 /\ Cardinality(delivered_routes) <= 1 /\ Cardinality(emitted_effects) <= 1 /\ Cardinality(observed_transitions) <= 6 /\ Cardinality(external_tool_surface_known_surfaces) <= 1 /\ Cardinality(external_tool_surface_visible_surfaces) <= 1 /\ Cardinality(DOMAIN external_tool_surface_base_state) <= 1 /\ Cardinality(DOMAIN external_tool_surface_pending_op) <= 1 /\ Cardinality(DOMAIN external_tool_surface_staged_op) <= 1 /\ Cardinality(DOMAIN external_tool_surface_staged_intent_sequence) <= 1 /\ Cardinality(DOMAIN external_tool_surface_pending_task_sequence) <= 1 /\ Cardinality(DOMAIN external_tool_surface_pending_lineage_sequence) <= 1 /\ Cardinality(DOMAIN external_tool_surface_inflight_calls) <= 1 /\ Cardinality(DOMAIN external_tool_surface_last_delta_operation) <= 1 /\ Cardinality(DOMAIN external_tool_surface_last_delta_phase) <= 1 /\ Len(turn_execution_barrier_operation_ids) <= 1
DeepStateConstraint == /\ model_step_count <= 6 /\ Len(pending_inputs) <= 2 /\ Cardinality(observed_inputs) <= 6 /\ Len(pending_routes) <= 2 /\ Cardinality(delivered_routes) <= 2 /\ Cardinality(emitted_effects) <= 2 /\ Cardinality(observed_transitions) <= 6 /\ Cardinality(external_tool_surface_known_surfaces) <= 2 /\ Cardinality(external_tool_surface_visible_surfaces) <= 2 /\ Cardinality(DOMAIN external_tool_surface_base_state) <= 2 /\ Cardinality(DOMAIN external_tool_surface_pending_op) <= 2 /\ Cardinality(DOMAIN external_tool_surface_staged_op) <= 2 /\ Cardinality(DOMAIN external_tool_surface_staged_intent_sequence) <= 2 /\ Cardinality(DOMAIN external_tool_surface_pending_task_sequence) <= 2 /\ Cardinality(DOMAIN external_tool_surface_pending_lineage_sequence) <= 2 /\ Cardinality(DOMAIN external_tool_surface_inflight_calls) <= 2 /\ Cardinality(DOMAIN external_tool_surface_last_delta_operation) <= 2 /\ Cardinality(DOMAIN external_tool_surface_last_delta_phase) <= 2 /\ Len(turn_execution_barrier_operation_ids) <= 2
WitnessStateConstraint_surface_add_notifies_control == /\ model_step_count <= 14 /\ Len(pending_inputs) <= 6 /\ Cardinality(observed_inputs) <= 12 /\ Len(pending_routes) <= 2 /\ Cardinality(delivered_routes) <= 4 /\ Cardinality(emitted_effects) <= 8 /\ Cardinality(observed_transitions) <= 14 /\ Cardinality(external_tool_surface_known_surfaces) <= 6 /\ Cardinality(external_tool_surface_visible_surfaces) <= 6 /\ Cardinality(DOMAIN external_tool_surface_base_state) <= 3 /\ Cardinality(DOMAIN external_tool_surface_pending_op) <= 3 /\ Cardinality(DOMAIN external_tool_surface_staged_op) <= 3 /\ Cardinality(DOMAIN external_tool_surface_staged_intent_sequence) <= 3 /\ Cardinality(DOMAIN external_tool_surface_pending_task_sequence) <= 3 /\ Cardinality(DOMAIN external_tool_surface_pending_lineage_sequence) <= 3 /\ Cardinality(DOMAIN external_tool_surface_inflight_calls) <= 3 /\ Cardinality(DOMAIN external_tool_surface_last_delta_operation) <= 3 /\ Cardinality(DOMAIN external_tool_surface_last_delta_phase) <= 3 /\ Len(turn_execution_barrier_operation_ids) <= 6
...
WitnessSpec_surface_completion_feedback == WitnessInit_surface_completion_feedback /\ [] [WitnessNext_surface_completion_feedback]_vars /\ WF_vars(DeliverQueuedRoute) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : external_tool_surface_StageAdd(arg_surface_id)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : external_tool_surface_StageRemove(arg_surface_id)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : external_tool_surface_StageReload(arg_surface_id)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_ApplyBoundaryAdd(arg_surface_id, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_ApplyBoundaryReload(arg_surface_id, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_ApplyBoundaryRemoveDraining(arg_surface_id, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_ApplyBoundaryRemoveNoop(arg_surface_id, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_PendingSucceededAdd(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_PendingSucceededReload(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_PendingFailedAdd(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_operation \in SurfaceDeltaOperationValues : \E arg_pending_task_sequence \in 0..2 : \E arg_staged_intent_sequence \in 0..2 : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_PendingFailedReload(arg_surface_id, arg_operation, arg_pending_task_sequence, arg_staged_intent_sequence, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : external_tool_surface_CallStartedActive(arg_surface_id)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : external_tool_surface_CallStartedRejectWhileRemoving(arg_surface_id)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : external_tool_surface_CallStartedRejectWhileUnavailable(arg_surface_id)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : external_tool_surface_CallFinishedActive(arg_surface_id)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : external_tool_surface_CallFinishedRemoving(arg_surface_id)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_FinalizeRemovalClean(arg_surface_id, arg_applied_at_turn)) /\ WF_vars(\E arg_surface_id \in SurfaceIdValues : \E arg_applied_at_turn \in TurnNumberValues : external_tool_surface_FinalizeRemovalForced(arg_surface_id, arg_applied_at_turn)) /\ WF_vars(\E arg_snapshot_epoch \in 0..2 : external_tool_surface_SnapshotAligned(arg_snapshot_epoch)) /\ WF_vars(external_tool_surface_Shutdown) /\ WF_vars(runtime_control_Initialize) /\ WF_vars(runtime_control_AttachFromIdle) /\ WF_vars(runtime_control_DetachToIdle) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_BeginRunFromIdle(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_BeginRunFromRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_BeginRunFromAttached(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_BeginRunFromRecovering(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCompletedToIdle(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCompletedToAttached(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCompletedToRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunFailedToIdle(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunFailedToAttached(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunFailedToRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCancelledToIdle(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCancelledToAttached(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCancelledToRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCompletedFromRetiredInFlight(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunFailedFromRetiredInFlight(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCancelledFromRetiredInFlight(arg_run_id)) /\ WF_vars(runtime_control_RecoverRequestedFromIdle) /\ WF_vars(runtime_control_RecoverRequestedFromRunning) /\ WF_vars(runtime_control_RecoverRequestedFromAttached) /\ WF_vars(runtime_control_RecoverySucceeded) /\ WF_vars(runtime_control_RetireRequestedFromIdle) /\ WF_vars(runtime_control_RetireRequestedFromRunning) /\ WF_vars(runtime_control_RetireRequestedFromAttached) /\ WF_vars(runtime_control_ResetRequested) /\ WF_vars(runtime_control_StopRequested) /\ WF_vars(runtime_control_DestroyRequested) /\ WF_vars(runtime_control_ResumeRequested) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : runtime_control_SubmitWorkFromIdle(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : runtime_control_SubmitWorkFromRunning(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : runtime_control_SubmitWorkFromAttached(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedIdleQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedIdleSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedRunningQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedRunningSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedAttachedQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedAttachedSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_reason \in {"alpha", "beta"} : runtime_control_AdmissionRejectedIdle(arg_work_id, arg_reason)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_reason \in {"alpha", "beta"} : runtime_control_AdmissionRejectedRunning(arg_work_id, arg_reason)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_reason \in {"alpha", "beta"} : runtime_control_AdmissionRejectedAttached(arg_work_id, arg_reason)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_existing_work_id \in WorkIdValues : runtime_control_AdmissionDeduplicatedIdle(arg_work_id, arg_existing_work_id)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_existing_work_id \in WorkIdValues : runtime_control_AdmissionDeduplicatedRunning(arg_work_id, arg_existing_work_id)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_existing_work_id \in WorkIdValues : runtime_control_AdmissionDeduplicatedAttached(arg_work_id, arg_existing_work_id)) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedIdle) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedRunning) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedRecovering) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedRetired) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedAttached) /\ WF_vars(runtime_control_RecycleRequestedFromRetired) /\ WF_vars(runtime_control_RecycleRequestedFromIdle) /\ WF_vars(runtime_control_RecycleRequestedFromAttached) /\ WF_vars(runtime_control_RecycleSucceeded) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_StartConversationRun(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_StartImmediateAppend(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_StartImmediateContext(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedConversationTurn(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedImmediateAppend(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedImmediateAppendCancelsAfterBoundary(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedImmediateContext(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedImmediateContextCancelsAfterBoundary(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_tool_count \in 0..2 : turn_execution_LlmReturnedToolCalls(arg_run_id, arg_tool_count)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_op_refs \in SeqOfAsyncOpRefValues : \E arg_barrier_operation_ids \in SeqOfOperationIdValues : \E arg_has_barrier_ops \in BOOLEAN : turn_execution_RegisterPendingOps(arg_run_id, arg_op_refs, arg_barrier_operation_ids, arg_has_barrier_ops)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_operation_ids \in SeqOfOperationIdValues : turn_execution_OpsBarrierSatisfied(arg_run_id, arg_operation_ids)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_ToolCallsResolved(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_LlmReturnedTerminal(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BoundaryContinue(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BoundaryContinueCancelsAfterBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BoundaryComplete(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BoundaryCompleteCancelsAfterBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_max_retries \in 0..2 : turn_execution_EnterExtraction(arg_run_id, arg_max_retries)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_ExtractionValidationPassed(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_ExtractionStart(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_error \in {"alpha", "beta"} : turn_execution_ExtractionValidationFailed(arg_run_id, arg_error)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_RecoverableFailureFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_RecoverableFailureFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_RecoverableFailureFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_RetryRequested(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancellationObserved(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TimeBudgetExceededFromErrorRecovery(arg_run_id)) /\ WF_vars(turn_execution_ForceCancelNoRunFromReady) /\ WF_vars(turn_execution_ForceCancelNoRunFromApplyingPrimitive) /\ WF_vars(turn_execution_ForceCancelNoRunFromCallingLlm) /\ WF_vars(turn_execution_ForceCancelNoRunFromWaitingForOps) /\ WF_vars(turn_execution_ForceCancelNoRunFromDrainingBoundary) /\ WF_vars(turn_execution_ForceCancelNoRunFromExtracting) /\ WF_vars(turn_execution_ForceCancelNoRunFromErrorRecovery) /\ WF_vars(turn_execution_ForceCancelNoRunFromCancelling) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_AcknowledgeTerminalFromCompleted(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_AcknowledgeTerminalFromFailed(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_AcknowledgeTerminalFromCancelled(arg_run_id)) /\ WF_vars(WitnessInjectNext_surface_completion_feedback)
...
WitnessTransitionOrder_surface_add_notifies_control_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "LlmReturnedTerminal" /\ later.machine = "turn_execution" /\ later.transition = "BoundaryComplete" /\ earlier.step < later.step)
WitnessTransitionOrder_surface_add_notifies_control_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "BoundaryComplete" /\ later.machine = "external_tool_surface" /\ later.transition = "ApplyBoundaryAdd" /\ earlier.step < later.step)
...
WitnessRouteObserved_turn_boundary_reaches_surface_surface_delta_notifies_runtime_control == <> RouteObserved_surface_delta_notifies_runtime_control
...
WitnessTransitionOrder_turn_boundary_reaches_surface_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "LlmReturnedTerminal" /\ later.machine = "turn_execution" /\ later.transition = "BoundaryComplete" /\ earlier.step < later.step)
WitnessTransitionOrder_turn_boundary_reaches_surface_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "BoundaryComplete" /\ later.machine = "external_tool_surface" /\ later.transition = "ApplyBoundaryAdd" /\ earlier.step < later.step)
WitnessTransitionOrder_turn_boundary_reaches_surface_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "external_tool_surface" /\ earlier.transition = "ApplyBoundaryAdd" /\ later.machine = "runtime_control" /\ later.transition = "ExternalToolDeltaReceivedIdle" /\ earlier.step < later.step)
...
WitnessRouteObserved_surface_completion_feedback_turn_boundary_applies_surface_changes == <> RouteObserved_turn_boundary_applies_surface_changes
WitnessRouteObserved_surface_completion_feedback_surface_delta_notifies_runtime_control == <> RouteObserved_surface_delta_notifies_runtime_control
WitnessStateObserved_surface_completion_feedback_1 == <> (external_tool_surface_phase = "Operating")
WitnessStateObserved_surface_completion_feedback_2 == <> (runtime_control_phase = "Idle")
WitnessStateObserved_surface_completion_feedback_3 == <> (turn_execution_phase = "Completed")
WitnessTransitionObserved_surface_completion_feedback_runtime_control_Initialize == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "Initialize")
WitnessTransitionObserved_surface_completion_feedback_external_tool_surface_StageAdd == <> (\E packet \in observed_transitions : /\ packet.machine = "external_tool_surface" /\ packet.transition = "StageAdd")
WitnessTransitionObserved_surface_completion_feedback_turn_execution_StartConversationRun == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "StartConversationRun")
WitnessTransitionObserved_surface_completion_feedback_turn_execution_PrimitiveAppliedConversationTurn == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "PrimitiveAppliedConversationTurn")
WitnessTransitionObserved_surface_completion_feedback_turn_execution_LlmReturnedTerminal == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "LlmReturnedTerminal")
WitnessTransitionObserved_surface_completion_feedback_turn_execution_BoundaryComplete == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "BoundaryComplete")
WitnessTransitionObserved_surface_completion_feedback_external_tool_surface_ApplyBoundaryAdd == <> (\E packet \in observed_transitions : /\ packet.machine = "external_tool_surface" /\ packet.transition = "ApplyBoundaryAdd")
WitnessTransitionObserved_surface_completion_feedback_runtime_control_ExternalToolDeltaReceivedIdle == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "ExternalToolDeltaReceivedIdle")
WitnessTransitionObserved_surface_completion_feedback_external_tool_surface_PendingSucceededAdd == <> (\E packet \in observed_transitions : /\ packet.machine = "external_tool_surface" /\ packet.transition = "PendingSucceededAdd")
WitnessTransitionObserved_surface_completion_feedback_external_tool_surface_SnapshotAligned == <> (\E packet \in observed_transitions : /\ packet.machine = "external_tool_surface" /\ packet.transition = "SnapshotAligned")
WitnessTransitionOrder_surface_completion_feedback_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "LlmReturnedTerminal" /\ later.machine = "turn_execution" /\ later.transition = "BoundaryComplete" /\ earlier.step < later.step)
WitnessTransitionOrder_surface_completion_feedback_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "BoundaryComplete" /\ later.machine = "external_tool_surface" /\ later.transition = "ApplyBoundaryAdd" /\ earlier.step < later.step)
WitnessTransitionOrder_surface_completion_feedback_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "external_tool_surface" /\ earlier.transition = "ApplyBoundaryAdd" /\ later.machine = "external_tool_surface" /\ later.transition = "PendingSucceededAdd" /\ earlier.step < later.step)
WitnessTransitionOrder_surface_completion_feedback_4 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "external_tool_surface" /\ earlier.transition = "PendingSucceededAdd" /\ later.machine = "external_tool_surface" /\ later.transition = "SnapshotAligned" /\ earlier.step < later.step)
...
THEOREM Spec => []surface_completion_protocol_covered
THEOREM Spec => []surface_snapshot_alignment_protocol_covered
THEOREM Spec => []external_tool_surface_visible_surfaces_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_base_state_keys_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_pending_op_keys_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_staged_op_keys_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_staged_intent_sequence_keys_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_pending_task_sequence_keys_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_pending_lineage_sequence_keys_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_inflight_calls_keys_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_last_delta_operation_keys_subset_of_known_surfaces
THEOREM Spec => []external_tool_surface_last_delta_phase_keys_subset_of_known_surfaces
...
THEOREM Spec => []external_tool_surface_staged_sequence_matches_staged_presence
THEOREM Spec => []external_tool_surface_pending_lineage_matches_pending_presence
THEOREM Spec => []external_tool_surface_snapshot_alignment_epoch_not_ahead
...
THEOREM Spec => []NoOpenObligationsOnTerminal_surface_completion
THEOREM Spec => []NoFeedbackWithoutObligation_surface_completion
THEOREM Spec => []NoOpenObligationsOnTerminal_surface_snapshot_alignment
THEOREM Spec => []NoFeedbackWithoutObligation_surface_snapshot_alignment
