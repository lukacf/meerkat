...
impl Pack for ReviewPack {
    ...
    fn definition(
        ...
        skills.insert(
            "reviewer-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/reviewer.md").into(),
            },
        );
        skills.insert(
            "security-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/security_reviewer.md").into(),
            },
        );
        skills.insert(
            "perf-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/perf_reviewer.md").into(),
            },
        );
        skills.insert(
        ...
        steps.insert(
            StepId::from("general_review"),
            flow_step("reviewer", review_msg.clone(), &[], 300_000),
        );
        steps.insert(
