...
/// Configuration metadata for a schedule. Not part of the machine state —
/// mutable via the service layer, never touched by the lifecycle authority.
#[cfg_attr(feature = "schema", derive(schemars::JsonSchema))]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Schedule {
    // Machine state — mutated by lifecycle authority
