...
pub fn emit_all_schemas(output_dir: &std::path::Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let wire_types = serde_json::json!({
        ...
        "MobAdaptiveStartResult": schema_for!(crate::wire::MobAdaptiveStartResult),
        "MobAdaptiveStatusResult": schema_for!(crate::wire::MobAdaptiveStatusResult),
        "MobAdaptiveLayersResult": schema_for!(crate::wire::MobAdaptiveLayersResult),
        "MobAdaptiveEventsResult": schema_for!(crate::wire::MobAdaptiveEventsResult),
        "MobAdaptiveResultResult": schema_for!(crate::wire::MobAdaptiveResultResult),
        "MobAdaptiveCancelResult": schema_for!(crate::wire::MobAdaptiveCancelResult),
        "MobAdaptiveRetryLayerResult": schema_for!(crate::wire::MobAdaptiveRetryLayerResult),
        "WireAdaptiveRun": schema_for!(crate::wire::WireAdaptiveRun),
        "WireAdaptiveRunPhase": schema_for!(crate::wire::WireAdaptiveRunPhase),
        "WireAdaptiveStopReason": schema_for!(crate::wire::WireAdaptiveStopReason),
        "WireAdaptiveLayer": schema_for!(crate::wire::WireAdaptiveLayer),
        "WireAdaptiveLayerPhase": schema_for!(crate::wire::WireAdaptiveLayerPhase),
    ...
    let params = serde_json::json!({
        ...
        "MobAdaptiveStartParams": schema_for!(crate::wire::MobAdaptiveStartParams),
        "MobAdaptiveRunParams": schema_for!(crate::wire::MobAdaptiveRunParams),
        "MobAdaptiveRetryLayerParams": schema_for!(crate::wire::MobAdaptiveRetryLayerParams),
