...
> current release line is documented in the main SKILL.md and api_reference.md;
> consult those files for current contracts. Notable post-0.5 renames: `MeerkatId` ->
