...
| `MobMemberLifecycleAnchorMachine` | `SchemaKernel` | `meerkat-mob` | `meerkat-machine-schema/src/catalog/mob_member_lifecycle_anchor.rs` plus generated owner under `src/generated/` | `src/runtime/ops_adapter.rs`, `src/runtime/handle.rs` | generated Rust + generated TLA + mob lifecycle observation tests |
| `MobRuntimeBridgeAnchorMachine` | `SchemaKernel` | `meerkat-mob` | `meerkat-machine-schema/src/catalog/mob_runtime_bridge_anchor.rs` plus generated owner under `src/generated/` | `src/runtime/actor.rs`, `src/runtime/provisioner.rs` | generated Rust + generated TLA + bridge observation tests |
| `MobWiringAnchorMachine` | `SchemaKernel` | `meerkat-mob` | `meerkat-machine-schema/src/catalog/mob_wiring_anchor.rs` plus generated owner under `src/generated/` | `src/runtime/actor.rs`, `src/runtime/ops_adapter.rs` | generated Rust + generated TLA + wiring observation tests |
