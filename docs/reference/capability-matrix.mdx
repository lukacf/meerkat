...
# Add persistence
meerkat = { version = "0.6.23", default-features = false, features = ["anthropic", "session-store"] }

# Add compaction
meerkat = { version = "0.6.23", default-features = false, features = ["anthropic", "session-store", "session-compaction"] }

# Add scheduling
meerkat = { version = "0.6.23", default-features = false, features = ["anthropic", "session-store", "schedule"] }
