...
<ResponseField name="id" type="str">Stable session UUID used by the runtime.</ResponseField>
<ResponseField name="ref" type="str | None">Optional human-readable session reference.</ResponseField>
<ResponseField name="text" type="str">Assistant text from the most recent turn.</ResponseField>
<ResponseField name="usage" type="Usage">Token usage from the most recent turn.</ResponseField>
<ResponseField name="turns" type="int">Number of LLM turns in the most recent run.</ResponseField>
<ResponseField name="tool_calls" type="int">Number of tool calls in the most recent run.</ResponseField>
<ResponseField name="structured_output" type="Any | None">Structured output from the most recent run, if present.</ResponseField>
<ResponseField name="last_result" type="RunResult">Cached result from the most recent runtime-backed turn.</ResponseField>
...
<ResponseField name="id" type="str">Stable session UUID reserved by the runtime.</ResponseField>
<ResponseField name="ref" type="str | None">Optional human-readable session reference.</ResponseField>
