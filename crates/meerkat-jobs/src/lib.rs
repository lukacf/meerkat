...
//! uniqueness, atomic compare-and-swap, outbox atomicity, and the narrow
//! predicate-delivery idempotency ledger only.
...
pub use types::{
    ...
    JobDescription, JobFailureCode, JobHealthCondition, JobHealthCoverage, JobHealthReading,
