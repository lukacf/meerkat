...
RouteSource(route_name) ==
    CASE route_name = "staged_run_notifies_control" -> "runtime_ingress"
...
RouteEffect(route_name) ==
    CASE route_name = "staged_run_notifies_control" -> "ReadyForRun"
...
RouteTargetMachine(route_name) ==
    CASE route_name = "staged_run_notifies_control" -> "runtime_control"
...
RouteTargetInput(route_name) ==
    CASE route_name = "staged_run_notifies_control" -> "BeginRun"
...
RouteDeliveryKind(route_name) ==
    CASE route_name = "staged_run_notifies_control" -> "Immediate"
...
CoverageInstrumentation == RouteCoverage_staged_run_notifies_control /\ RouteCoverage_control_starts_execution /\ RouteCoverage_execution_boundary_updates_ingress /\ RouteCoverage_execution_completion_updates_ingress /\ RouteCoverage_execution_completion_notifies_control /\ RouteCoverage_execution_failure_updates_ingress /\ RouteCoverage_execution_failure_notifies_control /\ RouteCoverage_execution_cancel_updates_ingress /\ RouteCoverage_execution_cancel_notifies_control /\ SchedulerCoverage_PreemptWhenReady_control_plane_ordinary_ingress
