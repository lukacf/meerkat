...
use meerkat_runtime::input::ContinuationInput;
...
impl McpRuntimeIngressContext {
    ...
    pub(crate) fn callback_results_continuation_input(reason: impl Into<String>) -> Input {
        Input::Continuation(ContinuationInput::callback_tool_results_staged(reason))
    }
