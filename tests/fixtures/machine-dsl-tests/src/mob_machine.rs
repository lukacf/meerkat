...
machine! {
    machine MobMachine {
        ...
        disposition EmitMemberLifecycleNotice => external seam OwnerRealizationOnly,
        disposition EmitRunLifecycleNotice => external seam OwnerRealizationOnly,
        disposition EmitFlowRunNotice => external seam OwnerRealizationOnly,
        disposition AppendFailureLedger => local seam NoOwnerRealization,
        disposition FlowTerminalized => external seam OwnerRealizationOnly,
        ...
        disposition EmitMemberTerminalNotice => external seam OwnerRealizationOnly,
