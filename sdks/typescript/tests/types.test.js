...
describe("Contract Version", () => {
  ...
  it("generated realtime type inventory includes protocol frames without retired open-info", () => {
    const generated = fs.readFileSync(
      new URL("../src/generated/types.ts", import.meta.url),
      "utf8",
    );

    assert.doesNotMatch(generated, /export interface RealtimeOpenInfo/);
