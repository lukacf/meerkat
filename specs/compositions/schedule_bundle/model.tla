...
BaseInit ==
    ...
    /\ occurrence_late_completion_recorded_at_utc_ms = None
    /\ occurrence_late_completion_resolution = None
    /\ occurrence_late_completion_detail = None
    /\ occurrence_stale_completion_arrivals = 0
    /\ model_step_count = 0
    /\ pending_routes = <<>>
    /\ delivered_routes = {}
    /\ emitted_effects = {}
...
WitnessInit_revision_supersede_route ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "schedule", variant |-> "Revise", payload |-> [at_utc_ms |-> 1, misfire_policy |-> "Skip", missing_target_policy |-> "MarkMisfired", overlap_policy |-> "SkipIfRunning", planning_horizon_days |-> 1, planning_horizon_occurrences |-> 2, target_binding_key |-> "targetbindingid_1", trigger_key |-> "triggerkey_1"], source_kind |-> "entry", source_route |-> "witness:revision_supersede_route:1", source_machine |-> "external_entry", source_effect |-> "Revise", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "schedule", variant |-> "Revise", payload |-> [at_utc_ms |-> 1, misfire_policy |-> "Skip", missing_target_policy |-> "MarkMisfired", overlap_policy |-> "SkipIfRunning", planning_horizon_days |-> 1, planning_horizon_occurrences |-> 2, target_binding_key |-> "targetbindingid_1", trigger_key |-> "triggerkey_1"], source_kind |-> "entry", source_route |-> "witness:revision_supersede_route:1", source_machine |-> "external_entry", source_effect |-> "Revise", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "schedule", variant |-> "Revise", payload |-> [at_utc_ms |-> 1, misfire_policy |-> "Skip", missing_target_policy |-> "MarkMisfired", overlap_policy |-> "SkipIfRunning", planning_horizon_days |-> 1, planning_horizon_occurrences |-> 2, target_binding_key |-> "targetbindingid_1", trigger_key |-> "triggerkey_1"], source_kind |-> "entry", source_route |-> "witness:revision_supersede_route:1", source_machine |-> "external_entry", source_effect |-> "Revise", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<>>

WitnessInit_occurrence_supersede_ack_route ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "occurrence", variant |-> "Supersede", payload |-> [at_utc_ms |-> 1, superseded_by_revision |-> 2], source_kind |-> "entry", source_route |-> "witness:occurrence_supersede_ack_route:1", source_machine |-> "external_entry", source_effect |-> "Supersede", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "occurrence", variant |-> "Supersede", payload |-> [at_utc_ms |-> 1, superseded_by_revision |-> 2], source_kind |-> "entry", source_route |-> "witness:occurrence_supersede_ack_route:1", source_machine |-> "external_entry", source_effect |-> "Supersede", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "occurrence", variant |-> "Supersede", payload |-> [at_utc_ms |-> 1, superseded_by_revision |-> 2], source_kind |-> "entry", source_route |-> "witness:occurrence_supersede_ack_route:1", source_machine |-> "external_entry", source_effect |-> "Supersede", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<>>
...
schedule_CreateSchedule(arg_schedule_id, arg_trigger_key, arg_target_binding_key, arg_misfire_policy, arg_overlap_policy, arg_missing_target_policy, arg_planning_horizon_days, arg_planning_horizon_occurrences) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << schedule_revision, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
...
schedule_ReviseActive(arg_trigger_key, arg_target_binding_key, arg_misfire_policy, arg_overlap_policy, arg_missing_target_policy, arg_planning_horizon_days, arg_planning_horizon_occurrences, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "schedule"
       ...
       /\ schedule_planning_cursor_utc_ms' = None
       /\ UNCHANGED << schedule_schedule_id, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
...
schedule_RevisePaused(arg_trigger_key, arg_target_binding_key, arg_misfire_policy, arg_overlap_policy, arg_missing_target_policy, arg_planning_horizon_days, arg_planning_horizon_occurrences, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "schedule"
       /\ packet.variant = "Revise"
       /\ packet.payload.trigger_key = arg_trigger_key
...
schedule_UpdatePlanningConfigActive(arg_planning_horizon_days, arg_planning_horizon_occurrences) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ schedule_planning_horizon_days' = packet.payload.planning_horizon_days
       /\ schedule_planning_horizon_occurrences' = packet.payload.planning_horizon_occurrences
       /\ UNCHANGED << schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
schedule_RecordPlanningWindowActive(arg_planning_cursor_utc_ms, arg_next_occurrence_ordinal) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_superseded_ack_ids, occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
schedule_SyncTargetSnapshotActive(arg_target_binding_key) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ schedule_phase' = "Active"
       /\ schedule_target_binding_key' = packet.payload.target_binding_key
       /\ UNCHANGED << schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
schedule_DeleteActive(arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ schedule_revision' = (schedule_revision) + 1
       /\ schedule_planning_cursor_utc_ms' = None
       /\ UNCHANGED << schedule_schedule_id, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "occurrence", variant |-> "Supersede", payload |-> [at_utc_ms |-> packet.payload.at_utc_ms, superseded_by_revision |-> (schedule_revision) + 1], source_kind |-> "route", source_route |-> "revision_supersede_enters_occurrence_authority", source_machine |-> "schedule", source_effect |-> "SupersedePendingOccurrences", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "occurrence", variant |-> "Supersede", payload |-> [at_utc_ms |-> packet.payload.at_utc_ms, superseded_by_revision |-> (schedule_revision) + 1], source_kind |-> "route", source_route |-> "revision_supersede_enters_occurrence_authority", source_machine |-> "schedule", source_effect |-> "SupersedePendingOccurrences", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
...
schedule_ConfirmOccurrencesSupersededActive(arg_occurrence_id, arg_superseding_revision) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
schedule_deleted_has_no_planning_cursor == (IF (schedule_phase # "Deleted") THEN TRUE ELSE (schedule_planning_cursor_utc_ms = None))
schedule_planning_cursor_requires_occurrence_progress == (IF (schedule_planning_cursor_utc_ms = None) THEN TRUE ELSE (schedule_next_occurrence_ordinal > 0))

occurrence__is_live_claim_phase(arg_phase) == (IF (arg_phase = "Claimed") THEN TRUE ELSE (IF (arg_phase = "Dispatching") THEN TRUE ELSE (arg_phase = "AwaitingCompletion")))
...
occurrence_ClassifyTransitionFailurePlanRejectedPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ occurrence_phase = "Pending"
       /\ ((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
...
occurrence_ClassifyTransitionFailureTargetSyncRejectedPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureReceiptRecordRejectedPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureDueClassificationRejectedPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureClaimedDispatchDispositionRejectedPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureCompletionSupersessionRejectedPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureNotPendingForClaimClaimed(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Claimed"
       /\ ((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Claimed"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureNotClaimedPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureNotDispatchingPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureNotLeaseHoldingPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureNotLiveForTerminalPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedPending(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ ((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition")))
       /\ occurrence_phase' = "Pending"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "Pending", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedPending"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedPending", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Pending"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedClaimed(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "Claimed", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedClaimed"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedClaimed", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Claimed"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedDispatching(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "Dispatching", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedDispatching"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedDispatching", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Dispatching"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedAwaitingCompletion(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "AwaitingCompletion", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedAwaitingCompletion"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedAwaitingCompletion", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "AwaitingCompletion"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedCompleted(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "Completed", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedCompleted"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedCompleted", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Completed"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedSkipped(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "Skipped", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedSkipped"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedSkipped", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Skipped"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedMisfired(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "Misfired", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedMisfired"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedMisfired", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Misfired"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedSuperseded(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "Superseded", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedSuperseded"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedSuperseded", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedDeliveryFailed(arg_refusal_kind, arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyTransitionFailure"
       /\ packet.payload.refusal_kind = arg_refusal_kind
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "TransitionFailureClassified", payload |-> [phase |-> "DeliveryFailed", public_class |-> "StaleCompletionArrivalClassificationRejected", refusal_kind |-> packet.payload.refusal_kind, trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedDeliveryFailed"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyTransitionFailureStaleCompletionArrivalRejectedDeliveryFailed", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "DeliveryFailed"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedPending(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Pending"
       /\ (IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (packet.payload.trigger = "Supersede")))))
       /\ occurrence_phase' = "Pending"
       /\ occurrence_stale_completion_arrivals' = (occurrence_stale_completion_arrivals) + 1
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "Pending", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedPending"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedPending", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Pending"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedClaimed(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "Claimed", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedClaimed"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedClaimed", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Claimed"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedDispatching(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "Dispatching", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedDispatching"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedDispatching", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Dispatching"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedAwaitingCompletion(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "AwaitingCompletion", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedAwaitingCompletion"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedAwaitingCompletion", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "AwaitingCompletion"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedCompleted(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "Completed", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedCompleted"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedCompleted", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Completed"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedSkipped(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "Skipped", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedSkipped"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedSkipped", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Skipped"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedMisfired(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "Misfired", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedMisfired"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedMisfired", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Misfired"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedSuperseded(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "Superseded", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedSuperseded"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedSuperseded", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyStaleCompletionArrivalObservedDeliveryFailed(arg_trigger) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyStaleCompletionArrival"
       /\ packet.payload.trigger = arg_trigger
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "StaleCompletionArrivalClassified", payload |-> [phase |-> "DeliveryFailed", trigger |-> packet.payload.trigger], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyStaleCompletionArrivalObservedDeliveryFailed"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyStaleCompletionArrivalObservedDeliveryFailed", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "DeliveryFailed"]}
       /\ model_step_count' = model_step_count + 1
...
occurrence_PlanOccurrenceFromPending(arg_occurrence_id, arg_schedule_id, arg_schedule_revision, arg_occurrence_ordinal, arg_trigger_key, arg_target_binding_key, arg_misfire_policy, arg_misfire_policy_key, arg_overlap_policy, arg_overlap_policy_key, arg_missing_target_policy, arg_missing_target_policy_key, arg_target_materialized_session_id, arg_due_at_utc_ms, arg_misfire_deadline_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ occurrence_late_completion_detail' = None
       /\ occurrence_stale_completion_arrivals' = 0
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
occurrence_ClassifyDueClaimedLeaseCurrent(arg_now_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Claimed"
       /\ (IF (occurrence_lease_expires_at_utc_ms = None) THEN TRUE ELSE (packet.payload.now_utc_ms < (IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None)))
       /\ occurrence_phase' = "Claimed"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
...
occurrence_ClassifyOccurrenceTerminalityTerminalCompleted ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Completed"
       /\ occurrence_phase' = "Completed"
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> TRUE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityTerminalCompleted"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityTerminalCompleted", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Completed"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyOccurrenceTerminalityTerminalSkipped ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> TRUE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityTerminalSkipped"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityTerminalSkipped", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Skipped"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyOccurrenceTerminalityTerminalMisfired ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> TRUE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityTerminalMisfired"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityTerminalMisfired", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Misfired"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyOccurrenceTerminalityTerminalSuperseded ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> TRUE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityTerminalSuperseded"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityTerminalSuperseded", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyOccurrenceTerminalityTerminalDeliveryFailed ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> TRUE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityTerminalDeliveryFailed"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityTerminalDeliveryFailed", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "DeliveryFailed"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyOccurrenceTerminalityLivePending ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> FALSE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityLivePending"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityLivePending", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Pending"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyOccurrenceTerminalityLiveClaimed ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> FALSE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityLiveClaimed"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityLiveClaimed", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Claimed"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyOccurrenceTerminalityLiveDispatching ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> FALSE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityLiveDispatching"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityLiveDispatching", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Dispatching"]}
       /\ model_step_count' = model_step_count + 1


occurrence_ClassifyOccurrenceTerminalityLiveAwaitingCompletion ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyOccurrenceTerminality"
       /\ ~HigherPriorityReady("occurrence_authority")
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "OccurrenceTerminalityClassified", payload |-> [terminal |-> FALSE], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyOccurrenceTerminalityLiveAwaitingCompletion"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyOccurrenceTerminalityLiveAwaitingCompletion", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "AwaitingCompletion"]}
       /\ model_step_count' = model_step_count + 1
...
occurrence_ClassifyCompletionSupersessionAlreadySuperseded(arg_schedule_phase, arg_current_schedule_revision) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ClassifyCompletionSupersession"
       /\ packet.payload.schedule_phase = arg_schedule_phase
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "CompletionSupersessionClassified", payload |-> [disposition |-> "AlreadySuperseded", superseded_by_revision |-> None], effect_id |-> (model_step_count + 1), source_transition |-> "ClassifyCompletionSupersessionAlreadySuperseded"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ClassifyCompletionSupersessionAlreadySuperseded", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1
...
occurrence_SyncTargetSnapshotPending(arg_target_binding_key, arg_target_materialized_session_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ occurrence_target_binding_key' = packet.payload.target_binding_key
       /\ occurrence_target_materialized_session_id' = packet.payload.target_materialized_session_id
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
occurrence_ClaimPending(arg_owner_id, arg_at_utc_ms, arg_lease_expires_at_utc_ms, arg_claim_token) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_target_materialized_session_id, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
occurrence_DispatchAcceptedFromDispatching(arg_admission_outcome, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "DispatchAccepted"
       /\ packet.payload.admission_outcome = arg_admission_outcome
       /\ packet.payload.at_utc_ms = arg_at_utc_ms
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Dispatching"
       /\ (occurrence_delivery_correlation_id # None)
       /\ (packet.payload.admission_outcome = "Accepted")
       /\ occurrence_phase' = "Dispatching"
       /\ occurrence_receipt_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_receipt_stage' = Some("DispatchAccepted")
       /\ occurrence_receipt_failure_class' = None
       /\ occurrence_receipt_detail' = None
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "DispatchAccepted", payload |-> [tag |-> "unit"], effect_id |-> (model_step_count + 1), source_transition |-> "DispatchAcceptedFromDispatching"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "DispatchAcceptedFromDispatching", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Dispatching"]}
       /\ model_step_count' = model_step_count + 1


occurrence_DispatchDeduplicatedFromDispatching(arg_admission_outcome, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "DispatchAccepted"
       /\ packet.payload.admission_outcome = arg_admission_outcome
       ...
       /\ occurrence_phase = "Dispatching"
       /\ (occurrence_delivery_correlation_id # None)
       /\ (packet.payload.admission_outcome = "Deduplicated")
       /\ occurrence_phase' = "Completed"
       /\ occurrence_receipt_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       ...
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "DispatchAccepted", payload |-> [tag |-> "unit"], effect_id |-> (model_step_count + 1), source_transition |-> "DispatchDeduplicatedFromDispatching"], [machine |-> "occurrence", variant |-> "Completed", payload |-> [tag |-> "unit"], effect_id |-> (model_step_count + 1), source_transition |-> "DispatchDeduplicatedFromDispatching"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "DispatchDeduplicatedFromDispatching", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Completed"]}
       /\ model_step_count' = model_step_count + 1
...
occurrence_AwaitCompletionAfterSupersession(arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "AwaitCompletion"
       /\ packet.payload.at_utc_ms = arg_at_utc_ms
       ...
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "AwaitCompletionAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1
...
occurrence_RuntimeCompletionRuntimeRejected(arg_outcome, arg_detail, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion"
       /\ (IF (packet.payload.outcome = "CallbackPending") THEN TRUE ELSE (IF (packet.payload.outcome = "Cancelled") THEN TRUE ELSE (packet.payload.outcome = "Abandoned")))
       /\ occurrence_phase' = "DeliveryFailed"
       /\ occurrence_receipt_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       ...
       /\ occurrence_completed_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_dispatched_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
occurrence_DeliveryCompletionFailureInternalError(arg_reason, arg_detail, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ~HigherPriorityReady("occurrence_authority")
       /\ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion"
       /\ (IF (packet.payload.reason = "RuntimeCompletionChannelClosed") THEN TRUE ELSE (IF (packet.payload.reason = "RuntimeCompletionAuthorityUnavailable") THEN TRUE ELSE (packet.payload.reason = "RuntimeCompletionHandleMissing")))
       /\ occurrence_phase' = "DeliveryFailed"
       /\ occurrence_receipt_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_receipt_stage' = Some("DeliveryFailed")
       /\ occurrence_receipt_failure_class' = Some("InternalError")
...
occurrence_SupersedePendingOrLive(arg_superseded_by_revision, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_attempt_count, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
...
occurrence_SupersedeAlreadySuperseded(arg_superseded_by_revision, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "Supersede"
       /\ packet.payload.superseded_by_revision = arg_superseded_by_revision
       ...
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "SupersedeAlreadySuperseded", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_LateCompleteAfterSupersession(arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "Complete"
       /\ packet.payload.at_utc_ms = arg_at_utc_ms
       ...
       /\ occurrence_phase = "Superseded"
       /\ occurrence_phase' = "Superseded"
       /\ occurrence_late_completion_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_late_completion_resolution' = Some("DeliveryCompleted")
       /\ occurrence_late_completion_detail' = None
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LateCompletionResolutionRecorded", payload |-> [resolution |-> "DeliveryCompleted"], effect_id |-> (model_step_count + 1), source_transition |-> "LateCompleteAfterSupersession"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "LateCompleteAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_LateRuntimeCompletionCompletedAfterSupersession(arg_outcome, arg_detail, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ResolveRuntimeCompletion"
       /\ packet.payload.outcome = arg_outcome
       ...
       /\ occurrence_phase' = "Superseded"
       /\ occurrence_late_completion_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_late_completion_resolution' = Some("RuntimeCompleted")
       /\ occurrence_late_completion_detail' = packet.payload.detail
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LateCompletionResolutionRecorded", payload |-> [resolution |-> "RuntimeCompleted"], effect_id |-> (model_step_count + 1), source_transition |-> "LateRuntimeCompletionCompletedAfterSupersession"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "LateRuntimeCompletionCompletedAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_LateRuntimeCompletionRejectedAfterSupersession(arg_outcome, arg_detail, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ResolveRuntimeCompletion"
       /\ packet.payload.outcome = arg_outcome
       ...
       /\ occurrence_phase' = "Superseded"
       /\ occurrence_late_completion_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_late_completion_resolution' = Some("RuntimeRejected")
       /\ occurrence_late_completion_detail' = packet.payload.detail
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LateCompletionResolutionRecorded", payload |-> [resolution |-> "RuntimeRejected"], effect_id |-> (model_step_count + 1), source_transition |-> "LateRuntimeCompletionRejectedAfterSupersession"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "LateRuntimeCompletionRejectedAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_LateRuntimeCompletionTransportErrorAfterSupersession(arg_outcome, arg_detail, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ResolveRuntimeCompletion"
       /\ packet.payload.outcome = arg_outcome
       ...
       /\ occurrence_phase' = "Superseded"
       /\ occurrence_late_completion_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_late_completion_resolution' = Some("RuntimeTransportError")
       /\ occurrence_late_completion_detail' = packet.payload.detail
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LateCompletionResolutionRecorded", payload |-> [resolution |-> "RuntimeTransportError"], effect_id |-> (model_step_count + 1), source_transition |-> "LateRuntimeCompletionTransportErrorAfterSupersession"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "LateRuntimeCompletionTransportErrorAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_LateRuntimeCompletionInternalErrorAfterSupersession(arg_outcome, arg_detail, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ResolveRuntimeCompletion"
       /\ packet.payload.outcome = arg_outcome
       ...
       /\ occurrence_phase' = "Superseded"
       /\ occurrence_late_completion_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_late_completion_resolution' = Some("RuntimeInternalError")
       /\ occurrence_late_completion_detail' = packet.payload.detail
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LateCompletionResolutionRecorded", payload |-> [resolution |-> "RuntimeInternalError"], effect_id |-> (model_step_count + 1), source_transition |-> "LateRuntimeCompletionInternalErrorAfterSupersession"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "LateRuntimeCompletionInternalErrorAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_LateDeliveryCompletionFailureAfterSupersession(arg_reason, arg_detail, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ResolveDeliveryCompletionFailure"
       /\ packet.payload.reason = arg_reason
       ...
       /\ occurrence_phase' = "Superseded"
       /\ occurrence_late_completion_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_late_completion_resolution' = Some("DeliveryCompletionFailed")
       /\ occurrence_late_completion_detail' = packet.payload.detail
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LateCompletionResolutionRecorded", payload |-> [resolution |-> "DeliveryCompletionFailed"], effect_id |-> (model_step_count + 1), source_transition |-> "LateDeliveryCompletionFailureAfterSupersession"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "LateDeliveryCompletionFailureAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_LateDeliveryFailureAfterSupersession(arg_reason, arg_detail, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ResolveDeliveryFailure"
       /\ packet.payload.reason = arg_reason
       ...
       /\ occurrence_phase' = "Superseded"
       /\ occurrence_late_completion_recorded_at_utc_ms' = Some(packet.payload.at_utc_ms)
       /\ occurrence_late_completion_resolution' = Some("DeliveryFailed")
       /\ occurrence_late_completion_detail' = packet.payload.detail
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_stale_completion_arrivals, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LateCompletionResolutionRecorded", payload |-> [resolution |-> "DeliveryFailed"], effect_id |-> (model_step_count + 1), source_transition |-> "LateDeliveryFailureAfterSupersession"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "LateDeliveryFailureAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_RenewLeaseFromDispatching(arg_claim_token, arg_lease_expires_at_utc_ms, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       ...
       /\ occurrence_phase = "Dispatching"
       /\ (occurrence_claim_token = Some(packet.payload.claim_token))
       /\ (IF (occurrence_lease_expires_at_utc_ms = None) THEN TRUE ELSE ((IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None) <= packet.payload.lease_expires_at_utc_ms))
       /\ occurrence_phase' = "Dispatching"
       /\ occurrence_lease_expires_at_utc_ms' = Some(packet.payload.lease_expires_at_utc_ms)
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LeaseRenewed", payload |-> [tag |-> "unit"], effect_id |-> (model_step_count + 1), source_transition |-> "RenewLeaseFromDispatching"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "RenewLeaseFromDispatching", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Dispatching"]}
       /\ model_step_count' = model_step_count + 1


occurrence_RenewLeaseFromAwaitingCompletion(arg_claim_token, arg_lease_expires_at_utc_ms, arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "RenewLease"
       /\ packet.payload.claim_token = arg_claim_token
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "occurrence", variant |-> "LeaseRenewed", payload |-> [tag |-> "unit"], effect_id |-> (model_step_count + 1), source_transition |-> "RenewLeaseFromAwaitingCompletion"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "RenewLeaseFromAwaitingCompletion", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "AwaitingCompletion"]}
       /\ model_step_count' = model_step_count + 1
...
occurrence_ReleaseLeaseForPausedScheduleAfterSupersession(arg_at_utc_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "occurrence"
       /\ packet.variant = "ReleaseLeaseForPausedSchedule"
       /\ packet.payload.at_utc_ms = arg_at_utc_ms
       ...
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "occurrence", transition |-> "ReleaseLeaseForPausedScheduleAfterSupersession", actor |-> "occurrence_authority", step |-> (model_step_count + 1), from_phase |-> occurrence_phase, to_phase |-> "Superseded"]}
       /\ model_step_count' = model_step_count + 1


occurrence_live_claim_requires_owner == (IF ~(occurrence__is_live_claim_phase(occurrence_phase)) THEN TRUE ELSE (occurrence_claimed_by # None))
occurrence_superseded_records_revision == (IF (occurrence_phase # "Superseded") THEN TRUE ELSE (occurrence_superseded_by_revision # None))
occurrence_delivery_failed_records_failure_class == (IF (occurrence_phase # "DeliveryFailed") THEN TRUE ELSE (occurrence_failure_class # None))
occurrence_misfire_deadline_not_before_due == (occurrence_misfire_deadline_utc_ms >= occurrence_due_at_utc_ms)
occurrence_late_completion_only_after_supersession == (IF (occurrence_late_completion_resolution = None) THEN TRUE ELSE (occurrence_phase = "Superseded"))
occurrence_late_completion_resolution_requires_timestamp == (IF (occurrence_late_completion_resolution = None) THEN TRUE ELSE (occurrence_late_completion_recorded_at_utc_ms # None))
occurrence_late_completion_timestamp_requires_resolution == (IF (occurrence_late_completion_recorded_at_utc_ms = None) THEN TRUE ELSE (occurrence_late_completion_resolution # None))
occurrence_late_completion_detail_requires_resolution == (IF (occurrence_late_completion_detail = None) THEN TRUE ELSE (occurrence_late_completion_resolution # None))

EntryPacketAdmissible_schedule(packet) ==
    \/ /\ (packet.variant = "Create") /\ (schedule_phase = "Active")
    \/ /\ (packet.variant = "Revise") /\ (schedule_phase = "Active")
    ...
    \/ /\ (packet.variant = "Resume") /\ (schedule_phase = "Active" \/ schedule_phase = "Paused")
    \/ /\ (packet.variant = "Delete") /\ (schedule_phase = "Active")
    \/ /\ (packet.variant = "Delete") /\ (schedule_phase = "Paused")
    \/ /\ (packet.variant = "Delete") /\ (schedule_phase = "Deleted")
    \/ /\ (packet.variant = "ConfirmOccurrencesSuperseded") /\ (schedule_phase = "Active")
    \/ /\ (packet.variant = "ConfirmOccurrencesSuperseded") /\ (schedule_phase = "Paused")
    \/ /\ (packet.variant = "ConfirmOccurrencesSuperseded") /\ (schedule_phase = "Deleted")

occurrence__entry_packet__is_live_claim_phase(arg_phase) == (IF (arg_phase = "Claimed") THEN TRUE ELSE (IF (arg_phase = "Dispatching") THEN TRUE ELSE (arg_phase = "AwaitingCompletion")))

EntryPacketAdmissible_occurrence(packet) ==
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "PlanOccurrence") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "SyncTargetSnapshot") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "RecordReceipt") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "ClassifyDue") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "ClassifyClaimedDispatchDisposition") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "ClassifyCompletionSupersession") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "Claim") /\ (packet.payload.refusal_kind = "GuardRejected")))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "Claim") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "DispatchStarted") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((IF (packet.payload.trigger = "DispatchAccepted") THEN TRUE ELSE (packet.payload.trigger = "AwaitCompletion")) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((IF (packet.payload.trigger = "LeaseExpired") THEN TRUE ELSE (IF (packet.payload.trigger = "ReleaseLeaseForPausedSchedule") THEN TRUE ELSE (packet.payload.trigger = "RenewLease"))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveTargetProbe") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDueMisfire") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))) /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Pending") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Dispatching") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Completed") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Skipped") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Misfired") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "Superseded") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyTransitionFailure") /\ (occurrence_phase = "DeliveryFailed") /\ (((packet.payload.trigger = "ClassifyStaleCompletionArrival") /\ (IF (packet.payload.refusal_kind = "GuardRejected") THEN TRUE ELSE (packet.payload.refusal_kind = "NoMatchingTransition"))))
    \/ /\ (packet.variant = "ClassifyStaleCompletionArrival") /\ (occurrence_phase = "Pending") /\ ((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))
    \/ /\ (packet.variant = "ClassifyStaleCompletionArrival") /\ (occurrence_phase = "Claimed") /\ ((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))
    \/ /\ (packet.variant = "ClassifyStaleCompletionArrival") /\ (occurrence_phase = "Dispatching") /\ ((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))
    \/ /\ (packet.variant = "ClassifyStaleCompletionArrival") /\ (occurrence_phase = "AwaitingCompletion") /\ ((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))
    \/ /\ (packet.variant = "ClassifyStaleCompletionArrival") /\ (occurrence_phase = "Completed") /\ ((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))
    ...
    \/ /\ (packet.variant = "ClassifyStaleCompletionArrival") /\ (occurrence_phase = "Superseded") /\ ((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))
    \/ /\ (packet.variant = "ClassifyStaleCompletionArrival") /\ (occurrence_phase = "DeliveryFailed") /\ ((IF (packet.payload.trigger = "Complete") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveRuntimeCompletion") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryCompletionFailure") THEN TRUE ELSE (IF (packet.payload.trigger = "ResolveDeliveryFailure") THEN TRUE ELSE (packet.payload.trigger = "Supersede"))))))
    \/ /\ (packet.variant = "PlanOccurrence") /\ (occurrence_phase = "Pending") /\ (((occurrence_attempt_count = 0) /\ (occurrence_claimed_by = None) /\ (occurrence_claim_token = None) /\ (occurrence_delivery_correlation_id = None) /\ (occurrence_target_materialized_session_id = None) /\ (occurrence_completed_at_utc_ms = None) /\ (occurrence_superseded_by_revision = None) /\ (packet.payload.misfire_deadline_utc_ms >= packet.payload.due_at_utc_ms)))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Pending") /\ ((packet.payload.now_utc_ms < occurrence_due_at_utc_ms))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Pending") /\ (((occurrence_due_at_utc_ms <= packet.payload.now_utc_ms) /\ (occurrence_misfire_deadline_utc_ms < packet.payload.now_utc_ms)))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Pending") /\ (((occurrence_due_at_utc_ms <= packet.payload.now_utc_ms) /\ (packet.payload.now_utc_ms <= occurrence_misfire_deadline_utc_ms)))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Claimed") /\ (((occurrence_lease_expires_at_utc_ms # None) /\ ((IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None) <= packet.payload.now_utc_ms)))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Dispatching") /\ (((occurrence_lease_expires_at_utc_ms # None) /\ ((IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None) <= packet.payload.now_utc_ms)))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "AwaitingCompletion") /\ (((occurrence_lease_expires_at_utc_ms # None) /\ ((IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None) <= packet.payload.now_utc_ms)))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Claimed") /\ ((IF (occurrence_lease_expires_at_utc_ms = None) THEN TRUE ELSE (packet.payload.now_utc_ms < (IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None))))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Dispatching") /\ ((IF (occurrence_lease_expires_at_utc_ms = None) THEN TRUE ELSE (packet.payload.now_utc_ms < (IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None))))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "AwaitingCompletion") /\ ((IF (occurrence_lease_expires_at_utc_ms = None) THEN TRUE ELSE (packet.payload.now_utc_ms < (IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None))))
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Completed")
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Skipped")
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Misfired")
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "Superseded")
    \/ /\ (packet.variant = "ClassifyDue") /\ (occurrence_phase = "DeliveryFailed")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "Completed")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "Skipped")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "Misfired")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "Superseded")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "DeliveryFailed")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "Pending")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "Claimed")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "Dispatching")
    \/ /\ (packet.variant = "ClassifyOccurrenceTerminality") /\ (occurrence_phase = "AwaitingCompletion")
    \/ /\ (packet.variant = "ClassifyClaimedDispatchDisposition") /\ (occurrence_phase = "Claimed") /\ ((packet.payload.current_schedule_revision < occurrence_schedule_revision))
    \/ /\ (packet.variant = "ClassifyClaimedDispatchDisposition") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.current_schedule_revision >= occurrence_schedule_revision) /\ (packet.payload.schedule_phase = "Paused")))
    \/ /\ (packet.variant = "ClassifyClaimedDispatchDisposition") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.current_schedule_revision >= occurrence_schedule_revision) /\ (packet.payload.schedule_phase = "Deleted")))
    \/ /\ (packet.variant = "ClassifyClaimedDispatchDisposition") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.schedule_phase = "Active") /\ (occurrence_schedule_revision < packet.payload.current_schedule_revision)))
    \/ /\ (packet.variant = "ClassifyClaimedDispatchDisposition") /\ (occurrence_phase = "Claimed") /\ (((packet.payload.schedule_phase = "Active") /\ (occurrence_schedule_revision = packet.payload.current_schedule_revision)))
    \/ /\ (packet.variant = "ClassifyCompletionSupersession") /\ (occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.schedule_phase = "Deleted"))
    \/ /\ (packet.variant = "ClassifyCompletionSupersession") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.schedule_phase # "Deleted") /\ (occurrence_schedule_revision < packet.payload.current_schedule_revision)))
    \/ /\ (packet.variant = "ClassifyCompletionSupersession") /\ (occurrence_phase = "AwaitingCompletion") /\ (((packet.payload.schedule_phase # "Deleted") /\ (occurrence_schedule_revision >= packet.payload.current_schedule_revision)))
    \/ /\ (packet.variant = "ClassifyCompletionSupersession") /\ (occurrence_phase = "Superseded")
    \/ /\ (packet.variant = "SyncTargetSnapshot") /\ (occurrence_phase = "Pending")
    \/ /\ (packet.variant = "SyncTargetSnapshot") /\ (occurrence_phase = "Claimed")
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "Pending") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "Claimed") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "Dispatching") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "AwaitingCompletion") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "Completed") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "Skipped") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "Misfired") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "Superseded") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "RecordReceipt") /\ (occurrence_phase = "DeliveryFailed") /\ (((occurrence_receipt_stage # None) /\ (occurrence_receipt_recorded_at_utc_ms # None) /\ (occurrence_receipt_detail = packet.payload.detail) /\ (occurrence_delivery_correlation_id = packet.payload.correlation_id) /\ (occurrence_target_materialized_session_id = packet.payload.materialized_session_id)))
    \/ /\ (packet.variant = "Claim") /\ (occurrence_phase = "Pending") /\ (((occurrence_due_at_utc_ms <= packet.payload.at_utc_ms) /\ (packet.payload.at_utc_ms <= occurrence_misfire_deadline_utc_ms)))
    \/ /\ (packet.variant = "DispatchStarted") /\ (occurrence_phase = "Claimed")
    \/ /\ (packet.variant = "DispatchAccepted") /\ (occurrence_phase = "Dispatching") /\ ((occurrence_delivery_correlation_id # None)) /\ ((packet.payload.admission_outcome = "Accepted"))
    \/ /\ (packet.variant = "DispatchAccepted") /\ (occurrence_phase = "Dispatching") /\ ((occurrence_delivery_correlation_id # None)) /\ ((packet.payload.admission_outcome = "Deduplicated"))
    \/ /\ (packet.variant = "AwaitCompletion") /\ (occurrence_phase = "Dispatching")
    \/ /\ (packet.variant = "AwaitCompletion") /\ (occurrence_phase = "Superseded")
    \/ /\ (packet.variant = "Complete") /\ (occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion")
    \/ /\ (packet.variant = "ResolveRuntimeCompletion") /\ (occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.outcome = "Completed"))
    \/ /\ (packet.variant = "ResolveRuntimeCompletion") /\ (occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((IF (packet.payload.outcome = "CallbackPending") THEN TRUE ELSE (IF (packet.payload.outcome = "Cancelled") THEN TRUE ELSE (packet.payload.outcome = "Abandoned"))))
    \/ /\ (packet.variant = "ResolveRuntimeCompletion") /\ (occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.outcome = "RuntimeTerminated"))
    \/ /\ (packet.variant = "ResolveRuntimeCompletion") /\ (occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.outcome = "FinalizationFailed"))
    \/ /\ (packet.variant = "ResolveDeliveryCompletionFailure") /\ (occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.reason = "CompletionFutureFailed"))
    \/ /\ (packet.variant = "ResolveDeliveryCompletionFailure") /\ (occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((IF (packet.payload.reason = "RuntimeCompletionChannelClosed") THEN TRUE ELSE (IF (packet.payload.reason = "RuntimeCompletionAuthorityUnavailable") THEN TRUE ELSE (packet.payload.reason = "RuntimeCompletionHandleMissing"))))
    \/ /\ (packet.variant = "ResolveDeliveryFailure") /\ (occurrence_phase = "Claimed" \/ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.reason = "TargetMaterializationFailed"))
    \/ /\ (packet.variant = "ResolveDeliveryFailure") /\ (occurrence_phase = "Claimed" \/ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.reason = "TargetMissing"))
    \/ /\ (packet.variant = "ResolveDeliveryFailure") /\ (occurrence_phase = "Claimed" \/ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.reason = "TargetBusy"))
    \/ /\ (packet.variant = "ResolveDeliveryFailure") /\ (occurrence_phase = "Claimed" \/ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.reason = "RuntimeRejected"))
    \/ /\ (packet.variant = "ResolveDeliveryFailure") /\ (occurrence_phase = "Claimed" \/ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.reason = "MobRejected"))
    \/ /\ (packet.variant = "ResolveDeliveryFailure") /\ (occurrence_phase = "Claimed" \/ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.reason = "TransportError"))
    \/ /\ (packet.variant = "ResolveDeliveryFailure") /\ (occurrence_phase = "Claimed" \/ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion") /\ ((packet.payload.reason = "InternalError"))
    \/ /\ (packet.variant = "ResolveTargetProbe") /\ (occurrence_phase = "Claimed") /\ ((packet.payload.outcome = "Ready"))
    \/ /\ (packet.variant = "ResolveTargetProbe") /\ (occurrence_phase = "Claimed") /\ ((packet.payload.outcome = "Busy")) /\ ((occurrence_overlap_policy = "AllowConcurrent"))
    \/ /\ (packet.variant = "ResolveTargetProbe") /\ (occurrence_phase = "Claimed") /\ ((packet.payload.outcome = "Busy")) /\ ((occurrence_overlap_policy = "SkipIfRunning"))
    \/ /\ (packet.variant = "ResolveTargetProbe") /\ (occurrence_phase = "Claimed") /\ ((packet.payload.outcome = "Missing")) /\ ((occurrence_missing_target_policy = "Skip"))
    \/ /\ (packet.variant = "ResolveTargetProbe") /\ (occurrence_phase = "Claimed") /\ ((packet.payload.outcome = "Missing")) /\ ((occurrence_missing_target_policy = "MarkMisfired"))
    \/ /\ (packet.variant = "ResolveDueMisfire") /\ (occurrence_phase = "Pending") /\ (((occurrence_due_at_utc_ms <= packet.payload.at_utc_ms) /\ (occurrence_misfire_deadline_utc_ms < packet.payload.at_utc_ms)))
    \/ /\ (packet.variant = "Supersede") /\ (occurrence_phase = "Pending" \/ occurrence_phase = "Claimed" \/ occurrence_phase = "Dispatching" \/ occurrence_phase = "AwaitingCompletion")
    \/ /\ (packet.variant = "Supersede") /\ (occurrence_phase = "Superseded")
    \/ /\ (packet.variant = "Complete") /\ (occurrence_phase = "Superseded")
    \/ /\ (packet.variant = "ResolveRuntimeCompletion") /\ (occurrence_phase = "Superseded") /\ ((packet.payload.outcome = "Completed"))
    \/ /\ (packet.variant = "ResolveRuntimeCompletion") /\ (occurrence_phase = "Superseded") /\ ((IF (packet.payload.outcome = "CallbackPending") THEN TRUE ELSE (IF (packet.payload.outcome = "Cancelled") THEN TRUE ELSE (packet.payload.outcome = "Abandoned"))))
    \/ /\ (packet.variant = "ResolveRuntimeCompletion") /\ (occurrence_phase = "Superseded") /\ ((packet.payload.outcome = "RuntimeTerminated"))
    \/ /\ (packet.variant = "ResolveRuntimeCompletion") /\ (occurrence_phase = "Superseded") /\ ((packet.payload.outcome = "FinalizationFailed"))
    \/ /\ (packet.variant = "ResolveDeliveryCompletionFailure") /\ (occurrence_phase = "Superseded")
    \/ /\ (packet.variant = "ResolveDeliveryFailure") /\ (occurrence_phase = "Superseded")
    \/ /\ (packet.variant = "RenewLease") /\ (occurrence_phase = "Dispatching") /\ ((occurrence_claim_token = Some(packet.payload.claim_token))) /\ ((IF (occurrence_lease_expires_at_utc_ms = None) THEN TRUE ELSE ((IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None) <= packet.payload.lease_expires_at_utc_ms)))
    \/ /\ (packet.variant = "RenewLease") /\ (occurrence_phase = "AwaitingCompletion") /\ ((occurrence_claim_token = Some(packet.payload.claim_token))) /\ ((IF (occurrence_lease_expires_at_utc_ms = None) THEN TRUE ELSE ((IF "value" \in DOMAIN occurrence_lease_expires_at_utc_ms THEN occurrence_lease_expires_at_utc_ms["value"] ELSE None) <= packet.payload.lease_expires_at_utc_ms)))
    \/ /\ (packet.variant = "LeaseExpired") /\ (occurrence_phase = "Claimed")
    \/ /\ (packet.variant = "LeaseExpired") /\ (occurrence_phase = "Dispatching")
    \/ /\ (packet.variant = "LeaseExpired") /\ (occurrence_phase = "AwaitingCompletion")
    \/ /\ (packet.variant = "ReleaseLeaseForPausedSchedule") /\ (occurrence_phase = "Claimed")
    \/ /\ (packet.variant = "ReleaseLeaseForPausedSchedule") /\ (occurrence_phase = "Dispatching")
    \/ /\ (packet.variant = "ReleaseLeaseForPausedSchedule") /\ (occurrence_phase = "AwaitingCompletion")
    \/ /\ (packet.variant = "ReleaseLeaseForPausedSchedule") /\ (occurrence_phase = "Superseded")

EntryPacketAdmissible(packet) ==
    CASE
      packet.machine = "schedule" -> EntryPacketAdmissible_schedule(packet)
      [] packet.machine = "occurrence" -> EntryPacketAdmissible_occurrence(packet)
      [] OTHER -> FALSE
...
DeliverQueuedRoute ==
    ...
    /\ LET route == Head(pending_routes) IN
       ...
       /\ UNCHANGED << schedule_phase, schedule_schedule_id, schedule_revision, schedule_trigger_key, schedule_target_binding_key, schedule_misfire_policy, schedule_overlap_policy, schedule_missing_target_policy, schedule_planning_horizon_days, schedule_planning_horizon_occurrences, schedule_planning_cursor_utc_ms, schedule_next_occurrence_ordinal, schedule_superseded_ack_ids, occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_trigger_key, occurrence_target_binding_key, occurrence_misfire_policy, occurrence_misfire_policy_key, occurrence_overlap_policy, occurrence_overlap_policy_key, occurrence_missing_target_policy, occurrence_missing_target_policy_key, occurrence_due_at_utc_ms, occurrence_misfire_deadline_utc_ms, occurrence_claimed_by, occurrence_lease_expires_at_utc_ms, occurrence_claimed_at_utc_ms, occurrence_claim_token, occurrence_delivery_correlation_id, occurrence_target_materialized_session_id, occurrence_receipt_recorded_at_utc_ms, occurrence_last_receipt_recorded_at_utc_ms, occurrence_last_receipt_attempt, occurrence_last_receipt_stage, occurrence_last_receipt_failure_class, occurrence_last_receipt_detail, occurrence_last_receipt_correlation_id, occurrence_last_receipt_materialized_session_id, occurrence_runtime_outcome_key, occurrence_receipt_stage, occurrence_receipt_failure_class, occurrence_receipt_detail, occurrence_failure_class, occurrence_failure_detail, occurrence_dispatched_at_utc_ms, occurrence_completed_at_utc_ms, occurrence_attempt_count, occurrence_superseded_by_revision, occurrence_late_completion_recorded_at_utc_ms, occurrence_late_completion_resolution, occurrence_late_completion_detail, occurrence_stale_completion_arrivals, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
WitnessScriptComplete_revision_supersede_route ==
    ...
    /\ Len(pending_routes) = 0
    /\ \E packet \in delivered_routes : packet.route = "revision_supersede_enters_occurrence_authority"
    /\ (\E packet \in observed_transitions : /\ packet.machine = "schedule" /\ packet.transition = "ReviseActive")
...
CoreNext ==
    ...
    \/ \E arg_target_binding_key \in TargetBindingIdValues : schedule_SyncTargetSnapshotActive(arg_target_binding_key)
    \/ \E arg_target_binding_key \in TargetBindingIdValues : schedule_SyncTargetSnapshotPaused(arg_target_binding_key)
    ...
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedPending(arg_refusal_kind, arg_trigger)
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedClaimed(arg_refusal_kind, arg_trigger)
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedDispatching(arg_refusal_kind, arg_trigger)
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedAwaitingCompletion(arg_refusal_kind, arg_trigger)
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedCompleted(arg_refusal_kind, arg_trigger)
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedSkipped(arg_refusal_kind, arg_trigger)
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedMisfired(arg_refusal_kind, arg_trigger)
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedSuperseded(arg_refusal_kind, arg_trigger)
    \/ \E arg_refusal_kind \in OccurrenceTransitionFailureRefusalKindValues : \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyTransitionFailureStaleCompletionArrivalRejectedDeliveryFailed(arg_refusal_kind, arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedPending(arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedClaimed(arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedDispatching(arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedAwaitingCompletion(arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedCompleted(arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedSkipped(arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedMisfired(arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedSuperseded(arg_trigger)
    \/ \E arg_trigger \in OccurrenceLifecycleInputVariantValues : occurrence_ClassifyStaleCompletionArrivalObservedDeliveryFailed(arg_trigger)
    ...
    \/ \E arg_schedule_phase \in ClaimedDispatchSchedulePhaseValues : \E arg_current_schedule_revision \in 0..2 : occurrence_ClassifyCompletionSupersessionAlreadySuperseded(arg_schedule_phase, arg_current_schedule_revision)
    \/ \E arg_target_binding_key \in TargetBindingIdValues : \E arg_target_materialized_session_id \in OptionSessionIdValues : occurrence_SyncTargetSnapshotPending(arg_target_binding_key, arg_target_materialized_session_id)
    \/ \E arg_target_binding_key \in TargetBindingIdValues : \E arg_target_materialized_session_id \in OptionSessionIdValues : occurrence_SyncTargetSnapshotClaimed(arg_target_binding_key, arg_target_materialized_session_id)
    \/ \E arg_correlation_id \in OptionCorrelationIdValues : \E arg_detail \in OptionStringValues : \E arg_materialized_session_id \in OptionSessionIdValues : \E arg_runtime_outcome_key \in OptionRuntimeOutcomeKeyValues : occurrence_RecordReceiptPending(arg_correlation_id, arg_detail, arg_materialized_session_id, arg_runtime_outcome_key)
    \/ \E arg_correlation_id \in OptionCorrelationIdValues : \E arg_detail \in OptionStringValues : \E arg_materialized_session_id \in OptionSessionIdValues : \E arg_runtime_outcome_key \in OptionRuntimeOutcomeKeyValues : occurrence_RecordReceiptClaimed(arg_correlation_id, arg_detail, arg_materialized_session_id, arg_runtime_outcome_key)
    ...
    \/ \E arg_correlation_id \in OptionCorrelationIdValues : \E arg_detail \in OptionStringValues : \E arg_materialized_session_id \in OptionSessionIdValues : \E arg_runtime_outcome_key \in OptionRuntimeOutcomeKeyValues : occurrence_RecordReceiptDeliveryFailed(arg_correlation_id, arg_detail, arg_materialized_session_id, arg_runtime_outcome_key)
    \/ \E arg_owner_id \in ClaimOwnerValues : \E arg_at_utc_ms \in 0..2 : \E arg_lease_expires_at_utc_ms \in 0..2 : \E arg_claim_token \in ClaimTokenValues : occurrence_ClaimPending(arg_owner_id, arg_at_utc_ms, arg_lease_expires_at_utc_ms, arg_claim_token)
    \/ \E arg_correlation_id \in OptionCorrelationIdValues : \E arg_at_utc_ms \in 0..2 : occurrence_DispatchStartedFromClaimed(arg_correlation_id, arg_at_utc_ms)
    \/ \E arg_admission_outcome \in DeliveryAdmissionOutcomeValues : \E arg_at_utc_ms \in 0..2 : occurrence_DispatchAcceptedFromDispatching(arg_admission_outcome, arg_at_utc_ms)
    \/ \E arg_admission_outcome \in DeliveryAdmissionOutcomeValues : \E arg_at_utc_ms \in 0..2 : occurrence_DispatchDeduplicatedFromDispatching(arg_admission_outcome, arg_at_utc_ms)
    \/ \E arg_at_utc_ms \in 0..2 : occurrence_AwaitCompletionFromDispatching(arg_at_utc_ms)
    \/ \E arg_at_utc_ms \in 0..2 : occurrence_AwaitCompletionAfterSupersession(arg_at_utc_ms)
    ...
    \/ \E arg_superseded_by_revision \in 0..2 : \E arg_at_utc_ms \in 0..2 : occurrence_SupersedeAlreadySuperseded(arg_superseded_by_revision, arg_at_utc_ms)
    \/ \E arg_at_utc_ms \in 0..2 : occurrence_LateCompleteAfterSupersession(arg_at_utc_ms)
    \/ \E arg_outcome \in RuntimeCompletionOutcomeValues : \E arg_detail \in OptionStringValues : \E arg_at_utc_ms \in 0..2 : occurrence_LateRuntimeCompletionCompletedAfterSupersession(arg_outcome, arg_detail, arg_at_utc_ms)
    \/ \E arg_outcome \in RuntimeCompletionOutcomeValues : \E arg_detail \in OptionStringValues : \E arg_at_utc_ms \in 0..2 : occurrence_LateRuntimeCompletionRejectedAfterSupersession(arg_outcome, arg_detail, arg_at_utc_ms)
    \/ \E arg_outcome \in RuntimeCompletionOutcomeValues : \E arg_detail \in OptionStringValues : \E arg_at_utc_ms \in 0..2 : occurrence_LateRuntimeCompletionTransportErrorAfterSupersession(arg_outcome, arg_detail, arg_at_utc_ms)
    \/ \E arg_outcome \in RuntimeCompletionOutcomeValues : \E arg_detail \in OptionStringValues : \E arg_at_utc_ms \in 0..2 : occurrence_LateRuntimeCompletionInternalErrorAfterSupersession(arg_outcome, arg_detail, arg_at_utc_ms)
    \/ \E arg_reason \in DeliveryCompletionFailureReasonValues : \E arg_detail \in OptionStringValues : \E arg_at_utc_ms \in 0..2 : occurrence_LateDeliveryCompletionFailureAfterSupersession(arg_reason, arg_detail, arg_at_utc_ms)
    \/ \E arg_reason \in DeliveryFailureReasonValues : \E arg_detail \in OptionStringValues : \E arg_at_utc_ms \in 0..2 : occurrence_LateDeliveryFailureAfterSupersession(arg_reason, arg_detail, arg_at_utc_ms)
    \/ \E arg_claim_token \in ClaimTokenValues : \E arg_lease_expires_at_utc_ms \in 0..2 : \E arg_at_utc_ms \in 0..2 : occurrence_RenewLeaseFromDispatching(arg_claim_token, arg_lease_expires_at_utc_ms, arg_at_utc_ms)
    \/ \E arg_claim_token \in ClaimTokenValues : \E arg_lease_expires_at_utc_ms \in 0..2 : \E arg_at_utc_ms \in 0..2 : occurrence_RenewLeaseFromAwaitingCompletion(arg_claim_token, arg_lease_expires_at_utc_ms, arg_at_utc_ms)
    ...
    \/ \E arg_at_utc_ms \in 0..2 : occurrence_ReleaseLeaseForPausedScheduleAfterSupersession(arg_at_utc_ms)
    \/ QuiescentStutter
...
RouteObserved_revision_supersede_enters_occurrence_authority == \E packet \in delivered_routes : packet.route = "revision_supersede_enters_occurrence_authority"
...
RouteObserved_occurrence_supersede_ack_returns_to_schedule == \E packet \in delivered_routes : packet.route = "occurrence_supersede_ack_returns_to_schedule"
...
THEOREM Spec => []occurrence_late_completion_only_after_supersession
THEOREM Spec => []occurrence_late_completion_resolution_requires_timestamp
THEOREM Spec => []occurrence_late_completion_timestamp_requires_resolution
THEOREM Spec => []occurrence_late_completion_detail_requires_resolution
