...
- `workgraph_topology_legality` — ValidateLink, LinkValidated, and topology_snapshot_is_stateless reject missing endpoints, self edges, duplicate edges, and dependency cycles without adding a separate topology machine
