...
Lease expiry alone does not mutate the item: a Schedule-owned sweep or another
trusted host must observe it, after which WorkGraph commits the release and a
