...
Scheduling is owned by Meerkat's `ScheduleService`. See [Scheduling](/mobkit/concepts/scheduling).
...
- [Events](/mobkit/concepts/events) - exact module event types and startup lifecycle
- [Architecture](/mobkit/reference/architecture) - module ownership in the runtime
- [Configuration](/mobkit/reference/configuration) - runtime options and manifests
