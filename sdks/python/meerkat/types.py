...
from .generated.types import (
    ...
    ModelFallbackConfig as ModelFallbackConfig,
    ModelFallbackPolicy as ModelFallbackPolicy,
    ModelFallbackTarget as ModelFallbackTarget,
    ModelFallbackTrigger as ModelFallbackTrigger,
    WireMobRuntimeConfig as WireMobRuntimeConfig,
