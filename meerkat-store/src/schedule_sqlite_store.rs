...
use meerkat_schedule::{
    ClaimDueRequest, ClaimDueResult, DeliveryReceipt, Occurrence, OccurrenceFilter,
    OccurrenceLifecycleAuthority, OccurrenceLifecycleError, OccurrenceLifecycleInput, Schedule,
    ...
    async fn claim_due_occurrences_impl(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let mut claimed = Vec::new();
            {
                ...
                let rows =
                    stmt.query_map(params![store_now_ms, limit], |row| row.get::<_, Vec<u8>>(0))?;
...
fn write_schedule_in_txn(
    ...
    tx.execute(
        ...
        params![
            ...
            millis(schedule.created_at_utc),
            millis(schedule.updated_at_utc),
