...
<ParamField body="turn_metadata" type="RuntimeTurnMetadata | null" default="null">
  Canonical first-turn runtime metadata. Put model/provider/provider_params, skill_references, additional_instructions, keep_alive, and render metadata inside this object; split top-level metadata fields are rejected.
</ParamField>
...
<ParamField body="comms_name" type="string | null" default="null">
  Agent name for comms. Required when `turn_metadata.keep_alive` enables keep-alive.
</ParamField>
...
<ParamField body="turn_metadata" type="RuntimeTurnMetadata | null" default="null">
  Canonical per-turn runtime metadata. Put turn-scoped model/provider/provider_params, skill_references, flow_tool_overlay, additional_instructions, keep_alive, and render metadata inside this object; split top-level metadata fields are rejected.
</ParamField>
