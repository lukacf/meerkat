...
- 📌 Remaining: A3, A4, A5 (DSL-schema migration), A10 (rest), B6, C1, C5 — all tracked, all require regression coverage per the "extensive regression tests" standard. Priority order:
