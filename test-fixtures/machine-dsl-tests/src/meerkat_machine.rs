...
machine! {
    machine MeerkatMachine {
        ...
        disposition CommittedVisibleSetPublished => external seam OwnerRealizationOnly,
        disposition RuntimeNotice => external seam OwnerRealizationOnly,
        ...
        disposition InputLifecycleNotice => external seam OwnerRealizationOnly,
        disposition CompletionResolved => local seam NoOwnerRealization,
        disposition IngressNotice => external seam OwnerRealizationOnly,
        disposition SilentIntentApplied => external seam OwnerRealizationOnly,
        ...
        disposition WaitAllSatisfied => local seam NoOwnerRealization,
        ...
        disposition ScheduleSurfaceCompletion => local seam NoOwnerRealization,
        disposition RefreshVisibleSurfaceSet => external seam OwnerRealizationOnly,
