...
pub fn rpc_method_catalog(options: RpcMethodCatalogOptions) -> Vec<RpcMethodDescriptor> {
    let mut methods = vec![
        ...
        RpcMethodDescriptor::typed(
            "session/export_atif",
            "Export currently projected session replay evidence as an ATIF trajectory",
            "ExportAtifParams",
            "Value",
        ),
        RpcMethodDescriptor::typed(
        ...
        RpcMethodDescriptor::typed(
            "approval/request",
            "Create an approval audit record; persistence depends on the host store",
            "ApprovalRequestParams",
            "ApprovalRecord",
        ),
        RpcMethodDescriptor::typed(
            "approval/list",
            "List approval audit records",
            "ApprovalListParams",
            "ApprovalListResult",
        ),
        RpcMethodDescriptor::typed(
            "approval/get",
            "Get one approval audit record",
            "ApprovalGetParams",
            "ApprovalRecord",
        ),
        RpcMethodDescriptor::typed(
            "approval/decide",
            "Record an approval audit decision",
        ...
        RpcMethodDescriptor::typed(
            "auth/profile/get",
            "Resolve one binding's auth profile with an optional profile override",
            "BindingIdParams",
            "WireAuthProfileDetail",
        ),
        RpcMethodDescriptor::typed(
            "auth/profile/create",
            "Store direct credentials for a configured auth binding",
            "CreateProfileParams",
            "WireAuthProfileCreated",
        ),
        RpcMethodDescriptor::typed(
            "auth/profile/delete",
            "Clear credentials for a configured auth binding",
            "BindingIdParams",
