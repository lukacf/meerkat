...
<Tabs>
  ...
  <Tab title="Rust crate">
    ...
    meerkat-store = "0.8.10"
    meerkat-tools = "0.8.10"
...
<Warning>
Meerkat's OpenAI/global default, `gpt-5.6-sol`, is currently limited to
preview-enabled API organizations and Codex workspaces. If the relevant account
context does not have GPT-5.6 preview access, explicitly select the broadly
available `gpt-5.5` model.
</Warning>
...
rkat run --model gpt-5.6-sol "Explain monads"
