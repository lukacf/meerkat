...
- realtime helpers: `sessionRealtimeAttachmentStatus`, `sessionRealtimeAttachmentStatuses`, `realtimeOpenInfo`, `realtimeStatus`, `realtimeCapabilities`
...
- runtime/input helpers: `sessionState`, `sessionAccept`, `sessionRetire`, `sessionReset`, `sessionInput`, `sessionInputs`
