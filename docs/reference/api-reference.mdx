...
`meerkat-contracts/src/error/mod.rs`, or the [error-code table](#error-code-reference)
...
| `ContractVersion` | Semver version, lock-stepped with `workspace.package.version` (see `meerkat-contracts/src/version.rs`) |
