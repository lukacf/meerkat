...
#[allow(
    ...
    reason = "default construction must not silently mint a durable interaction identity"
)]
impl InteractionId {
    /// Mint an identity before the first canonical mutation of an interaction.
    #[must_use]
    pub fn new() -> Self {
        Self(Uuid::new_v4())
    }
