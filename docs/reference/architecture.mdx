...
## Current 0.6.19 Snapshot

Since the 0.6.5 live-adapter release, the architecture has gained several
important surfaces and runtime fixes:

- **WorkGraph** is now the sixth canonical machine and owns realm-scoped durable
  commitments, dependencies, claims, evidence, ready-item derivation, and
  host observability. CLI and trusted hosts add narrow goal and attention
  controls.
