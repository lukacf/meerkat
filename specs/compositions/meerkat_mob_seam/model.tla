...
mob_SetMemberVoiceIntent(arg_agent_identity) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "mob"
       /\ packet.variant = "SetMemberVoiceIntent"
       /\ packet.payload.agent_identity = arg_agent_identity
       /\ ~HigherPriorityReady("mob_kernel")
       /\ mob_phase = "Running"
       /\ mob_phase' = "Running"
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "mob", variant |-> "MemberVoiceIntentSet", payload |-> [agent_identity |-> packet.payload.agent_identity], effect_id |-> (model_step_count + 1), source_transition |-> "SetMemberVoiceIntent"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "mob", transition |-> "SetMemberVoiceIntent", actor |-> "mob_kernel", step |-> (model_step_count + 1), from_phase |-> mob_phase, to_phase |-> "Running"]}
       /\ model_step_count' = model_step_count + 1


mob_ClearMemberVoiceIntent(arg_agent_identity) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "mob"
       /\ packet.variant = "ClearMemberVoiceIntent"
       /\ packet.payload.agent_identity = arg_agent_identity
       /\ ~HigherPriorityReady("mob_kernel")
       /\ mob_phase = "Running"
       /\ mob_phase' = "Running"
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "mob", variant |-> "MemberVoiceIntentCleared", payload |-> [agent_identity |-> packet.payload.agent_identity], effect_id |-> (model_step_count + 1), source_transition |-> "ClearMemberVoiceIntent"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "mob", transition |-> "ClearMemberVoiceIntent", actor |-> "mob_kernel", step |-> (model_step_count + 1), from_phase |-> mob_phase, to_phase |-> "Running"]}
       /\ model_step_count' = model_step_count + 1
...
EntryPacketAdmissible_mob(packet) ==
    ...
    \/ /\ (packet.variant = "SetMemberVoiceIntent") /\ (mob_phase = "Running")
    \/ /\ (packet.variant = "ClearMemberVoiceIntent") /\ (mob_phase = "Running")
...
CoreNext ==
    ...
    \/ \E arg_agent_identity \in AgentIdentityValues : mob_SetMemberVoiceIntent(arg_agent_identity)
    \/ \E arg_agent_identity \in AgentIdentityValues : mob_ClearMemberVoiceIntent(arg_agent_identity)
    \/ QuiescentStutter
