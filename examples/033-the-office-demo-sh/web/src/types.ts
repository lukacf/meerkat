...
export const AGENTS: Record<AgentId, AgentMeta> = {
  triage:     { id: "triage",     name: "Triage",      role: "Triage Coordinator", zone: "Mail Room",   color: "#4488CC" },
  "it-dept":  { id: "it-dept",    name: "IT Support",  role: "IT Department",      zone: "Dept Row",    color: "#44AA66" },
  "hr-dept":  { id: "hr-dept",    name: "HR",          role: "HR Department",      zone: "Dept Row",    color: "#CC6688" },
  facilities: { id: "facilities", name: "Facilities",  role: "Facilities Team",    zone: "Dept Row",    color: "#AA8844" },
  finance:    { id: "finance",    name: "Finance",     role: "Finance Team",       zone: "Dept Row",    color: "#8866CC" },
  "alex-pa":  { id: "alex-pa",    name: "PA Alex",     role: "Assistant to Alex",  zone: "PA Bullpen",  color: "#CC4466" },
  "sam-pa":   { id: "sam-pa",     name: "PA Sam",      role: "Assistant to Sam",   zone: "PA Bullpen",  color: "#44AACC" },
  "pat-pa":   { id: "pat-pa",     name: "PA Pat",      role: "Assistant to Pat",   zone: "PA Bullpen",  color: "#CCAA44" },
  gate:       { id: "gate",       name: "Compliance",  role: "Compliance Gate",    zone: "Gate",        color: "#CC4444" },
  archivist:  { id: "archivist",  name: "Archivist",   role: "Knowledge Archivist", zone: "Archive",    color: "#66AA88" },
};
