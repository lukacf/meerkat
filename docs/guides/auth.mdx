...
- [Hooks](/docs/guides/hooks) — observe auth events or gate turns on
  credential state
- [Mobs](/docs/guides/mobs) — per-member `connection_ref` overrides
- Design doc `/docs/architecture/meerkat-runtime-dogma.md` for the
