...
<Tabs>
  <Tab title="JSON-RPC">
    ...
    {"jsonrpc":"2.0","id":4,"method":"mob/send","params":{
      "mob_id": "my-mob",
      "meerkat_id": "lead-1",
      "message": "Coordinate the release triage."
    }}
    ```
  </Tab>
  <Tab title="REST">
  ...
  <Tab title="Python">
    ...
    await mob.send_message("lead-1", "Coordinate the release triage.")
  ...
  <Tab title="TypeScript">
    ...
    await mob.sendMessage("lead-1", "Coordinate the release triage.");
