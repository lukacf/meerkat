...
| `session/status` | Runtime | Get a session's current runtime state |
| `session/submit` | Runtime | Accept a runtime input for a session |
| `session/submission` | Runtime | Get a runtime input state |
| `session/submissions` | Runtime | List active runtime inputs |
| `session/retire` | Runtime | Retire a session runtime |
| `session/reset` | Runtime | Reset a session runtime |
