...
impl Pack for ArchitectPack {
    ...
    fn definition(
        ...
        profiles.insert(
            ...
            turn_driven_profile(
                resolve_model(overrides, "planner", "claude-opus-4-6"),
                "planner-skill",
        ...
        profiles.insert(
            ProfileName::from("critic"),
            turn_driven_profile(
                resolve_model(overrides, "critic", "gpt-5.4"),
                "critic-skill",
                "Architecture critic",
                pp,
            ),
        ...
        skills.insert(
            "planner-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/planner.md").into(),
            },
        );
        skills.insert(
            "critic-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/critic.md").into(),
            },
        );
        skills.insert(
        ...
        steps.insert(
            ...
            flow_step(
                "planner",
                "Address the critique. Revise your plan.\n\n## Critique\n{{ steps.critique }}"
                    .into(),
                &["critique"],
                600_000,
            ),
        ...
        mob_definition(
            ...
            skills,
            flows,
            identity_spawn_policy(&["planner", "critic", "synthesizer"]),
        )
    }
}
