...
WitnessInit_terminal_response_continuation_success ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_control", variant |-> "SubmitCandidate", payload |-> [candidate_id |-> "continuation_1", candidate_kind |-> "ContinuationInput"], source_kind |-> "entry", source_route |-> "witness:terminal_response_continuation_success:2", source_machine |-> "external_entry", source_effect |-> "SubmitCandidate", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", candidate_id |-> "continuation_1", candidate_kind |-> "ContinuationInput", process |-> TRUE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:terminal_response_continuation_success:3", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_input_ids |-> <<"continuation_1">>, run_id |-> "runid_cont_1"], source_kind |-> "entry", source_route |-> "witness:terminal_response_continuation_success:4", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "PrimitiveApplied", payload |-> [run_id |-> "runid_cont_1"], source_kind |-> "entry", source_route |-> "witness:terminal_response_continuation_success:5", source_machine |-> "external_entry", source_effect |-> "PrimitiveApplied", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "LlmReturnedTerminal", payload |-> [run_id |-> "runid_cont_1"], source_kind |-> "entry", source_route |-> "witness:terminal_response_continuation_success:6", source_machine |-> "external_entry", source_effect |-> "LlmReturnedTerminal", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "BoundaryComplete", payload |-> [run_id |-> "runid_cont_1"], source_kind |-> "entry", source_route |-> "witness:terminal_response_continuation_success:7", source_machine |-> "external_entry", source_effect |-> "BoundaryComplete", effect_id |-> 0]>>
...
WitnessInit_host_mode_continuation_success ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_control", variant |-> "SubmitCandidate", payload |-> [candidate_id |-> "host_continuation_1", candidate_kind |-> "ContinuationInput"], source_kind |-> "entry", source_route |-> "witness:host_mode_continuation_success:2", source_machine |-> "external_entry", source_effect |-> "SubmitCandidate", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", candidate_id |-> "host_continuation_1", candidate_kind |-> "ContinuationInput", process |-> TRUE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:host_mode_continuation_success:3", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_input_ids |-> <<"host_continuation_1">>, run_id |-> "runid_host_cont_1"], source_kind |-> "entry", source_route |-> "witness:host_mode_continuation_success:4", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "PrimitiveApplied", payload |-> [run_id |-> "runid_host_cont_1"], source_kind |-> "entry", source_route |-> "witness:host_mode_continuation_success:5", source_machine |-> "external_entry", source_effect |-> "PrimitiveApplied", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "LlmReturnedTerminal", payload |-> [run_id |-> "runid_host_cont_1"], source_kind |-> "entry", source_route |-> "witness:host_mode_continuation_success:6", source_machine |-> "external_entry", source_effect |-> "LlmReturnedTerminal", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "BoundaryComplete", payload |-> [run_id |-> "runid_host_cont_1"], source_kind |-> "entry", source_route |-> "witness:host_mode_continuation_success:7", source_machine |-> "external_entry", source_effect |-> "BoundaryComplete", effect_id |-> 0]>>

WitnessInit_continuation_control_preemption ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:continuation_control_preemption:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "SubmitCandidate", payload |-> [candidate_id |-> "continuation_1", candidate_kind |-> "ContinuationInput"], source_kind |-> "entry", source_route |-> "witness:continuation_control_preemption:2", source_machine |-> "external_entry", source_effect |-> "SubmitCandidate", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:continuation_control_preemption:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "SubmitCandidate", payload |-> [candidate_id |-> "continuation_1", candidate_kind |-> "ContinuationInput"], source_kind |-> "entry", source_route |-> "witness:continuation_control_preemption:2", source_machine |-> "external_entry", source_effect |-> "SubmitCandidate", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "runtime_control", variant |-> "SubmitCandidate", payload |-> [candidate_id |-> "continuation_1", candidate_kind |-> "ContinuationInput"], source_kind |-> "entry", source_route |-> "witness:continuation_control_preemption:2", source_machine |-> "external_entry", source_effect |-> "SubmitCandidate", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", candidate_id |-> "continuation_1", candidate_kind |-> "ContinuationInput", process |-> TRUE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:continuation_control_preemption:3", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]>>
...
runtime_control_AdmissionAcceptedIdleNone(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "ContinuationQueued", process |-> TRUE, wake |-> TRUE], source_kind |-> "route", source_route |-> "continuation_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)])
...
Inject_continuation_submit_candidate(arg_candidate_id, arg_candidate_kind) ==
    /\ ~([machine |-> "runtime_control", variant |-> "SubmitCandidate", payload |-> [candidate_id |-> arg_candidate_id, candidate_kind |-> arg_candidate_kind], source_kind |-> "entry", source_route |-> "continuation_submit_candidate", source_machine |-> "external_entry", source_effect |-> "SubmitCandidate", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "runtime_control", variant |-> "SubmitCandidate", payload |-> [candidate_id |-> arg_candidate_id, candidate_kind |-> arg_candidate_kind], source_kind |-> "entry", source_route |-> "continuation_submit_candidate", source_machine |-> "external_entry", source_effect |-> "SubmitCandidate", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitCandidate", payload |-> [candidate_id |-> arg_candidate_id, candidate_kind |-> arg_candidate_kind], source_kind |-> "entry", source_route |-> "continuation_submit_candidate", source_machine |-> "external_entry", source_effect |-> "SubmitCandidate", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_input_kind, runtime_ingress_policy_snapshot, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_tool_calls_pending, turn_execution_boundary_count, turn_execution_terminal_outcome, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
InjectNext ==
    \/ Inject_control_initialize
    \/ \E arg_candidate_id \in CandidateIdValues : \E arg_candidate_kind \in InputKindValues : Inject_continuation_submit_candidate(arg_candidate_id, arg_candidate_kind)
...
WitnessTransitionObserved_terminal_response_continuation_success_runtime_control_AdmissionAcceptedIdleWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleWakeAndProcess")
WitnessTransitionObserved_terminal_response_continuation_success_runtime_ingress_AdmitQueuedWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedWakeAndProcess")
...
WitnessTransitionObserved_host_mode_continuation_success_runtime_control_AdmissionAcceptedIdleWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleWakeAndProcess")
WitnessTransitionObserved_host_mode_continuation_success_runtime_ingress_AdmitQueuedWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedWakeAndProcess")
...
WitnessTransitionOrder_host_mode_continuation_success_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "AdmissionAcceptedIdleWakeAndProcess" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedWakeAndProcess" /\ earlier.step < later.step)
...
WitnessTransitionObserved_continuation_control_preemption_runtime_control_AdmissionAcceptedIdleWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleWakeAndProcess")
WitnessTransitionObserved_continuation_control_preemption_runtime_ingress_AdmitQueuedWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedWakeAndProcess")
WitnessTransitionOrder_continuation_control_preemption_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "Initialize" /\ later.machine = "runtime_control" /\ later.transition = "AdmissionAcceptedIdleWakeAndProcess" /\ earlier.step < later.step)
WitnessTransitionOrder_continuation_control_preemption_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "AdmissionAcceptedIdleWakeAndProcess" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedWakeAndProcess" /\ earlier.step < later.step)
