...
impl Pack for RedTeamPack {
    ...
    fn definition(
        ...
        steps.insert(StepId::from("judgment"), step("judge", "Weigh both arguments. Produce a balanced risk assessment with a clear recommendation.".into(), vec!["advocate_case", "adversary_case"]));
