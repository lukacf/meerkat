...
features (`anthropic`, `openai`, `gemini`); realm persistence, compaction,
...
| **Provider default** | default features | Anthropic + OpenAI + Gemini providers; no session persistence, compaction, live transport, comms, MCP, skills, or semantic memory |
