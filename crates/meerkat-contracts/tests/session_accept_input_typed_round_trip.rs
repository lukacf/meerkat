...
//! payload. This test round-trips the two primitive variants and asserts
//! that turn metadata + idempotency round-trip intact.

use meerkat_contracts::wire::runtime::{
    SessionAcceptInputParams, WireConversationAppend, WireConversationAppendRole, WireRunPrimitive,
