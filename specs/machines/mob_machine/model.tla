...
VARIABLES phase, model_step_count, live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch
...
WireMembersRunning(edge) ==
    ...
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, member_state_markers, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids >>
...
BindMemberSessionRunning(agent_identity, session_id) ==
    ...
    /\ topology_epoch' = (topology_epoch) + 1
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, pending_session_ingress_detach_runtime_ids >>
...
SpawnRunningFresh(agent_identity, agent_runtime_id, fence_token, generation, external_addressable, bridge_session_id, replacing) ==
    ...
    /\ topology_epoch' = (topology_epoch) + 1
    /\ UNCHANGED << active_run_count, pending_spawn_count, coordinator_bound, member_state_markers, wiring_edges, external_peer_edges, tasks, in_progress_task_ids, completed_task_ids, pending_session_ingress_detach_runtime_ids >>
...
RetireMember(agent_runtime_id, fence_token, session_id) ==
    ...
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch >>
...
ObserveRuntimeRetired(agent_runtime_id, fence_token) ==
    ...
    /\ UNCHANGED << pending_spawn_count, coordinator_bound, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch >>
...
StopRunning ==
    ...
    /\ active_run_count' = 0
    /\ coordinator_bound' = FALSE
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, pending_spawn_count, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch >>
...
ResumeStopped ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ coordinator_bound' = TRUE
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch >>
...
CompleteRunning ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ active_run_count' = 0
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, pending_spawn_count, coordinator_bound, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch >>
...
TaskCreateRunning(task_id, task_payload) ==
    ...
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, in_progress_task_ids, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch >>
...
TaskUpdateRunningPending(task_id, new_status) ==
    ...
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, tasks, completed_task_ids, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch >>
...
TaskUpdateRunningCompleted(task_id, new_status) ==
    ...
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, tasks, member_session_bindings, pending_session_ingress_detach_runtime_ids, topology_epoch >>
...
RetireRunningReleasing(agent_runtime_id, agent_identity, releasing, session_id) ==
    ...
    /\ topology_epoch' = (topology_epoch) + 1
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids >>
...
SessionIngressDetachedForMobDestroyRunning(mob_id, agent_runtime_id) ==
    ...
    /\ UNCHANGED << live_runtime_ids, externally_addressable_runtime_ids, runtime_fence_tokens, active_run_count, pending_spawn_count, coordinator_bound, member_state_markers, wiring_edges, external_peer_edges, identity_to_runtime, tasks, in_progress_task_ids, completed_task_ids, member_session_bindings, topology_epoch >>
...
CiStateConstraint == /\ model_step_count <= 6 /\ Cardinality(live_runtime_ids) <= 1 /\ Cardinality(externally_addressable_runtime_ids) <= 1 /\ Cardinality(DOMAIN runtime_fence_tokens) <= 1 /\ Cardinality(DOMAIN member_state_markers) <= 1 /\ Cardinality(wiring_edges) <= 1 /\ Cardinality(external_peer_edges) <= 1 /\ Cardinality(DOMAIN identity_to_runtime) <= 1 /\ Cardinality(DOMAIN tasks) <= 1 /\ Cardinality(in_progress_task_ids) <= 1 /\ Cardinality(completed_task_ids) <= 1 /\ Cardinality(DOMAIN member_session_bindings) <= 1 /\ Cardinality(pending_session_ingress_detach_runtime_ids) <= 1
DeepStateConstraint == /\ model_step_count <= 8 /\ Cardinality(live_runtime_ids) <= 2 /\ Cardinality(externally_addressable_runtime_ids) <= 2 /\ Cardinality(DOMAIN runtime_fence_tokens) <= 2 /\ Cardinality(DOMAIN member_state_markers) <= 2 /\ Cardinality(wiring_edges) <= 2 /\ Cardinality(external_peer_edges) <= 2 /\ Cardinality(DOMAIN identity_to_runtime) <= 2 /\ Cardinality(DOMAIN tasks) <= 2 /\ Cardinality(in_progress_task_ids) <= 2 /\ Cardinality(completed_task_ids) <= 2 /\ Cardinality(DOMAIN member_session_bindings) <= 2 /\ Cardinality(pending_session_ingress_detach_runtime_ids) <= 2
