...
WitnessInit_prompt_queue_idle ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", candidate_id |-> "prompt_1", candidate_kind |-> "WorkInput", process |-> FALSE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:prompt_queue_idle:2", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]>>
...
WitnessInit_prompt_steer_idle ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", candidate_id |-> "prompt_1", candidate_kind |-> "WorkInput", process |-> TRUE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:prompt_steer_idle:2", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]>>
...
WitnessInit_prompt_queue_running ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_control", variant |-> "BeginRun", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:prompt_queue_running:2", source_machine |-> "external_entry", source_effect |-> "BeginRun", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", candidate_id |-> "prompt_1", candidate_kind |-> "WorkInput", process |-> FALSE, wake |-> FALSE], source_kind |-> "entry", source_route |-> "witness:prompt_queue_running:3", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]>>
...
WitnessInit_prompt_steer_running ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_control", variant |-> "BeginRun", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:prompt_steer_running:2", source_machine |-> "external_entry", source_effect |-> "BeginRun", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", candidate_id |-> "prompt_1", candidate_kind |-> "WorkInput", process |-> TRUE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:prompt_steer_running:3", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]>>
...
WitnessInit_failure_path ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> "inputid_1", input_kind |-> "WorkInput", policy |-> "policydecision_1", process |-> FALSE, wake |-> FALSE], source_kind |-> "entry", source_route |-> "witness:failure_path:2", source_machine |-> "external_entry", source_effect |-> "AdmitQueued", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_input_ids |-> <<"inputid_1">>, run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:failure_path:3", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "FatalFailure", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:failure_path:4", source_machine |-> "external_entry", source_effect |-> "FatalFailure", effect_id |-> 0]>>
...
WitnessInit_cancel_path ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> "inputid_1", input_kind |-> "WorkInput", policy |-> "policydecision_1", process |-> FALSE, wake |-> FALSE], source_kind |-> "entry", source_route |-> "witness:cancel_path:2", source_machine |-> "external_entry", source_effect |-> "AdmitQueued", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_input_ids |-> <<"inputid_1">>, run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:cancel_path:3", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "CancelRequested", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:cancel_path:4", source_machine |-> "external_entry", source_effect |-> "CancelRequested", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "CancellationObserved", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:cancel_path:5", source_machine |-> "external_entry", source_effect |-> "CancellationObserved", effect_id |-> 0]>>

WitnessInit_control_preemption ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:control_preemption:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> "inputid_1", input_kind |-> "WorkInput", policy |-> "policydecision_1", process |-> TRUE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:control_preemption:2", source_machine |-> "external_entry", source_effect |-> "AdmitQueued", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:control_preemption:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> "inputid_1", input_kind |-> "WorkInput", policy |-> "policydecision_1", process |-> TRUE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:control_preemption:2", source_machine |-> "external_entry", source_effect |-> "AdmitQueued", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> "inputid_1", input_kind |-> "WorkInput", policy |-> "policydecision_1", process |-> TRUE, wake |-> TRUE], source_kind |-> "entry", source_route |-> "witness:control_preemption:2", source_machine |-> "external_entry", source_effect |-> "AdmitQueued", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<>>
...
runtime_control_AdmissionAcceptedIdleNone(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], source_kind |-> "route", source_route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)])
...
runtime_control_AdmissionAcceptedIdleWake(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], source_kind |-> "route", source_route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedIdleWake"] }
...
runtime_control_AdmissionAcceptedIdleProcess(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], source_kind |-> "route", source_route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedIdleProcess"] }
...
runtime_control_AdmissionAcceptedIdleWakeAndProcess(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], source_kind |-> "route", source_route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedIdleWakeAndProcess"] }
...
runtime_control_AdmissionAcceptedRunningNone(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], source_kind |-> "route", source_route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedRunningNone"] }
...
runtime_control_AdmissionAcceptedRunningWake(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], source_kind |-> "route", source_route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedRunningWake"] }
...
runtime_control_AdmissionAcceptedRunningProcess(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], source_kind |-> "route", source_route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedRunningProcess"] }
...
runtime_control_AdmissionAcceptedRunningWakeAndProcess(arg_candidate_id, arg_candidate_kind, arg_admission_effect, arg_wake, arg_process) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], source_kind |-> "route", source_route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [input_id |-> packet.payload.candidate_id, input_kind |-> packet.payload.candidate_kind, policy |-> "PromptAdmission", process |-> packet.payload.process, wake |-> packet.payload.wake], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedRunningWakeAndProcess"] }
...
Inject_admit_queued_work(arg_input_id, arg_input_kind, arg_policy, arg_wake, arg_process) ==
    /\ ~([machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> arg_input_id, input_kind |-> arg_input_kind, policy |-> arg_policy, process |-> arg_process, wake |-> arg_wake], source_kind |-> "entry", source_route |-> "admit_queued_work", source_machine |-> "external_entry", source_effect |-> "AdmitQueued", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> arg_input_id, input_kind |-> arg_input_kind, policy |-> arg_policy, process |-> arg_process, wake |-> arg_wake], source_kind |-> "entry", source_route |-> "admit_queued_work", source_machine |-> "external_entry", source_effect |-> "AdmitQueued", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [input_id |-> arg_input_id, input_kind |-> arg_input_kind, policy |-> arg_policy, process |-> arg_process, wake |-> arg_wake], source_kind |-> "entry", source_route |-> "admit_queued_work", source_machine |-> "external_entry", source_effect |-> "AdmitQueued", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_input_kind, runtime_ingress_policy_snapshot, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_tool_calls_pending, turn_execution_boundary_count, turn_execution_terminal_outcome, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_admit_consumed_on_accept(arg_input_id, arg_input_kind, arg_policy) ==
    /\ ~([machine |-> "runtime_ingress", variant |-> "AdmitConsumedOnAccept", payload |-> [input_id |-> arg_input_id, input_kind |-> arg_input_kind, policy |-> arg_policy], source_kind |-> "entry", source_route |-> "admit_consumed_on_accept", source_machine |-> "external_entry", source_effect |-> "AdmitConsumedOnAccept", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "runtime_ingress", variant |-> "AdmitConsumedOnAccept", payload |-> [input_id |-> arg_input_id, input_kind |-> arg_input_kind, policy |-> arg_policy], source_kind |-> "entry", source_route |-> "admit_consumed_on_accept", source_machine |-> "external_entry", source_effect |-> "AdmitConsumedOnAccept", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitConsumedOnAccept", payload |-> [input_id |-> arg_input_id, input_kind |-> arg_input_kind, policy |-> arg_policy], source_kind |-> "entry", source_route |-> "admit_consumed_on_accept", source_machine |-> "external_entry", source_effect |-> "AdmitConsumedOnAccept", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_input_kind, runtime_ingress_policy_snapshot, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_tool_calls_pending, turn_execution_boundary_count, turn_execution_terminal_outcome, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_stage_drain_snapshot(arg_run_id, arg_contributing_input_ids) ==
    /\ ~([machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_input_ids |-> arg_contributing_input_ids, run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "stage_drain_snapshot", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_input_ids |-> arg_contributing_input_ids, run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "stage_drain_snapshot", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_input_ids |-> arg_contributing_input_ids, run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "stage_drain_snapshot", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_input_kind, runtime_ingress_policy_snapshot, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_tool_calls_pending, turn_execution_boundary_count, turn_execution_terminal_outcome, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
Inject_primitive_applied(arg_run_id) ==
    /\ ~([machine |-> "turn_execution", variant |-> "PrimitiveApplied", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "primitive_applied", source_machine |-> "external_entry", source_effect |-> "PrimitiveApplied", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "PrimitiveApplied", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "primitive_applied", source_machine |-> "external_entry", source_effect |-> "PrimitiveApplied", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "PrimitiveApplied", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "primitive_applied", source_machine |-> "external_entry", source_effect |-> "PrimitiveApplied", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_input_kind, runtime_ingress_policy_snapshot, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_tool_calls_pending, turn_execution_boundary_count, turn_execution_terminal_outcome, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
Inject_cancel_requested(arg_run_id) ==
    /\ ~([machine |-> "turn_execution", variant |-> "CancelRequested", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "cancel_requested", source_machine |-> "external_entry", source_effect |-> "CancelRequested", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "CancelRequested", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "cancel_requested", source_machine |-> "external_entry", source_effect |-> "CancelRequested", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "CancelRequested", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "cancel_requested", source_machine |-> "external_entry", source_effect |-> "CancelRequested", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_input_kind, runtime_ingress_policy_snapshot, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_tool_calls_pending, turn_execution_boundary_count, turn_execution_terminal_outcome, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
InjectNext ==
    ...
    \/ \E arg_input_id \in InputIdValues : \E arg_input_kind \in InputKindValues : \E arg_policy \in PolicyDecisionValues : \E arg_wake \in BOOLEAN : \E arg_process \in BOOLEAN : Inject_admit_queued_work(arg_input_id, arg_input_kind, arg_policy, arg_wake, arg_process)
    \/ \E arg_input_id \in InputIdValues : \E arg_input_kind \in InputKindValues : \E arg_policy \in PolicyDecisionValues : Inject_admit_consumed_on_accept(arg_input_id, arg_input_kind, arg_policy)
    \/ \E arg_run_id \in RunIdValues : \E arg_contributing_input_ids \in SeqOfInputIdValues : Inject_stage_drain_snapshot(arg_run_id, arg_contributing_input_ids)
    \/ Inject_control_recover_requested
    \/ Inject_control_retire_requested
    \/ Inject_control_reset_requested
    \/ Inject_control_stop_requested
    \/ Inject_control_destroy_requested
    \/ \E arg_run_id \in RunIdValues : Inject_primitive_applied(arg_run_id)
    ...
    \/ \E arg_run_id \in RunIdValues : Inject_cancel_requested(arg_run_id)
...
WitnessStateConstraint_prompt_queue_running == /\ model_step_count <= 8 /\ Len(pending_inputs) <= 3 /\ Cardinality(observed_inputs) <= 7 /\ Len(pending_routes) <= 1 /\ Cardinality(delivered_routes) <= 2 /\ Cardinality(emitted_effects) <= 5 /\ Cardinality(observed_transitions) <= 8 /\ Cardinality(runtime_ingress_admitted_inputs) <= 2 /\ Len(runtime_ingress_admission_order) <= 2 /\ Cardinality(DOMAIN runtime_ingress_input_kind) <= 2 /\ Cardinality(DOMAIN runtime_ingress_policy_snapshot) <= 2 /\ Cardinality(DOMAIN runtime_ingress_lifecycle) <= 2 /\ Cardinality(DOMAIN runtime_ingress_terminal_outcome) <= 2 /\ Len(runtime_ingress_queue) <= 2 /\ Len(runtime_ingress_current_run_contributors) <= 2 /\ Cardinality(DOMAIN runtime_ingress_last_run) <= 2 /\ Cardinality(DOMAIN runtime_ingress_last_boundary_sequence) <= 2
WitnessStateConstraint_prompt_steer_running == /\ model_step_count <= 8 /\ Len(pending_inputs) <= 3 /\ Cardinality(observed_inputs) <= 7 /\ Len(pending_routes) <= 1 /\ Cardinality(delivered_routes) <= 2 /\ Cardinality(emitted_effects) <= 5 /\ Cardinality(observed_transitions) <= 8 /\ Cardinality(runtime_ingress_admitted_inputs) <= 2 /\ Len(runtime_ingress_admission_order) <= 2 /\ Cardinality(DOMAIN runtime_ingress_input_kind) <= 2 /\ Cardinality(DOMAIN runtime_ingress_policy_snapshot) <= 2 /\ Cardinality(DOMAIN runtime_ingress_lifecycle) <= 2 /\ Cardinality(DOMAIN runtime_ingress_terminal_outcome) <= 2 /\ Len(runtime_ingress_queue) <= 2 /\ Len(runtime_ingress_current_run_contributors) <= 2 /\ Cardinality(DOMAIN runtime_ingress_last_run) <= 2 /\ Cardinality(DOMAIN runtime_ingress_last_boundary_sequence) <= 2
WitnessStateConstraint_success_path == /\ model_step_count <= 12 /\ Len(pending_inputs) <= 6 /\ Cardinality(observed_inputs) <= 14 /\ Len(pending_routes) <= 2 /\ Cardinality(delivered_routes) <= 6 /\ Cardinality(emitted_effects) <= 6 /\ Cardinality(observed_transitions) <= 12 /\ Cardinality(runtime_ingress_admitted_inputs) <= 6 /\ Len(runtime_ingress_admission_order) <= 6 /\ Cardinality(DOMAIN runtime_ingress_input_kind) <= 2 /\ Cardinality(DOMAIN runtime_ingress_policy_snapshot) <= 2 /\ Cardinality(DOMAIN runtime_ingress_lifecycle) <= 2 /\ Cardinality(DOMAIN runtime_ingress_terminal_outcome) <= 2 /\ Len(runtime_ingress_queue) <= 6 /\ Len(runtime_ingress_current_run_contributors) <= 6 /\ Cardinality(DOMAIN runtime_ingress_last_run) <= 2 /\ Cardinality(DOMAIN runtime_ingress_last_boundary_sequence) <= 2
...
WitnessTransitionObserved_prompt_queue_idle_runtime_control_AdmissionAcceptedIdleWake == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleWake")
WitnessTransitionObserved_prompt_queue_idle_runtime_ingress_AdmitQueuedWake == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedWake")
WitnessTransitionOrder_prompt_queue_idle_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "Initialize" /\ later.machine = "runtime_control" /\ later.transition = "AdmissionAcceptedIdleWake" /\ earlier.step < later.step)
WitnessTransitionOrder_prompt_queue_idle_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "AdmissionAcceptedIdleWake" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedWake" /\ earlier.step < later.step)
...
WitnessTransitionObserved_prompt_steer_idle_runtime_control_AdmissionAcceptedIdleWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleWakeAndProcess")
WitnessTransitionObserved_prompt_steer_idle_runtime_ingress_AdmitQueuedWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedWakeAndProcess")
WitnessTransitionOrder_prompt_steer_idle_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "Initialize" /\ later.machine = "runtime_control" /\ later.transition = "AdmissionAcceptedIdleWakeAndProcess" /\ earlier.step < later.step)
WitnessTransitionOrder_prompt_steer_idle_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "AdmissionAcceptedIdleWakeAndProcess" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedWakeAndProcess" /\ earlier.step < later.step)
...
WitnessTransitionObserved_prompt_queue_running_runtime_control_AdmissionAcceptedRunningNone == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedRunningNone")
WitnessTransitionObserved_prompt_queue_running_runtime_ingress_AdmitQueuedNone == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedNone")
WitnessTransitionOrder_prompt_queue_running_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "BeginRunFromIdle" /\ later.machine = "turn_execution" /\ later.transition = "StartConversationRun" /\ earlier.step < later.step)
WitnessTransitionOrder_prompt_queue_running_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "BeginRunFromIdle" /\ later.machine = "runtime_control" /\ later.transition = "AdmissionAcceptedRunningNone" /\ earlier.step < later.step)
WitnessTransitionOrder_prompt_queue_running_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "AdmissionAcceptedRunningNone" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedNone" /\ earlier.step < later.step)
...
WitnessTransitionObserved_prompt_steer_running_runtime_control_AdmissionAcceptedRunningWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedRunningWakeAndProcess")
WitnessTransitionObserved_prompt_steer_running_runtime_ingress_AdmitQueuedWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedWakeAndProcess")
WitnessTransitionOrder_prompt_steer_running_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "BeginRunFromIdle" /\ later.machine = "turn_execution" /\ later.transition = "StartConversationRun" /\ earlier.step < later.step)
WitnessTransitionOrder_prompt_steer_running_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "BeginRunFromIdle" /\ later.machine = "runtime_control" /\ later.transition = "AdmissionAcceptedRunningWakeAndProcess" /\ earlier.step < later.step)
WitnessTransitionOrder_prompt_steer_running_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "AdmissionAcceptedRunningWakeAndProcess" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedWakeAndProcess" /\ earlier.step < later.step)
...
WitnessTransitionObserved_cancel_path_turn_execution_CancelRequestedFromApplyingPrimitive == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "CancelRequestedFromApplyingPrimitive")
...
WitnessTransitionObserved_control_preemption_runtime_ingress_AdmitQueuedWakeAndProcess == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedWakeAndProcess")
WitnessTransitionOrder_control_preemption_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "Initialize" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedWakeAndProcess" /\ earlier.step < later.step)
