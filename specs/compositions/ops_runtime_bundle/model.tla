...
CONSTANTS AdmissionEffectValues, AsyncOpRefValues, BooleanValues, ContentShapeValues, HandlingModeValues, NatValues, OperationIdValues, OperationKindValues, PolicyDecisionValues, RequestIdValues, ReservationKeyValues, RunIdValues, SetOfStringValues, StringValues, WorkIdValues
...
RouteSource(route_name) ==
    CASE route_name = "op_event_enters_runtime_admission" -> "ops_lifecycle"
      ...
      [] route_name = "ops_barrier_satisfied_enters_turn_execution" -> "ops_lifecycle"
...
RouteEffect(route_name) ==
    CASE route_name = "op_event_enters_runtime_admission" -> "SubmitOpEvent"
      ...
      [] route_name = "ops_barrier_satisfied_enters_turn_execution" -> "WaitAllSatisfied"
...
RouteTargetMachine(route_name) ==
    CASE route_name = "op_event_enters_runtime_admission" -> "runtime_control"
      ...
      [] route_name = "ops_barrier_satisfied_enters_turn_execution" -> "turn_execution"
      [] OTHER -> "unknown_machine"

RouteTargetInput(route_name) ==
    CASE route_name = "op_event_enters_runtime_admission" -> "SubmitWork"
      ...
      [] route_name = "execution_cancel_updates_ingress" -> "RunCancelled"
      [] route_name = "execution_cancel_notifies_control" -> "RunCancelled"
      [] route_name = "ops_barrier_satisfied_enters_turn_execution" -> "OpsBarrierSatisfied"
      [] OTHER -> "unknown_input"
...
WitnessInit_op_failure_path ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "ops_lifecycle", variant |-> "RegisterOperation", payload |-> [operation_id |-> "op_1", operation_kind |-> "BackgroundToolOp"], source_kind |-> "entry", source_route |-> "witness:op_failure_path:2", source_machine |-> "external_entry", source_effect |-> "RegisterOperation", effect_id |-> 0], [machine |-> "ops_lifecycle", variant |-> "ProvisioningSucceeded", payload |-> [operation_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:op_failure_path:3", source_machine |-> "external_entry", source_effect |-> "ProvisioningSucceeded", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", content_shape |-> "TextOnly", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:op_failure_path:4", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_work_ids |-> <<"op_1">>, run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:op_failure_path:5", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "FatalFailure", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:op_failure_path:6", source_machine |-> "external_entry", source_effect |-> "FatalFailure", effect_id |-> 0]>>
...
WitnessInit_op_cancel_path ==
    ...
    /\ witness_remaining_script_inputs = <<[machine |-> "ops_lifecycle", variant |-> "RegisterOperation", payload |-> [operation_id |-> "op_1", operation_kind |-> "BackgroundToolOp"], source_kind |-> "entry", source_route |-> "witness:op_cancel_path:2", source_machine |-> "external_entry", source_effect |-> "RegisterOperation", effect_id |-> 0], [machine |-> "ops_lifecycle", variant |-> "ProvisioningSucceeded", payload |-> [operation_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:op_cancel_path:3", source_machine |-> "external_entry", source_effect |-> "ProvisioningSucceeded", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", content_shape |-> "TextOnly", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:op_cancel_path:4", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_work_ids |-> <<"op_1">>, run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:op_cancel_path:5", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "CancelNow", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:op_cancel_path:6", source_machine |-> "external_entry", source_effect |-> "CancelNow", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "CancellationObserved", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:op_cancel_path:7", source_machine |-> "external_entry", source_effect |-> "CancellationObserved", effect_id |-> 0]>>

WitnessInit_control_preempts_op_ingress ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:control_preempts_op_ingress:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", content_shape |-> "TextOnly", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:control_preempts_op_ingress:2", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:control_preempts_op_ingress:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", content_shape |-> "TextOnly", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:control_preempts_op_ingress:2", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", content_shape |-> "TextOnly", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:control_preempts_op_ingress:2", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<[machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", content_shape |-> "TextOnly", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> "op_2"], source_kind |-> "entry", source_route |-> "witness:control_preempts_op_ingress:3", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0]>>

WitnessInit_barrier_tool_loop_path ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "runtime_control", variant |-> "Initialize", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:1", source_machine |-> "external_entry", source_effect |-> "Initialize", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<[machine |-> "ops_lifecycle", variant |-> "RegisterOperation", payload |-> [operation_id |-> "op_1", operation_kind |-> "BackgroundToolOp"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:2", source_machine |-> "external_entry", source_effect |-> "RegisterOperation", effect_id |-> 0], [machine |-> "ops_lifecycle", variant |-> "ProvisioningSucceeded", payload |-> [operation_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:3", source_machine |-> "external_entry", source_effect |-> "ProvisioningSucceeded", effect_id |-> 0], [machine |-> "runtime_control", variant |-> "AdmissionAccepted", payload |-> [admission_effect |-> "SubmitAdmittedIngressEffect", content_shape |-> "TextOnly", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:4", source_machine |-> "external_entry", source_effect |-> "AdmissionAccepted", effect_id |-> 0], [machine |-> "runtime_ingress", variant |-> "StageDrainSnapshot", payload |-> [contributing_work_ids |-> <<"op_1">>, run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:5", source_machine |-> "external_entry", source_effect |-> "StageDrainSnapshot", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "PrimitiveApplied", payload |-> [admitted_content_shape |-> "TextOnly", image_tool_results_enabled |-> FALSE, run_id |-> "runid_1", vision_enabled |-> FALSE], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:6", source_machine |-> "external_entry", source_effect |-> "PrimitiveApplied", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "LlmReturnedToolCalls", payload |-> [run_id |-> "runid_1", tool_count |-> 1], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:7", source_machine |-> "external_entry", source_effect |-> "LlmReturnedToolCalls", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "RegisterPendingOps", payload |-> [has_barrier_ops |-> TRUE, op_refs |-> <<"op_1">>, run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:8", source_machine |-> "external_entry", source_effect |-> "RegisterPendingOps", effect_id |-> 0], [machine |-> "ops_lifecycle", variant |-> "CompleteOperation", payload |-> [operation_id |-> "op_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:9", source_machine |-> "external_entry", source_effect |-> "CompleteOperation", effect_id |-> 0], [machine |-> "ops_lifecycle", variant |-> "WaitAll", payload |-> [operation_ids |-> <<"op_1">>], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:10", source_machine |-> "external_entry", source_effect |-> "WaitAll", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "OpsBarrierSatisfied", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:11", source_machine |-> "external_entry", source_effect |-> "OpsBarrierSatisfied", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "ToolCallsResolved", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:12", source_machine |-> "external_entry", source_effect |-> "ToolCallsResolved", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "BoundaryContinue", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:13", source_machine |-> "external_entry", source_effect |-> "BoundaryContinue", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "LlmReturnedTerminal", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:14", source_machine |-> "external_entry", source_effect |-> "LlmReturnedTerminal", effect_id |-> 0], [machine |-> "turn_execution", variant |-> "BoundaryComplete", payload |-> [run_id |-> "runid_1"], source_kind |-> "entry", source_route |-> "witness:barrier_tool_loop_path:15", source_machine |-> "external_entry", source_effect |-> "BoundaryComplete", effect_id |-> 0]>>
...
ops_lifecycle_RegisterOperation(arg_operation_id, arg_operation_kind) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
...
ops_lifecycle_ProvisioningSucceeded(arg_operation_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", effect |-> "SubmitOpEvent", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "ProvisioningSucceeded"] }
...
ops_lifecycle_ProvisioningFailed(arg_operation_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ops_lifecycle_active_count' = (ops_lifecycle_active_count) - 1
       /\ UNCHANGED << ops_lifecycle_known_operations, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", effect |-> "SubmitOpEvent", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "ProvisioningFailed"] }
...
ops_lifecycle_ProgressReported(arg_operation_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", effect |-> "SubmitOpEvent", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "ProgressReported"] }
...
ops_lifecycle_CompleteOperation(arg_operation_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", effect |-> "SubmitOpEvent", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "CompleteOperation"] }
...
ops_lifecycle_FailOperation(arg_operation_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", effect |-> "SubmitOpEvent", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "FailOperation"] }
...
ops_lifecycle_CancelOperation(arg_operation_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", effect |-> "SubmitOpEvent", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "CancelOperation"] }
...
ops_lifecycle_RetireCompleted(arg_operation_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], source_kind |-> "route", source_route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", source_effect |-> "SubmitOpEvent", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "op_event_enters_runtime_admission", source_machine |-> "ops_lifecycle", effect |-> "SubmitOpEvent", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> "Steer", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.operation_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "RetireCompleted"] }
...
ops_lifecycle_CollectTerminal(arg_operation_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ ops_lifecycle_phase' = "Active"
       /\ ops_lifecycle_terminal_buffered' = MapSet(ops_lifecycle_terminal_buffered, packet.payload.operation_id, FALSE)
       /\ UNCHANGED << ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
ops_lifecycle_OwnerTerminated ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << ops_lifecycle_known_operations, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
ops_lifecycle_WaitAll(arg_operation_ids) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "ops_lifecycle"
       /\ packet.variant = "WaitAll"
       /\ packet.payload.operation_ids = arg_operation_ids
       /\ ~HigherPriorityReady("ops_plane")
       /\ ops_lifecycle_phase = "Active"
       /\ ops_lifecycle_phase' = "Active"
       /\ UNCHANGED << ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "turn_execution", variant |-> "OpsBarrierSatisfied", payload |-> [run_id |-> owner_provided_run_id], source_kind |-> "route", source_route |-> "ops_barrier_satisfied_enters_turn_execution", source_machine |-> "ops_lifecycle", source_effect |-> "WaitAllSatisfied", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "OpsBarrierSatisfied", payload |-> [run_id |-> owner_provided_run_id], source_kind |-> "route", source_route |-> "ops_barrier_satisfied_enters_turn_execution", source_machine |-> "ops_lifecycle", source_effect |-> "WaitAllSatisfied", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "ops_barrier_satisfied_enters_turn_execution", source_machine |-> "ops_lifecycle", effect |-> "WaitAllSatisfied", target_machine |-> "turn_execution", target_input |-> "OpsBarrierSatisfied", payload |-> [run_id |-> owner_provided_run_id], actor |-> "turn_executor", effect_id |-> (model_step_count + 1), source_transition |-> "WaitAll"] }
...
runtime_control_Initialize ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
runtime_control_BeginRunFromIdle(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ runtime_control_wake_pending' = FALSE
       /\ runtime_control_process_pending' = FALSE
       /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
...
runtime_control_RecoverRequestedFromIdle ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ runtime_control_phase' = "Recovering"
       /\ runtime_control_pre_run_state' = Some("Idle")
       /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_current_run_id, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
runtime_control_AdmissionAcceptedIdleQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], source_kind |-> "route", source_route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], source_kind |-> "route", source_route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedIdleQueue"] }
...
runtime_control_AdmissionAcceptedIdleSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], source_kind |-> "route", source_route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedIdleSteer"] }
...
runtime_control_AdmissionAcceptedRunningQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], source_kind |-> "route", source_route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedRunningQueue"] }
...
runtime_control_AdmissionAcceptedRunningSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], source_kind |-> "route", source_route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedRunningSteer"] }
...
runtime_control_AdmissionAcceptedAttachedQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], source_kind |-> "route", source_route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedAttachedQueue"] }
...
runtime_control_AdmissionAcceptedAttachedSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], source_kind |-> "route", source_route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", source_effect |-> "SubmitAdmittedIngressEffect", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "admitted_op_work_enters_ingress", source_machine |-> "runtime_control", effect |-> "SubmitAdmittedIngressEffect", target_machine |-> "runtime_ingress", target_input |-> "AdmitQueued", payload |-> [content_shape |-> "contentshape_default", handling_mode |-> packet.payload.handling_mode, policy |-> "OperationQueued", request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.work_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "AdmissionAcceptedAttachedSteer"] }
...
runtime_ingress_StageDrainSnapshotFromActive(arg_run_id, arg_contributing_work_ids) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "ingress_ready_starts_runtime_control", source_machine |-> "runtime_ingress", effect |-> "ReadyForRun", target_machine |-> "runtime_control", target_input |-> "BeginRun", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "StageDrainSnapshotFromActive"] }
...
runtime_ingress_StageDrainSnapshotFromRetired(arg_run_id, arg_contributing_work_ids) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "BeginRun", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "ingress_ready_starts_runtime_control", source_machine |-> "runtime_ingress", source_effect |-> "ReadyForRun", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "ingress_ready_starts_runtime_control", source_machine |-> "runtime_ingress", effect |-> "ReadyForRun", target_machine |-> "runtime_control", target_input |-> "BeginRun", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "StageDrainSnapshotFromRetired"] }
...
turn_execution_ExtractionValidationPassed(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "ExtractionValidationPassed"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "ExtractionValidationPassed"] }
...
turn_execution_ExtractionExhausted(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "ExtractionExhausted"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "ExtractionExhausted"] }
...
turn_execution_FatalFailureFromExtracting(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "RunFailed", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_failure_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunFailed", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunFailed", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_failure_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunFailed", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_failure_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunFailed", target_machine |-> "runtime_ingress", target_input |-> "RunFailed", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "FatalFailureFromExtracting"], [route |-> "execution_failure_notifies_control", source_machine |-> "turn_execution", effect |-> "RunFailed", target_machine |-> "runtime_control", target_input |-> "RunFailed", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "FatalFailureFromExtracting"] }
...
turn_execution_TurnLimitReachedFromApplyingPrimitive(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "runtime_ingress", target_input |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromApplyingPrimitive"], [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromApplyingPrimitive"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromApplyingPrimitive"] }
...
turn_execution_TurnLimitReachedFromCallingLlm(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "runtime_ingress", target_input |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromCallingLlm"], [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromCallingLlm"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromCallingLlm"] }
...
turn_execution_TurnLimitReachedFromErrorRecovery(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "runtime_ingress", target_input |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromErrorRecovery"], [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromErrorRecovery"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromErrorRecovery"] }
...
turn_execution_BudgetExhaustedFromApplyingPrimitive(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "runtime_ingress", target_input |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromApplyingPrimitive"], [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromApplyingPrimitive"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromApplyingPrimitive"] }
...
turn_execution_BudgetExhaustedFromCallingLlm(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "runtime_ingress", target_input |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromCallingLlm"], [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromCallingLlm"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromCallingLlm"] }
...
turn_execution_BudgetExhaustedFromWaitingForOps(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "runtime_ingress", target_input |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromWaitingForOps"], [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromWaitingForOps"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromWaitingForOps"] }
...
turn_execution_BudgetExhaustedFromDrainingBoundary(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "runtime_ingress", target_input |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromDrainingBoundary"], [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromDrainingBoundary"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromDrainingBoundary"] }
...
turn_execution_BudgetExhaustedFromErrorRecovery(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_ingress", variant |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_ingress", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)], [machine |-> "runtime_control", variant |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], source_kind |-> "route", source_route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", source_effect |-> "RunCompleted", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "execution_boundary_updates_ingress", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "runtime_ingress", target_input |-> "BoundaryApplied", payload |-> [boundary_sequence |-> (turn_execution_boundary_count) + 1, run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromErrorRecovery"], [route |-> "execution_completion_updates_ingress", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_ingress", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "ordinary_ingress", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromErrorRecovery"], [route |-> "execution_completion_notifies_control", source_machine |-> "turn_execution", effect |-> "RunCompleted", target_machine |-> "runtime_control", target_input |-> "RunCompleted", payload |-> [run_id |-> packet.payload.run_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromErrorRecovery"] }
...
Inject_control_initialize ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_ops_wait_all(arg_operation_ids) ==
    /\ ~([machine |-> "ops_lifecycle", variant |-> "WaitAll", payload |-> [operation_ids |-> arg_operation_ids], source_kind |-> "entry", source_route |-> "ops_wait_all", source_machine |-> "external_entry", source_effect |-> "WaitAll", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "ops_lifecycle", variant |-> "WaitAll", payload |-> [operation_ids |-> arg_operation_ids], source_kind |-> "entry", source_route |-> "ops_wait_all", source_machine |-> "external_entry", source_effect |-> "WaitAll", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "ops_lifecycle", variant |-> "WaitAll", payload |-> [operation_ids |-> arg_operation_ids], source_kind |-> "entry", source_route |-> "ops_wait_all", source_machine |-> "external_entry", source_effect |-> "WaitAll", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_turn_ops_barrier_satisfied(arg_run_id) ==
    /\ ~([machine |-> "turn_execution", variant |-> "OpsBarrierSatisfied", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_ops_barrier_satisfied", source_machine |-> "external_entry", source_effect |-> "OpsBarrierSatisfied", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "OpsBarrierSatisfied", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_ops_barrier_satisfied", source_machine |-> "external_entry", source_effect |-> "OpsBarrierSatisfied", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "OpsBarrierSatisfied", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_ops_barrier_satisfied", source_machine |-> "external_entry", source_effect |-> "OpsBarrierSatisfied", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
Inject_turn_cancel_now(arg_run_id) ==
    /\ ~([machine |-> "turn_execution", variant |-> "CancelNow", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_cancel_now", source_machine |-> "external_entry", source_effect |-> "CancelNow", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "CancelNow", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_cancel_now", source_machine |-> "external_entry", source_effect |-> "CancelNow", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "CancelNow", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_cancel_now", source_machine |-> "external_entry", source_effect |-> "CancelNow", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_turn_cancel_after_boundary(arg_run_id) ==
    /\ ~([machine |-> "turn_execution", variant |-> "CancelAfterBoundary", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_cancel_after_boundary", source_machine |-> "external_entry", source_effect |-> "CancelAfterBoundary", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "CancelAfterBoundary", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_cancel_after_boundary", source_machine |-> "external_entry", source_effect |-> "CancelAfterBoundary", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "CancelAfterBoundary", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_cancel_after_boundary", source_machine |-> "external_entry", source_effect |-> "CancelAfterBoundary", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
Inject_turn_llm_returned_tool_calls(arg_run_id, arg_tool_count) ==
    /\ ~([machine |-> "turn_execution", variant |-> "LlmReturnedToolCalls", payload |-> [run_id |-> arg_run_id, tool_count |-> arg_tool_count], source_kind |-> "entry", source_route |-> "turn_llm_returned_tool_calls", source_machine |-> "external_entry", source_effect |-> "LlmReturnedToolCalls", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "LlmReturnedToolCalls", payload |-> [run_id |-> arg_run_id, tool_count |-> arg_tool_count], source_kind |-> "entry", source_route |-> "turn_llm_returned_tool_calls", source_machine |-> "external_entry", source_effect |-> "LlmReturnedToolCalls", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "LlmReturnedToolCalls", payload |-> [run_id |-> arg_run_id, tool_count |-> arg_tool_count], source_kind |-> "entry", source_route |-> "turn_llm_returned_tool_calls", source_machine |-> "external_entry", source_effect |-> "LlmReturnedToolCalls", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_turn_register_pending_ops(arg_run_id, arg_op_refs, arg_has_barrier_ops) ==
    /\ ~([machine |-> "turn_execution", variant |-> "RegisterPendingOps", payload |-> [has_barrier_ops |-> arg_has_barrier_ops, op_refs |-> arg_op_refs, run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_register_pending_ops", source_machine |-> "external_entry", source_effect |-> "RegisterPendingOps", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "RegisterPendingOps", payload |-> [has_barrier_ops |-> arg_has_barrier_ops, op_refs |-> arg_op_refs, run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_register_pending_ops", source_machine |-> "external_entry", source_effect |-> "RegisterPendingOps", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "RegisterPendingOps", payload |-> [has_barrier_ops |-> arg_has_barrier_ops, op_refs |-> arg_op_refs, run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_register_pending_ops", source_machine |-> "external_entry", source_effect |-> "RegisterPendingOps", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_turn_tool_calls_resolved(arg_run_id) ==
    /\ ~([machine |-> "turn_execution", variant |-> "ToolCallsResolved", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_tool_calls_resolved", source_machine |-> "external_entry", source_effect |-> "ToolCallsResolved", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "ToolCallsResolved", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_tool_calls_resolved", source_machine |-> "external_entry", source_effect |-> "ToolCallsResolved", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "ToolCallsResolved", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_tool_calls_resolved", source_machine |-> "external_entry", source_effect |-> "ToolCallsResolved", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_turn_boundary_continue(arg_run_id) ==
    /\ ~([machine |-> "turn_execution", variant |-> "BoundaryContinue", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_boundary_continue", source_machine |-> "external_entry", source_effect |-> "BoundaryContinue", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "BoundaryContinue", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_boundary_continue", source_machine |-> "external_entry", source_effect |-> "BoundaryContinue", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "turn_execution", variant |-> "BoundaryContinue", payload |-> [run_id |-> arg_run_id], source_kind |-> "entry", source_route |-> "turn_boundary_continue", source_machine |-> "external_entry", source_effect |-> "BoundaryContinue", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
DeliverQueuedRoute ==
    ...
    /\ LET route == Head(pending_routes) IN
       ...
       /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
WitnessInjectNext_op_success_path ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << ops_lifecycle_phase, ops_lifecycle_known_operations, ops_lifecycle_operation_status, ops_lifecycle_operation_kind, ops_lifecycle_peer_ready, ops_lifecycle_progress_count, ops_lifecycle_watcher_count, ops_lifecycle_terminal_outcome, ops_lifecycle_terminal_buffered, ops_lifecycle_completed_order, ops_lifecycle_max_completed, ops_lifecycle_max_concurrent, ops_lifecycle_active_count, ops_lifecycle_created_at_ms, ops_lifecycle_completed_at_ms, runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, turn_execution_phase, turn_execution_active_run, turn_execution_primitive_kind, turn_execution_admitted_content_shape, turn_execution_vision_enabled, turn_execution_image_tool_results_enabled, turn_execution_tool_calls_pending, turn_execution_pending_op_refs, turn_execution_has_barrier_ops, turn_execution_barrier_satisfied, turn_execution_boundary_count, turn_execution_cancel_after_boundary, turn_execution_terminal_outcome, turn_execution_extraction_attempts, turn_execution_max_extraction_retries, obligation_ops_barrier_satisfaction, pending_routes, delivered_routes, emitted_effects, observed_transitions >>
...
WitnessInjectNext_barrier_tool_loop_path ==
    /\ witness_current_script_input # None
    /\ ~(witness_current_script_input \in SeqElements(pending_inputs))
    /\ Len(pending_inputs) = 0
    /\ Len(pending_routes) = 0
...
CoreNext ==
    ...
    \/ ops_lifecycle_OwnerTerminated
    \/ \E arg_operation_ids \in SeqOfOperationIdValues : ops_lifecycle_WaitAll(arg_operation_ids)
    \/ ops_lifecycle_CollectCompleted
    \/ runtime_control_Initialize
    \/ runtime_control_AttachFromIdle
    \/ runtime_control_DetachToIdle
...
InjectNext ==
    \/ Inject_control_initialize
    \/ \E arg_operation_ids \in SeqOfOperationIdValues : Inject_ops_wait_all(arg_operation_ids)
    \/ \E arg_run_id \in RunIdValues : Inject_turn_ops_barrier_satisfied(arg_run_id)
    ...
    \/ \E arg_run_id \in RunIdValues : Inject_turn_cancel_now(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : Inject_turn_cancel_after_boundary(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : Inject_turn_cancellation_observed(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : \E arg_tool_count \in 0..2 : Inject_turn_llm_returned_tool_calls(arg_run_id, arg_tool_count)
    \/ \E arg_run_id \in RunIdValues : \E arg_op_refs \in SeqOfAsyncOpRefValues : \E arg_has_barrier_ops \in BOOLEAN : Inject_turn_register_pending_ops(arg_run_id, arg_op_refs, arg_has_barrier_ops)
    \/ \E arg_run_id \in RunIdValues : Inject_turn_tool_calls_resolved(arg_run_id)
    \/ \E arg_run_id \in RunIdValues : Inject_turn_boundary_continue(arg_run_id)
...
WitnessNext_barrier_tool_loop_path ==
    \/ CoreNext
    \/ WitnessInjectNext_barrier_tool_loop_path


async_op_events_reenter_runtime_via_operation_input == \A input_packet \in observed_inputs : ((input_packet.machine = "runtime_control" /\ input_packet.variant = "SubmitWork") => (/\ input_packet.source_kind = "route" /\ input_packet.source_machine = "ops_lifecycle" /\ input_packet.source_effect = "SubmitOpEvent" /\ \E effect_packet \in emitted_effects : /\ effect_packet.machine = "ops_lifecycle" /\ effect_packet.variant = "SubmitOpEvent" /\ effect_packet.effect_id = input_packet.effect_id /\ \E route_packet \in RoutePackets : /\ route_packet.route = input_packet.source_route /\ route_packet.source_machine = "ops_lifecycle" /\ route_packet.effect = "SubmitOpEvent" /\ route_packet.target_machine = "runtime_control" /\ route_packet.target_input = "SubmitWork" /\ route_packet.effect_id = input_packet.effect_id /\ route_packet.payload = input_packet.payload))
...
barrier_satisfaction_handoff_protocol_covered == TRUE

NoFeedbackWithoutObligation_ops_barrier_satisfaction == \A input_packet \in observed_inputs : (((input_packet.machine = "turn_execution" /\ input_packet.variant = "OpsBarrierSatisfied")) => (\E record \in obligation_ops_barrier_satisfaction : (record.operation_ids = input_packet.payload.operation_ids)))

\* Liveness: eventual feedback under task-scheduling fairness
OwnerFeedback_ops_barrier_satisfaction ==
    /\ obligation_ops_barrier_satisfaction /= {}
    /\ \E token \in obligation_ops_barrier_satisfaction :
        /\ pending_inputs' = Append(pending_inputs, [machine |-> "turn_execution", variant |-> "OpsBarrierSatisfied", source_kind |-> "owner", source_machine |-> "ops_lifecycle", source_effect |-> "WaitAllSatisfied", source_route |-> "none", effect_id |-> token, payload |-> [operation_ids |-> token.operation_ids]])
        /\ obligation_ops_barrier_satisfaction' = obligation_ops_barrier_satisfaction \ {token}
...
RouteObserved_ops_barrier_satisfied_enters_turn_execution == \E packet \in RoutePackets : packet.route = "ops_barrier_satisfied_enters_turn_execution"
RouteCoverage_ops_barrier_satisfied_enters_turn_execution == (RouteObserved_ops_barrier_satisfied_enters_turn_execution \/ ~RouteObserved_ops_barrier_satisfied_enters_turn_execution)
...
WitnessSpec_barrier_tool_loop_path == WitnessInit_barrier_tool_loop_path /\ [] [WitnessNext_barrier_tool_loop_path]_vars /\ WF_vars(DeliverQueuedRoute) /\ WF_vars(\E arg_operation_id \in OperationIdValues : \E arg_operation_kind \in OperationKindValues : ops_lifecycle_RegisterOperation(arg_operation_id, arg_operation_kind)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_ProvisioningSucceeded(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_ProvisioningFailed(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_PeerReady(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_RegisterWatcher(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_ProgressReported(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_CompleteOperation(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_FailOperation(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_CancelOperation(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_RetireRequested(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_RetireCompleted(arg_operation_id)) /\ WF_vars(\E arg_operation_id \in OperationIdValues : ops_lifecycle_CollectTerminal(arg_operation_id)) /\ WF_vars(ops_lifecycle_OwnerTerminated) /\ WF_vars(\E arg_operation_ids \in SeqOfOperationIdValues : ops_lifecycle_WaitAll(arg_operation_ids)) /\ WF_vars(ops_lifecycle_CollectCompleted) /\ WF_vars(runtime_control_Initialize) /\ WF_vars(runtime_control_AttachFromIdle) /\ WF_vars(runtime_control_DetachToIdle) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_BeginRunFromIdle(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_BeginRunFromRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_BeginRunFromAttached(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_BeginRunFromRecovering(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCompletedToIdle(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCompletedToAttached(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCompletedToRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunFailedToIdle(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunFailedToAttached(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunFailedToRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCancelledToIdle(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCancelledToAttached(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCancelledToRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCompletedFromRetiredInFlight(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunFailedFromRetiredInFlight(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_control_RunCancelledFromRetiredInFlight(arg_run_id)) /\ WF_vars(runtime_control_RecoverRequestedFromIdle) /\ WF_vars(runtime_control_RecoverRequestedFromRunning) /\ WF_vars(runtime_control_RecoverRequestedFromAttached) /\ WF_vars(runtime_control_RecoverySucceeded) /\ WF_vars(runtime_control_RetireRequestedFromIdle) /\ WF_vars(runtime_control_RetireRequestedFromRunning) /\ WF_vars(runtime_control_RetireRequestedFromAttached) /\ WF_vars(runtime_control_ResetRequested) /\ WF_vars(runtime_control_StopRequested) /\ WF_vars(runtime_control_DestroyRequested) /\ WF_vars(runtime_control_ResumeRequested) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : runtime_control_SubmitWorkFromIdle(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : runtime_control_SubmitWorkFromRunning(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : runtime_control_SubmitWorkFromAttached(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedIdleQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedIdleSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedRunningQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedRunningSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedAttachedQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_admission_effect \in AdmissionEffectValues : runtime_control_AdmissionAcceptedAttachedSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_admission_effect)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_reason \in {"alpha", "beta"} : runtime_control_AdmissionRejectedIdle(arg_work_id, arg_reason)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_reason \in {"alpha", "beta"} : runtime_control_AdmissionRejectedRunning(arg_work_id, arg_reason)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_reason \in {"alpha", "beta"} : runtime_control_AdmissionRejectedAttached(arg_work_id, arg_reason)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_existing_work_id \in WorkIdValues : runtime_control_AdmissionDeduplicatedIdle(arg_work_id, arg_existing_work_id)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_existing_work_id \in WorkIdValues : runtime_control_AdmissionDeduplicatedRunning(arg_work_id, arg_existing_work_id)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_existing_work_id \in WorkIdValues : runtime_control_AdmissionDeduplicatedAttached(arg_work_id, arg_existing_work_id)) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedIdle) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedRunning) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedRecovering) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedRetired) /\ WF_vars(runtime_control_ExternalToolDeltaReceivedAttached) /\ WF_vars(runtime_control_RecycleRequestedFromRetired) /\ WF_vars(runtime_control_RecycleRequestedFromIdle) /\ WF_vars(runtime_control_RecycleRequestedFromAttached) /\ WF_vars(runtime_control_RecycleSucceeded) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_policy \in PolicyDecisionValues : runtime_ingress_AdmitQueuedQueue(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_policy)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_handling_mode \in HandlingModeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_policy \in PolicyDecisionValues : runtime_ingress_AdmitQueuedSteer(arg_work_id, arg_content_shape, arg_handling_mode, arg_request_id, arg_reservation_key, arg_policy)) /\ WF_vars(\E arg_work_id \in WorkIdValues : \E arg_content_shape \in ContentShapeValues : \E arg_request_id \in OptionRequestIdValues : \E arg_reservation_key \in OptionReservationKeyValues : \E arg_policy \in PolicyDecisionValues : runtime_ingress_AdmitConsumedOnAccept(arg_work_id, arg_content_shape, arg_request_id, arg_reservation_key, arg_policy)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_contributing_work_ids \in SeqOfWorkIdValues : runtime_ingress_StageDrainSnapshotFromActive(arg_run_id, arg_contributing_work_ids)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_contributing_work_ids \in SeqOfWorkIdValues : runtime_ingress_StageDrainSnapshotFromRetired(arg_run_id, arg_contributing_work_ids)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_boundary_sequence \in 0..2 : runtime_ingress_BoundaryAppliedFromActive(arg_run_id, arg_boundary_sequence)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_boundary_sequence \in 0..2 : runtime_ingress_BoundaryAppliedFromRetired(arg_run_id, arg_boundary_sequence)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_ingress_RunCompletedFromActive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_ingress_RunCompletedFromRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_ingress_RunFailedFromActive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_ingress_RunFailedFromRetired(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_ingress_RunCancelledFromActive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : runtime_ingress_RunCancelledFromRetired(arg_run_id)) /\ WF_vars(\E arg_new_work_id \in WorkIdValues : \E arg_old_work_id \in WorkIdValues : runtime_ingress_SupersedeQueuedInputFromActive(arg_new_work_id, arg_old_work_id)) /\ WF_vars(\E arg_new_work_id \in WorkIdValues : \E arg_old_work_id \in WorkIdValues : runtime_ingress_SupersedeQueuedInputFromRetired(arg_new_work_id, arg_old_work_id)) /\ WF_vars(\E arg_aggregate_work_id \in WorkIdValues : \E arg_source_work_ids \in SeqOfWorkIdValues : runtime_ingress_CoalesceQueuedInputsFromActive(arg_aggregate_work_id, arg_source_work_ids)) /\ WF_vars(\E arg_aggregate_work_id \in WorkIdValues : \E arg_source_work_ids \in SeqOfWorkIdValues : runtime_ingress_CoalesceQueuedInputsFromRetired(arg_aggregate_work_id, arg_source_work_ids)) /\ WF_vars(runtime_ingress_Retire) /\ WF_vars(runtime_ingress_ResetFromActive) /\ WF_vars(runtime_ingress_ResetFromRetired) /\ WF_vars(runtime_ingress_Destroy) /\ WF_vars(runtime_ingress_RecoverFromActive) /\ WF_vars(runtime_ingress_RecoverFromRetired) /\ WF_vars(\E arg_intents \in SetOfStringValues : runtime_ingress_SetSilentIntentOverridesFromActive(arg_intents)) /\ WF_vars(\E arg_intents \in SetOfStringValues : runtime_ingress_SetSilentIntentOverridesFromRetired(arg_intents)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_StartConversationRun(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_StartImmediateAppend(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_StartImmediateContext(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedConversationTurn(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedImmediateAppend(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedImmediateAppendCancelsAfterBoundary(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedImmediateContext(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_admitted_content_shape \in ContentShapeValues : \E arg_vision_enabled \in BOOLEAN : \E arg_image_tool_results_enabled \in BOOLEAN : turn_execution_PrimitiveAppliedImmediateContextCancelsAfterBoundary(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_tool_count \in 0..2 : turn_execution_LlmReturnedToolCalls(arg_run_id, arg_tool_count)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_op_refs \in SeqOfAsyncOpRefValues : \E arg_has_barrier_ops \in BOOLEAN : turn_execution_RegisterPendingOps(arg_run_id, arg_op_refs, arg_has_barrier_ops)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_OpsBarrierSatisfied(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_ToolCallsResolved(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_LlmReturnedTerminal(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BoundaryContinue(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BoundaryContinueCancelsAfterBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BoundaryComplete(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BoundaryCompleteCancelsAfterBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : \E arg_max_retries \in 0..2 : turn_execution_EnterExtraction(arg_run_id, arg_max_retries)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_ExtractionValidationPassed(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_ExtractionRetry(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_ExtractionExhausted(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_RecoverableFailureFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_RecoverableFailureFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_RecoverableFailureFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_RetryRequested(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_FatalFailureFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelNowFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancelAfterBoundaryFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_CancellationObserved(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_TurnLimitReachedFromErrorRecovery(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromApplyingPrimitive(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromCallingLlm(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromWaitingForOps(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromDrainingBoundary(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromExtracting(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_BudgetExhaustedFromErrorRecovery(arg_run_id)) /\ WF_vars(turn_execution_ForceCancelNoRunFromReady) /\ WF_vars(turn_execution_ForceCancelNoRunFromApplyingPrimitive) /\ WF_vars(turn_execution_ForceCancelNoRunFromCallingLlm) /\ WF_vars(turn_execution_ForceCancelNoRunFromWaitingForOps) /\ WF_vars(turn_execution_ForceCancelNoRunFromDrainingBoundary) /\ WF_vars(turn_execution_ForceCancelNoRunFromExtracting) /\ WF_vars(turn_execution_ForceCancelNoRunFromErrorRecovery) /\ WF_vars(turn_execution_ForceCancelNoRunFromCancelling) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_AcknowledgeTerminalFromCompleted(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_AcknowledgeTerminalFromFailed(arg_run_id)) /\ WF_vars(\E arg_run_id \in RunIdValues : turn_execution_AcknowledgeTerminalFromCancelled(arg_run_id)) /\ WF_vars(WitnessInjectNext_barrier_tool_loop_path)
...
WitnessTransitionObserved_op_success_path_runtime_control_AdmissionAcceptedIdleSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleSteer")
WitnessTransitionObserved_op_success_path_runtime_ingress_AdmitQueuedSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedSteer")
WitnessTransitionObserved_op_success_path_runtime_ingress_StageDrainSnapshotFromActive == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "StageDrainSnapshotFromActive")
...
WitnessTransitionObserved_op_success_path_runtime_ingress_RunCompletedFromActive == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "RunCompletedFromActive")
WitnessTransitionObserved_op_success_path_runtime_control_RunCompletedToIdle == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "RunCompletedToIdle")
WitnessTransitionOrder_op_success_path_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "ops_lifecycle" /\ earlier.transition = "ProvisioningSucceeded" /\ later.machine = "runtime_control" /\ later.transition = "AdmissionAcceptedIdleSteer" /\ earlier.step < later.step)
WitnessTransitionOrder_op_success_path_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "AdmissionAcceptedIdleSteer" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedSteer" /\ earlier.step < later.step)
WitnessTransitionOrder_op_success_path_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_ingress" /\ earlier.transition = "StageDrainSnapshotFromActive" /\ later.machine = "runtime_control" /\ later.transition = "BeginRunFromIdle" /\ earlier.step < later.step)
...
WitnessTransitionObserved_op_failure_path_runtime_control_AdmissionAcceptedIdleSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleSteer")
WitnessTransitionObserved_op_failure_path_runtime_ingress_AdmitQueuedSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedSteer")
WitnessTransitionObserved_op_failure_path_runtime_ingress_StageDrainSnapshotFromActive == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "StageDrainSnapshotFromActive")
...
WitnessTransitionObserved_op_failure_path_runtime_ingress_RunFailedFromActive == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "RunFailedFromActive")
WitnessTransitionObserved_op_failure_path_runtime_control_RunFailedToIdle == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "RunFailedToIdle")
...
WitnessTransitionOrder_op_failure_path_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "FatalFailureFromApplyingPrimitive" /\ later.machine = "runtime_ingress" /\ later.transition = "RunFailedFromActive" /\ earlier.step < later.step)
WitnessTransitionOrder_op_failure_path_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "FatalFailureFromApplyingPrimitive" /\ later.machine = "runtime_control" /\ later.transition = "RunFailedToIdle" /\ earlier.step < later.step)
...
WitnessTransitionObserved_op_cancel_path_runtime_control_AdmissionAcceptedIdleSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleSteer")
WitnessTransitionObserved_op_cancel_path_runtime_ingress_AdmitQueuedSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedSteer")
WitnessTransitionObserved_op_cancel_path_runtime_ingress_StageDrainSnapshotFromActive == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "StageDrainSnapshotFromActive")
...
WitnessTransitionObserved_op_cancel_path_turn_execution_CancelNowFromApplyingPrimitive == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "CancelNowFromApplyingPrimitive")
...
WitnessTransitionObserved_op_cancel_path_runtime_ingress_RunCancelledFromActive == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "RunCancelledFromActive")
WitnessTransitionObserved_op_cancel_path_runtime_control_RunCancelledToIdle == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "RunCancelledToIdle")
...
WitnessTransitionOrder_op_cancel_path_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "CancellationObserved" /\ later.machine = "runtime_ingress" /\ later.transition = "RunCancelledFromActive" /\ earlier.step < later.step)
WitnessTransitionOrder_op_cancel_path_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "CancellationObserved" /\ later.machine = "runtime_control" /\ later.transition = "RunCancelledToIdle" /\ earlier.step < later.step)
...
WitnessTransitionObserved_control_preempts_op_ingress_runtime_control_AdmissionAcceptedIdleSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleSteer")
WitnessTransitionObserved_control_preempts_op_ingress_runtime_ingress_AdmitQueuedSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedSteer")
WitnessTransitionOrder_control_preempts_op_ingress_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "Initialize" /\ later.machine = "runtime_control" /\ later.transition = "AdmissionAcceptedIdleSteer" /\ earlier.step < later.step)
WitnessTransitionOrder_control_preempts_op_ingress_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "AdmissionAcceptedIdleSteer" /\ later.machine = "runtime_ingress" /\ later.transition = "AdmitQueuedSteer" /\ earlier.step < later.step)
WitnessRouteObserved_barrier_tool_loop_path_op_event_enters_runtime_admission == <> RouteObserved_op_event_enters_runtime_admission
WitnessRouteObserved_barrier_tool_loop_path_admitted_op_work_enters_ingress == <> RouteObserved_admitted_op_work_enters_ingress
WitnessRouteObserved_barrier_tool_loop_path_ingress_ready_starts_runtime_control == <> RouteObserved_ingress_ready_starts_runtime_control
WitnessRouteObserved_barrier_tool_loop_path_runtime_control_starts_execution == <> RouteObserved_runtime_control_starts_execution
WitnessRouteObserved_barrier_tool_loop_path_ops_barrier_satisfied_enters_turn_execution == <> RouteObserved_ops_barrier_satisfied_enters_turn_execution
WitnessRouteObserved_barrier_tool_loop_path_execution_boundary_updates_ingress == <> RouteObserved_execution_boundary_updates_ingress
WitnessRouteObserved_barrier_tool_loop_path_execution_completion_updates_ingress == <> RouteObserved_execution_completion_updates_ingress
WitnessRouteObserved_barrier_tool_loop_path_execution_completion_notifies_control == <> RouteObserved_execution_completion_notifies_control
WitnessStateObserved_barrier_tool_loop_path_1 == <> (ops_lifecycle_phase = "Active")
WitnessStateObserved_barrier_tool_loop_path_2 == <> (runtime_control_phase = "Idle")
WitnessStateObserved_barrier_tool_loop_path_3 == <> (runtime_ingress_phase = "Active")
WitnessStateObserved_barrier_tool_loop_path_4 == <> (turn_execution_phase = "Completed")
WitnessTransitionObserved_barrier_tool_loop_path_ops_lifecycle_RegisterOperation == <> (\E packet \in observed_transitions : /\ packet.machine = "ops_lifecycle" /\ packet.transition = "RegisterOperation")
WitnessTransitionObserved_barrier_tool_loop_path_ops_lifecycle_ProvisioningSucceeded == <> (\E packet \in observed_transitions : /\ packet.machine = "ops_lifecycle" /\ packet.transition = "ProvisioningSucceeded")
WitnessTransitionObserved_barrier_tool_loop_path_ops_lifecycle_CompleteOperation == <> (\E packet \in observed_transitions : /\ packet.machine = "ops_lifecycle" /\ packet.transition = "CompleteOperation")
WitnessTransitionObserved_barrier_tool_loop_path_ops_lifecycle_WaitAll == <> (\E packet \in observed_transitions : /\ packet.machine = "ops_lifecycle" /\ packet.transition = "WaitAll")
WitnessTransitionObserved_barrier_tool_loop_path_runtime_control_AdmissionAcceptedIdleSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "AdmissionAcceptedIdleSteer")
WitnessTransitionObserved_barrier_tool_loop_path_runtime_ingress_AdmitQueuedSteer == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "AdmitQueuedSteer")
WitnessTransitionObserved_barrier_tool_loop_path_runtime_ingress_StageDrainSnapshotFromActive == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "StageDrainSnapshotFromActive")
WitnessTransitionObserved_barrier_tool_loop_path_runtime_control_BeginRunFromIdle == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "BeginRunFromIdle")
WitnessTransitionObserved_barrier_tool_loop_path_turn_execution_StartConversationRun == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "StartConversationRun")
WitnessTransitionObserved_barrier_tool_loop_path_turn_execution_LlmReturnedToolCalls == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "LlmReturnedToolCalls")
WitnessTransitionObserved_barrier_tool_loop_path_turn_execution_RegisterPendingOps == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "RegisterPendingOps")
WitnessTransitionObserved_barrier_tool_loop_path_turn_execution_OpsBarrierSatisfied == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "OpsBarrierSatisfied")
WitnessTransitionObserved_barrier_tool_loop_path_turn_execution_ToolCallsResolved == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "ToolCallsResolved")
WitnessTransitionObserved_barrier_tool_loop_path_turn_execution_BoundaryContinue == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "BoundaryContinue")
WitnessTransitionObserved_barrier_tool_loop_path_turn_execution_BoundaryComplete == <> (\E packet \in observed_transitions : /\ packet.machine = "turn_execution" /\ packet.transition = "BoundaryComplete")
WitnessTransitionObserved_barrier_tool_loop_path_runtime_ingress_RunCompletedFromActive == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_ingress" /\ packet.transition = "RunCompletedFromActive")
WitnessTransitionObserved_barrier_tool_loop_path_runtime_control_RunCompletedToIdle == <> (\E packet \in observed_transitions : /\ packet.machine = "runtime_control" /\ packet.transition = "RunCompletedToIdle")
WitnessTransitionOrder_barrier_tool_loop_path_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "RegisterPendingOps" /\ later.machine = "ops_lifecycle" /\ later.transition = "WaitAll" /\ earlier.step < later.step)
WitnessTransitionOrder_barrier_tool_loop_path_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "ops_lifecycle" /\ earlier.transition = "WaitAll" /\ later.machine = "turn_execution" /\ later.transition = "OpsBarrierSatisfied" /\ earlier.step < later.step)
WitnessTransitionOrder_barrier_tool_loop_path_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "OpsBarrierSatisfied" /\ later.machine = "turn_execution" /\ later.transition = "ToolCallsResolved" /\ earlier.step < later.step)
WitnessTransitionOrder_barrier_tool_loop_path_4 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "ToolCallsResolved" /\ later.machine = "turn_execution" /\ later.transition = "BoundaryContinue" /\ earlier.step < later.step)
...
THEOREM Spec => []barrier_satisfaction_handoff_protocol_covered
...
THEOREM Spec => []NoFeedbackWithoutObligation_ops_barrier_satisfaction
