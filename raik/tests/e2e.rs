//! End-to-end tests for RAIK (Gate 1: E2E Scenarios)
//!
...
//!
//! Run with: cargo e2e (or cargo test --package raik --test e2e -- --ignored)
...
mod sub_agent_fork {
    ...
    async fn test_context_strategy_application() {
        ...
        session.push(Message::User(raik::UserMessage {
