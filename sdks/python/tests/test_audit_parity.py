...
RPC_PUBLIC_WRAPPERS: dict[str, tuple[type, str]] = {
    ...
    "session/state": (MeerkatClient, "session_state"),
    "session/accept": (MeerkatClient, "session_accept"),
    "session/retire": (MeerkatClient, "session_retire"),
    "session/reset": (MeerkatClient, "session_reset"),
    "session/input": (MeerkatClient, "session_input"),
    "session/inputs": (MeerkatClient, "session_inputs"),
