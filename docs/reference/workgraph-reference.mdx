...
rkat workgraph goal-create --title <TITLE> --session-id <SESSION_ID> [--namespace <NS>] [--completion-policy <POLICY>] [--json]
rkat workgraph goal-status --binding-id <BINDING_ID> [--namespace <NS>] [--json]
rkat workgraph goal-confirm --binding-id <BINDING_ID> --expected-revision <N> [--principal <ID>] [--namespace <NS>] [--json]
rkat workgraph goal-close --binding-id <BINDING_ID> --expected-revision <N> [--status <completed|cancelled|failed>] [--namespace <NS>] [--json]
rkat workgraph attention-list [--namespace <NS>] [--status <STATUS>] [--target-kind <KIND>] [--target-id <ID>] [--json]
rkat workgraph attention-pause --binding-id <BINDING_ID> --expected-revision <N> [--until <RFC3339>] [--namespace <NS>] [--json]
rkat workgraph attention-resume --binding-id <BINDING_ID> --expected-revision <N> [--namespace <NS>] [--json]
```
