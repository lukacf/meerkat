...
impl Pack for RctPack {
    ...
    fn definition(&self, task: &str, context: &str, overrides: &BTreeMap<String, String>, pp: Option<&Value>) -> MobDefinition {
        ...
        let agents: Vec<(&str, &str, &str, &str, ToolConfig)> = vec![
            ...
            ("integration_sheriff","rct-sheriff-skill",      "Integration Sheriff reviewer",    "claude-sonnet-4-6",  tools_with_shell.clone()),
            ("spec_auditor",       "rct-auditor-skill",      "Spec Auditor reviewer",           "claude-sonnet-4-6",  tools_with_shell.clone()),
