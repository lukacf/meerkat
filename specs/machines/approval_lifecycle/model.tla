...
Next ==
    ...
    \/ \E approval_id \in StringValues : \E status \in ApprovalLifecycleStatusValues : \E deny_allowed \in BOOLEAN : \E has_expiry \in BOOLEAN : \E decision \in OptionApprovalLifecycleDecisionValues : RestoreApproved(approval_id, status, TRUE, deny_allowed, has_expiry, decision)
    \/ \E approval_id \in StringValues : \E status \in ApprovalLifecycleStatusValues : \E approve_allowed \in BOOLEAN : \E has_expiry \in BOOLEAN : \E decision \in OptionApprovalLifecycleDecisionValues : RestoreDenied(approval_id, status, approve_allowed, TRUE, has_expiry, decision)
    ...
    \/ \E approval_id \in StringValues : ObserveExpiryExpiresPending(approval_id, TRUE)
