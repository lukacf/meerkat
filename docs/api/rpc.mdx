...
description: "Stateful JSON-RPC 2.0 interface for stdio, TCP, and optional live-channel WebSocket hosting."
icon: "terminal"
---
...
The export replays the durable event log page by page, so it requires a host
with the durable event projection installed. Outcomes:
...
```json Response
{
  ...
  "id": 8,
  "result": {
    "contract_version": {"major": 0, "minor": 8, "patch": 24},
    "capabilities": [
      {
        "id": "sessions",
