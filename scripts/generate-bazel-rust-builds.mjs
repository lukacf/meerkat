...
function writeRootBuild(fastTestLabels, e2eSystemTestLabels, surfaceFeatureMatrixLabels) {
  const lines = [
    ...
    `    89, 90, 92, 93, 94, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 107,`,
    `]`,
    ``,
    ...
    `            ["//tests/integration:gpt_live_public_e2e_test"] if scenario in (97, 98, 99, 100, 101, 102, 103, 104, 105, 107) else []`,
    `        ),`,
    `        env = dict(`,
    `            E2E_SMOKE_REMOTE_ENV,`,
