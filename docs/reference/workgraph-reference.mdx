...
rkat workgraph goal-create <SESSION_ID> <TITLE> [--namespace <NS>] [--description <TEXT>] [--mode <MODE>] [--completion-policy <POLICY>] [--supervisor <OWNER>] [--reviewer-threshold <N>] [--json]
rkat workgraph goal-status <BINDING_ID> [--namespace <NS>] [--json]
rkat workgraph goal-confirm <BINDING_ID> --expected-revision <N> --kind <KIND> --id <ID> [--principal <OWNER>] [--namespace <NS>] [--label <TEXT>] [--summary <TEXT>] [--json]
