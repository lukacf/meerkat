        ...
        machine_manifest_from_schema(
            ...
            &[
                ...
                scenario(
                    ...
                    "abort, wait, abort all, request cancellation at boundary, completion produced/resolved, wait all satisfied, collect completed result, recover op record, recover ops completion cursor, evict completed op, collect completed op, submit op event, resolve op lifecycle transition rejected feedback, notify op watcher, reject surface call, retain or evict completed terminal records",
                ),
                scenario(
        ...
        machine_manifest_from_schema(
            ...
            &[
                scenario(
                    ...
                    "CreateOpen, CreateBlocked, UpdateOpen, UpdateInProgress, UpdateBlocked, RefreshEligibilityOpen, RefreshEligibilityInProgress, RefreshEligibilityBlocked, Created, Updated, ClaimOpen, ClaimExpiredInProgress, Claimed, due eligibility, blocker satisfaction, and CAS revision",
                ),
                scenario(
