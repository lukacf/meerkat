...
| Mob runtime | `meerkat-mob` | Mobs, member lifecycle, flows, wiring, task board, supervisor bridge, mob storage. |
...
The canonical machine catalog contains five machines:
