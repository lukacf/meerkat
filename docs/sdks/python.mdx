...
The Python SDK (`meerkat-sdk`) communicates with the `rkat` JSON-RPC server over stdio to manage sessions, run agent turns, stream events, and query capabilities.
