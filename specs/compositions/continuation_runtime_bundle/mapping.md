...
- `runtime_comms_sink`: `meerkat-runtime/src/comms_sink.rs` — host continuation precursor slated for deletion
...
- `continuation_enters_ingress`
  - anchors: `host_mode_cutover`, `runtime_comms_sink`, `agent_comms_impl`, `agent_runner`
