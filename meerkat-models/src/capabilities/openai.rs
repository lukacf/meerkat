...
pub const CAPABILITIES: &[ModelCapabilities] = &[
    ...
    // Public Live endpoint only; token limits are not published.
    ...
    ModelCapabilities {
        ...
        inline_video: false,
        interaction_kind: ModelInteractionKind::ContinuousLive,
        realtime_supports_provider_managed_turns: false,
        realtime_supports_explicit_commit: false,
        realtime_interrupt_supported: false,
        ...
        supports_thinking_budget_legacy: false,
        beta_headers: &[],
        // Transport I/O bound, not a voice-session duration limit.
        call_timeout_secs: Some(30),
    },
    // GPT Live 1 Codex
    //
    // Private, pre-release ChatGPT-brokered realtime voice model. This row
    // records only capabilities established by the validated direct protocol
    // probe. Unknown context and output limits stay unknown rather than being
    // copied from the public Realtime family. Its Experimental release stage
    // requires a separate, off-by-default admission path and must never select
    // the public Realtime factory.
    ModelCapabilities {
        id: "gpt-live-1-codex",
        provider: Provider::OpenAI,
        display_name: "GPT Live 1 Codex (Experimental)",
        tier: ModelTier::Supported,
        ...
        image_tool_results: false,
        inline_video: false,
        interaction_kind: ModelInteractionKind::TurnBasedRealtime,
