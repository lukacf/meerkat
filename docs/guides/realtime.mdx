...
`ModelCapabilities.realtime: bool` is set per model in the curated catalog (`meerkat_core::model_profile`). Capability is catalog data, not prefix inference:
