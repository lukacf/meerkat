...
mutation methods are trusted host-control methods: public REST and JSON-RPC
servers expose observability, but fail closed for create, confirm, close, pause,
resume, and continuation injection unless the call is made through an in-process
