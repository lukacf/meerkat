// @generated — protocol helpers for `work_execution_quarantined_launch_resolution`
// Composition: workgraph_flow_bundle, Producer: work_execution, Effect: FlowLaunchQuarantined
...
#[derive(Debug, Clone)]
pub struct WorkExecutionQuarantinedLaunchResolutionObligation {
...
#[macro_export]
macro_rules! work_execution_quarantined_launch_resolution_feedback_input_patterns {
    () => {
...
) -> Vec<WorkExecutionQuarantinedLaunchResolutionObligation> {
    transition
        .effects()
        .iter()
        .filter_map(|effect| match effect {
            WorkExecutionLifecycleEffect::FlowLaunchQuarantined {
                ...
                run_id,
                detail,
            } => Some(WorkExecutionQuarantinedLaunchResolutionObligation {
...
pub fn submit_confirm_flow_started(
    ...
    _obligation: WorkExecutionQuarantinedLaunchResolutionObligation,
