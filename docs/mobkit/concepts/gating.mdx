...
- [Delivery](/mobkit/concepts/delivery) - route and send after the caller accepts a gating outcome
- [Memory](/mobkit/concepts/memory) - assertions and conflict handling
- [JSON-RPC API](/mobkit/api/rpc) - exact method parameters and responses
- [Configuration](/mobkit/reference/configuration) - runtime configuration
