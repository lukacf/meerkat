...
\* Generated composition model for schedule_runtime_bundle.
...
WitnessInit_runtime_delivery_completion_path ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "occurrence", variant |-> "Claim", payload |-> [claim_time_utc_ms |-> 10, lease_expiry_utc_ms |-> 20, owner_id |-> "scheduler-owner"], source_kind |-> "entry", source_route |-> "witness:runtime_delivery_completion_path:1", source_machine |-> "external_entry", source_effect |-> "Claim", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "occurrence", variant |-> "Claim", payload |-> [claim_time_utc_ms |-> 10, lease_expiry_utc_ms |-> 20, owner_id |-> "scheduler-owner"], source_kind |-> "entry", source_route |-> "witness:runtime_delivery_completion_path:1", source_machine |-> "external_entry", source_effect |-> "Claim", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "occurrence", variant |-> "Claim", payload |-> [claim_time_utc_ms |-> 10, lease_expiry_utc_ms |-> 20, owner_id |-> "scheduler-owner"], source_kind |-> "entry", source_route |-> "witness:runtime_delivery_completion_path:1", source_machine |-> "external_entry", source_effect |-> "Claim", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<[machine |-> "occurrence", variant |-> "StartRuntimeDispatch", payload |-> [delivery_correlation_id |-> "corr-1"], source_kind |-> "entry", source_route |-> "witness:runtime_delivery_completion_path:2", source_machine |-> "external_entry", source_effect |-> "StartRuntimeDispatch", effect_id |-> 0], [machine |-> "occurrence", variant |-> "RuntimeAccepted", payload |-> [attempt_count |-> 1, occurrence_id |-> "occurrence-0"], source_kind |-> "entry", source_route |-> "witness:runtime_delivery_completion_path:3", source_machine |-> "external_entry", source_effect |-> "RuntimeAccepted", effect_id |-> 0], [machine |-> "occurrence", variant |-> "RuntimeCompleted", payload |-> [attempt_count |-> 1, occurrence_id |-> "occurrence-0"], source_kind |-> "entry", source_route |-> "witness:runtime_delivery_completion_path:4", source_machine |-> "external_entry", source_effect |-> "RuntimeCompleted", effect_id |-> 0]>>

WitnessInit_runtime_lease_expiry_reclaims_occurrence ==
    /\ BaseInit
    /\ pending_inputs = <<[machine |-> "occurrence", variant |-> "Claim", payload |-> [claim_time_utc_ms |-> 10, lease_expiry_utc_ms |-> 20, owner_id |-> "scheduler-owner"], source_kind |-> "entry", source_route |-> "witness:runtime_lease_expiry_reclaims_occurrence:1", source_machine |-> "external_entry", source_effect |-> "Claim", effect_id |-> 0]>>
    /\ observed_inputs = {[machine |-> "occurrence", variant |-> "Claim", payload |-> [claim_time_utc_ms |-> 10, lease_expiry_utc_ms |-> 20, owner_id |-> "scheduler-owner"], source_kind |-> "entry", source_route |-> "witness:runtime_lease_expiry_reclaims_occurrence:1", source_machine |-> "external_entry", source_effect |-> "Claim", effect_id |-> 0]}
    /\ witness_current_script_input = [machine |-> "occurrence", variant |-> "Claim", payload |-> [claim_time_utc_ms |-> 10, lease_expiry_utc_ms |-> 20, owner_id |-> "scheduler-owner"], source_kind |-> "entry", source_route |-> "witness:runtime_lease_expiry_reclaims_occurrence:1", source_machine |-> "external_entry", source_effect |-> "Claim", effect_id |-> 0]
    /\ witness_remaining_script_inputs = <<[machine |-> "occurrence", variant |-> "StartRuntimeDispatch", payload |-> [delivery_correlation_id |-> "corr-2"], source_kind |-> "entry", source_route |-> "witness:runtime_lease_expiry_reclaims_occurrence:2", source_machine |-> "external_entry", source_effect |-> "StartRuntimeDispatch", effect_id |-> 0], [machine |-> "occurrence", variant |-> "LeaseExpired", payload |-> [tag |-> "unit"], source_kind |-> "entry", source_route |-> "witness:runtime_lease_expiry_reclaims_occurrence:3", source_machine |-> "external_entry", source_effect |-> "LeaseExpired", effect_id |-> 0]>>
...
Inject_occurrence_start_runtime_dispatch(arg_delivery_correlation_id) ==
    /\ ~([machine |-> "occurrence", variant |-> "StartRuntimeDispatch", payload |-> [delivery_correlation_id |-> arg_delivery_correlation_id], source_kind |-> "entry", source_route |-> "occurrence_start_runtime_dispatch", source_machine |-> "external_entry", source_effect |-> "StartRuntimeDispatch", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "occurrence", variant |-> "StartRuntimeDispatch", payload |-> [delivery_correlation_id |-> arg_delivery_correlation_id], source_kind |-> "entry", source_route |-> "occurrence_start_runtime_dispatch", source_machine |-> "external_entry", source_effect |-> "StartRuntimeDispatch", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "occurrence", variant |-> "StartRuntimeDispatch", payload |-> [delivery_correlation_id |-> arg_delivery_correlation_id], source_kind |-> "entry", source_route |-> "occurrence_start_runtime_dispatch", source_machine |-> "external_entry", source_effect |-> "StartRuntimeDispatch", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_target_binding_key, occurrence_due_at_utc_ms, occurrence_lease_held, occurrence_lease_owner, occurrence_lease_expiry_utc_ms, occurrence_delivery_correlation_id, occurrence_open_delivery_protocol, occurrence_last_receipt_stage, occurrence_failure_class, occurrence_attempt_count, occurrence_superseded_by_revision, obligation_occurrence_runtime_delivery, obligation_occurrence_mob_delivery, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_occurrence_runtime_accepted(arg_occurrence_id, arg_attempt_count) ==
    /\ ~([machine |-> "occurrence", variant |-> "RuntimeAccepted", payload |-> [attempt_count |-> arg_attempt_count, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_accepted", source_machine |-> "external_entry", source_effect |-> "RuntimeAccepted", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "occurrence", variant |-> "RuntimeAccepted", payload |-> [attempt_count |-> arg_attempt_count, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_accepted", source_machine |-> "external_entry", source_effect |-> "RuntimeAccepted", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "occurrence", variant |-> "RuntimeAccepted", payload |-> [attempt_count |-> arg_attempt_count, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_accepted", source_machine |-> "external_entry", source_effect |-> "RuntimeAccepted", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_target_binding_key, occurrence_due_at_utc_ms, occurrence_lease_held, occurrence_lease_owner, occurrence_lease_expiry_utc_ms, occurrence_delivery_correlation_id, occurrence_open_delivery_protocol, occurrence_last_receipt_stage, occurrence_failure_class, occurrence_attempt_count, occurrence_superseded_by_revision, obligation_occurrence_runtime_delivery, obligation_occurrence_mob_delivery, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_occurrence_runtime_completed(arg_occurrence_id, arg_attempt_count) ==
    /\ ~([machine |-> "occurrence", variant |-> "RuntimeCompleted", payload |-> [attempt_count |-> arg_attempt_count, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_completed", source_machine |-> "external_entry", source_effect |-> "RuntimeCompleted", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "occurrence", variant |-> "RuntimeCompleted", payload |-> [attempt_count |-> arg_attempt_count, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_completed", source_machine |-> "external_entry", source_effect |-> "RuntimeCompleted", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "occurrence", variant |-> "RuntimeCompleted", payload |-> [attempt_count |-> arg_attempt_count, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_completed", source_machine |-> "external_entry", source_effect |-> "RuntimeCompleted", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_target_binding_key, occurrence_due_at_utc_ms, occurrence_lease_held, occurrence_lease_owner, occurrence_lease_expiry_utc_ms, occurrence_delivery_correlation_id, occurrence_open_delivery_protocol, occurrence_last_receipt_stage, occurrence_failure_class, occurrence_attempt_count, occurrence_superseded_by_revision, obligation_occurrence_runtime_delivery, obligation_occurrence_mob_delivery, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_occurrence_runtime_skipped(arg_occurrence_id, arg_attempt_count, arg_failure_class) ==
    /\ ~([machine |-> "occurrence", variant |-> "RuntimeSkipped", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_skipped", source_machine |-> "external_entry", source_effect |-> "RuntimeSkipped", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "occurrence", variant |-> "RuntimeSkipped", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_skipped", source_machine |-> "external_entry", source_effect |-> "RuntimeSkipped", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "occurrence", variant |-> "RuntimeSkipped", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_skipped", source_machine |-> "external_entry", source_effect |-> "RuntimeSkipped", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_target_binding_key, occurrence_due_at_utc_ms, occurrence_lease_held, occurrence_lease_owner, occurrence_lease_expiry_utc_ms, occurrence_delivery_correlation_id, occurrence_open_delivery_protocol, occurrence_last_receipt_stage, occurrence_failure_class, occurrence_attempt_count, occurrence_superseded_by_revision, obligation_occurrence_runtime_delivery, obligation_occurrence_mob_delivery, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_occurrence_runtime_misfired(arg_occurrence_id, arg_attempt_count, arg_failure_class) ==
    /\ ~([machine |-> "occurrence", variant |-> "RuntimeMisfired", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_misfired", source_machine |-> "external_entry", source_effect |-> "RuntimeMisfired", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "occurrence", variant |-> "RuntimeMisfired", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_misfired", source_machine |-> "external_entry", source_effect |-> "RuntimeMisfired", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "occurrence", variant |-> "RuntimeMisfired", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_misfired", source_machine |-> "external_entry", source_effect |-> "RuntimeMisfired", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_target_binding_key, occurrence_due_at_utc_ms, occurrence_lease_held, occurrence_lease_owner, occurrence_lease_expiry_utc_ms, occurrence_delivery_correlation_id, occurrence_open_delivery_protocol, occurrence_last_receipt_stage, occurrence_failure_class, occurrence_attempt_count, occurrence_superseded_by_revision, obligation_occurrence_runtime_delivery, obligation_occurrence_mob_delivery, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>

Inject_occurrence_runtime_failed(arg_occurrence_id, arg_attempt_count, arg_failure_class) ==
    /\ ~([machine |-> "occurrence", variant |-> "RuntimeDeliveryFailed", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_failed", source_machine |-> "external_entry", source_effect |-> "RuntimeDeliveryFailed", effect_id |-> 0] \in SeqElements(pending_inputs))
    /\ pending_inputs' = Append(pending_inputs, [machine |-> "occurrence", variant |-> "RuntimeDeliveryFailed", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_failed", source_machine |-> "external_entry", source_effect |-> "RuntimeDeliveryFailed", effect_id |-> 0])
    /\ observed_inputs' = observed_inputs \cup {[machine |-> "occurrence", variant |-> "RuntimeDeliveryFailed", payload |-> [attempt_count |-> arg_attempt_count, failure_class |-> arg_failure_class, occurrence_id |-> arg_occurrence_id], source_kind |-> "entry", source_route |-> "occurrence_runtime_failed", source_machine |-> "external_entry", source_effect |-> "RuntimeDeliveryFailed", effect_id |-> 0]}
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << occurrence_phase, occurrence_occurrence_id, occurrence_schedule_id, occurrence_schedule_revision, occurrence_occurrence_ordinal, occurrence_target_binding_key, occurrence_due_at_utc_ms, occurrence_lease_held, occurrence_lease_owner, occurrence_lease_expiry_utc_ms, occurrence_delivery_correlation_id, occurrence_open_delivery_protocol, occurrence_last_receipt_stage, occurrence_failure_class, occurrence_attempt_count, occurrence_superseded_by_revision, obligation_occurrence_runtime_delivery, obligation_occurrence_mob_delivery, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs >>
...
WitnessInjectNext_runtime_delivery_completion_path ==
    /\ witness_current_script_input # None
...
WitnessInjectNext_runtime_lease_expiry_reclaims_occurrence ==
    /\ witness_current_script_input # None
    /\ ~(witness_current_script_input \in SeqElements(pending_inputs))
    /\ Len(pending_inputs) = 0
    /\ Len(pending_routes) = 0
...
InjectNext ==
    ...
    \/ \E arg_delivery_correlation_id \in {"alpha", "beta"} : Inject_occurrence_start_runtime_dispatch(arg_delivery_correlation_id)
    \/ \E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : Inject_occurrence_runtime_accepted(arg_occurrence_id, arg_attempt_count)
    \/ \E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : Inject_occurrence_runtime_completed(arg_occurrence_id, arg_attempt_count)
    \/ \E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : Inject_occurrence_runtime_skipped(arg_occurrence_id, arg_attempt_count, arg_failure_class)
    \/ \E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : Inject_occurrence_runtime_misfired(arg_occurrence_id, arg_attempt_count, arg_failure_class)
    \/ \E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : Inject_occurrence_runtime_failed(arg_occurrence_id, arg_attempt_count, arg_failure_class)
    \/ Inject_occurrence_lease_expired
...
WitnessNext_runtime_delivery_completion_path ==
    \/ CoreNext
    \/ WitnessInjectNext_runtime_delivery_completion_path

WitnessNext_runtime_lease_expiry_reclaims_occurrence ==
    \/ CoreNext
    \/ WitnessInjectNext_runtime_lease_expiry_reclaims_occurrence


runtime_delivery_protocol_covered == TRUE
...
WitnessStateConstraint_runtime_delivery_completion_path == /\ model_step_count <= 8 /\ Len(pending_inputs) <= 1 /\ Cardinality(observed_inputs) <= 4 /\ Len(pending_routes) <= 1 /\ Cardinality(delivered_routes) <= 1 /\ Cardinality(emitted_effects) <= 4 /\ Cardinality(observed_transitions) <= 8
WitnessStateConstraint_runtime_lease_expiry_reclaims_occurrence == /\ model_step_count <= 6 /\ Len(pending_inputs) <= 1 /\ Cardinality(observed_inputs) <= 4 /\ Len(pending_routes) <= 1 /\ Cardinality(delivered_routes) <= 1 /\ Cardinality(emitted_effects) <= 3 /\ Cardinality(observed_transitions) <= 6

Spec == Init /\ [][Next]_vars
WitnessSpec_runtime_delivery_completion_path == WitnessInit_runtime_delivery_completion_path /\ [] [WitnessNext_runtime_delivery_completion_path]_vars /\ WF_vars(\E arg_claim_time_utc_ms \in 0..2 : \E arg_owner_id \in {"alpha", "beta"} : \E arg_lease_expiry_utc_ms \in 0..2 : occurrence_ClaimPending(arg_claim_time_utc_ms, arg_owner_id, arg_lease_expiry_utc_ms)) /\ WF_vars(\E arg_delivery_correlation_id \in {"alpha", "beta"} : occurrence_StartRuntimeDispatchFromClaimed(arg_delivery_correlation_id)) /\ WF_vars(\E arg_delivery_correlation_id \in {"alpha", "beta"} : occurrence_StartMobDispatchFromClaimed(arg_delivery_correlation_id)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : occurrence_RuntimeAcceptedFromDispatching(arg_occurrence_id, arg_attempt_count)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : occurrence_MobAcceptedFromDispatching(arg_occurrence_id, arg_attempt_count)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : occurrence_RuntimeCompletedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : occurrence_MobCompletedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_RuntimeSkippedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_MobSkippedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_RuntimeMisfiredFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_MobMisfiredFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_RuntimeDeliveryFailedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_MobDeliveryFailedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_superseding_revision \in 0..2 : occurrence_SupersedePending(arg_superseding_revision)) /\ WF_vars(occurrence_LeaseExpiredFromClaimed) /\ WF_vars(occurrence_LeaseExpiredFromDispatching) /\ WF_vars(occurrence_LeaseExpiredFromAwaitingCompletion) /\ WF_vars(WitnessInjectNext_runtime_delivery_completion_path)
WitnessSpec_runtime_lease_expiry_reclaims_occurrence == WitnessInit_runtime_lease_expiry_reclaims_occurrence /\ [] [WitnessNext_runtime_lease_expiry_reclaims_occurrence]_vars /\ WF_vars(\E arg_claim_time_utc_ms \in 0..2 : \E arg_owner_id \in {"alpha", "beta"} : \E arg_lease_expiry_utc_ms \in 0..2 : occurrence_ClaimPending(arg_claim_time_utc_ms, arg_owner_id, arg_lease_expiry_utc_ms)) /\ WF_vars(\E arg_delivery_correlation_id \in {"alpha", "beta"} : occurrence_StartRuntimeDispatchFromClaimed(arg_delivery_correlation_id)) /\ WF_vars(\E arg_delivery_correlation_id \in {"alpha", "beta"} : occurrence_StartMobDispatchFromClaimed(arg_delivery_correlation_id)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : occurrence_RuntimeAcceptedFromDispatching(arg_occurrence_id, arg_attempt_count)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : occurrence_MobAcceptedFromDispatching(arg_occurrence_id, arg_attempt_count)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : occurrence_RuntimeCompletedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : occurrence_MobCompletedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_RuntimeSkippedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_MobSkippedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_RuntimeMisfiredFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_MobMisfiredFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_RuntimeDeliveryFailedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_occurrence_id \in OccurrenceIdValues : \E arg_attempt_count \in 0..2 : \E arg_failure_class \in OccurrenceFailureClassValues : occurrence_MobDeliveryFailedFromDispatchingOrAwaiting(arg_occurrence_id, arg_attempt_count, arg_failure_class)) /\ WF_vars(\E arg_superseding_revision \in 0..2 : occurrence_SupersedePending(arg_superseding_revision)) /\ WF_vars(occurrence_LeaseExpiredFromClaimed) /\ WF_vars(occurrence_LeaseExpiredFromDispatching) /\ WF_vars(occurrence_LeaseExpiredFromAwaitingCompletion) /\ WF_vars(WitnessInjectNext_runtime_lease_expiry_reclaims_occurrence)

WitnessStateObserved_runtime_delivery_completion_path_1 == <> (occurrence_phase = "Completed")
WitnessTransitionObserved_runtime_delivery_completion_path_occurrence_ClaimPending == <> (\E packet \in observed_transitions : /\ packet.machine = "occurrence" /\ packet.transition = "ClaimPending")
WitnessTransitionObserved_runtime_delivery_completion_path_occurrence_StartRuntimeDispatchFromClaimed == <> (\E packet \in observed_transitions : /\ packet.machine = "occurrence" /\ packet.transition = "StartRuntimeDispatchFromClaimed")
WitnessTransitionObserved_runtime_delivery_completion_path_occurrence_RuntimeAcceptedFromDispatching == <> (\E packet \in observed_transitions : /\ packet.machine = "occurrence" /\ packet.transition = "RuntimeAcceptedFromDispatching")
WitnessTransitionObserved_runtime_delivery_completion_path_occurrence_RuntimeCompletedFromDispatchingOrAwaiting == <> (\E packet \in observed_transitions : /\ packet.machine = "occurrence" /\ packet.transition = "RuntimeCompletedFromDispatchingOrAwaiting")
WitnessTransitionOrder_runtime_delivery_completion_path_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "occurrence" /\ earlier.transition = "ClaimPending" /\ later.machine = "occurrence" /\ later.transition = "StartRuntimeDispatchFromClaimed" /\ earlier.step < later.step)
WitnessTransitionOrder_runtime_delivery_completion_path_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "occurrence" /\ earlier.transition = "StartRuntimeDispatchFromClaimed" /\ later.machine = "occurrence" /\ later.transition = "RuntimeAcceptedFromDispatching" /\ earlier.step < later.step)
WitnessTransitionOrder_runtime_delivery_completion_path_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "occurrence" /\ earlier.transition = "RuntimeAcceptedFromDispatching" /\ later.machine = "occurrence" /\ later.transition = "RuntimeCompletedFromDispatchingOrAwaiting" /\ earlier.step < later.step)
WitnessStateObserved_runtime_lease_expiry_reclaims_occurrence_1 == <> (occurrence_phase = "Pending")
WitnessTransitionObserved_runtime_lease_expiry_reclaims_occurrence_occurrence_ClaimPending == <> (\E packet \in observed_transitions : /\ packet.machine = "occurrence" /\ packet.transition = "ClaimPending")
WitnessTransitionObserved_runtime_lease_expiry_reclaims_occurrence_occurrence_StartRuntimeDispatchFromClaimed == <> (\E packet \in observed_transitions : /\ packet.machine = "occurrence" /\ packet.transition = "StartRuntimeDispatchFromClaimed")
WitnessTransitionObserved_runtime_lease_expiry_reclaims_occurrence_occurrence_LeaseExpiredFromDispatching == <> (\E packet \in observed_transitions : /\ packet.machine = "occurrence" /\ packet.transition = "LeaseExpiredFromDispatching")
WitnessTransitionOrder_runtime_lease_expiry_reclaims_occurrence_1 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "occurrence" /\ earlier.transition = "ClaimPending" /\ later.machine = "occurrence" /\ later.transition = "StartRuntimeDispatchFromClaimed" /\ earlier.step < later.step)
WitnessTransitionOrder_runtime_lease_expiry_reclaims_occurrence_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "occurrence" /\ earlier.transition = "StartRuntimeDispatchFromClaimed" /\ later.machine = "occurrence" /\ later.transition = "LeaseExpiredFromDispatching" /\ earlier.step < later.step)

THEOREM Spec => []runtime_delivery_protocol_covered
