...
- Cancellation requires generated authority for the exact live operation. It
  ...
  Supersession cancels and settles the previous voice operation before
  acquiring the source transcript mutation boundary or admitting replacement
  work. Replacement execution still requires canonical final-input commitment
  and reconciliation; unrelated running text is allowed to finish normally.
