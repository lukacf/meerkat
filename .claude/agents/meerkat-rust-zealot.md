...
Review provider implementations in their owning crates and agent-client adaptation in `crates/meerkat-llm-core/src/adapter.rs`. Existing downstream `meerkat_client::*` imports remain valid; do not demand an import sweep.
