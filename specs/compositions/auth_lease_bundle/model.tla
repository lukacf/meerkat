...
WitnessInit_auth_release_oauth_flow_drain_round_trip ==
    /\ BaseInit
    /\ pending_inputs = <<>>
    /\ observed_inputs = {}
    /\ witness_current_script_input = None
...
auth_machine_Acquire(arg_expires_at_ts, arg_credential_published_at_millis) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << obligation_auth_machine_auth_release_oauth_flow_drain >>
...
auth_machine_BeginReleaseDrainingOAuthFlowsValid ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ obligation_auth_machine_auth_release_oauth_flow_drain' = obligation_auth_machine_auth_release_oauth_flow_drain \cup {[browser_flow_ids |-> auth_machine_oauth_browser_flow_ids, device_flow_ids |-> auth_machine_oauth_device_flow_ids]}
...
NoFeedbackWithoutObligation_auth_machine_auth_release_oauth_flow_drain == \A input_packet \in observed_inputs : ((((input_packet.machine = "auth_machine" /\ input_packet.variant = "ExpireOAuthBrowserFlow")) => (obligation_auth_machine_auth_release_oauth_flow_drain /= {})) /\ (((input_packet.machine = "auth_machine" /\ input_packet.variant = "ExpireOAuthDeviceFlow")) => (obligation_auth_machine_auth_release_oauth_flow_drain /= {})))
...
WitnessStateConstraint_auth_release_oauth_flow_drain_round_trip == /\ model_step_count <= 8 /\ Len(pending_inputs) <= 8 /\ Cardinality(observed_inputs) <= 10 /\ Len(pending_routes) <= 8 /\ Cardinality(delivered_routes) <= 0 /\ Cardinality(emitted_effects) <= 0 /\ Cardinality(observed_transitions) <= 8 /\ Cardinality(auth_machine_oauth_browser_flow_ids) <= 0 /\ Cardinality(DOMAIN auth_machine_oauth_browser_flow_providers) <= 0 /\ Cardinality(DOMAIN auth_machine_oauth_browser_flow_redirect_uris) <= 0 /\ Cardinality(DOMAIN auth_machine_oauth_browser_flow_expires_at_millis) <= 0 /\ Cardinality(auth_machine_oauth_device_flow_ids) <= 0 /\ Cardinality(DOMAIN auth_machine_oauth_device_flow_providers) <= 0 /\ Cardinality(DOMAIN auth_machine_oauth_device_flow_expires_at_millis) <= 0 /\ Cardinality(auth_machine_oauth_device_poll_ids) <= 0
...
WitnessFairness_auth_lease_lifecycle_publication_round_trip_2 ==
    ...
    /\ WF_vars(auth_machine_BeginReleaseDrainingOAuthFlowsRefreshing)
    /\ WF_vars(auth_machine_BeginReleaseDrainingOAuthFlowsReauthRequired)
    /\ WF_vars(auth_machine_BeginReleaseWithoutOAuthFlowsValid)
    /\ WF_vars(auth_machine_BeginReleaseWithoutOAuthFlowsExpiring)
    /\ WF_vars(auth_machine_BeginReleaseWithoutOAuthFlowsExpired)
    /\ WF_vars(auth_machine_BeginReleaseWithoutOAuthFlowsRefreshing)
    /\ WF_vars(auth_machine_BeginReleaseWithoutOAuthFlowsReauthRequired)
    /\ WF_vars(auth_machine_BeginReleaseReleased)
    /\ WF_vars(auth_machine_Release)
    /\ WF_vars(\E arg_lifecycle_phase \in OptionAuthLifecyclePhaseValues : \E arg_expires_at \in OptionU64Values : \E arg_last_refresh \in OptionU64Values : \E arg_refresh_attempt \in 0..2 : \E arg_credential_generation \in 0..2 : \E arg_credential_published_at_millis \in OptionU64Values : \E arg_restored_oauth_membership_observed \in BOOLEAN : auth_machine_RestoreCredentialLifecycleSnapshotValid(arg_lifecycle_phase, arg_expires_at, arg_last_refresh, arg_refresh_attempt, TRUE, arg_credential_generation, arg_credential_published_at_millis, arg_restored_oauth_membership_observed))
    /\ WF_vars(\E arg_lifecycle_phase \in OptionAuthLifecyclePhaseValues : \E arg_expires_at \in OptionU64Values : \E arg_last_refresh \in OptionU64Values : \E arg_refresh_attempt \in 0..2 : \E arg_credential_generation \in 0..2 : \E arg_credential_published_at_millis \in OptionU64Values : \E arg_restored_oauth_membership_observed \in BOOLEAN : auth_machine_RestoreCredentialLifecycleSnapshotExpiring(arg_lifecycle_phase, arg_expires_at, arg_last_refresh, arg_refresh_attempt, TRUE, arg_credential_generation, arg_credential_published_at_millis, arg_restored_oauth_membership_observed))
    /\ WF_vars(\E arg_lifecycle_phase \in OptionAuthLifecyclePhaseValues : \E arg_expires_at \in OptionU64Values : \E arg_last_refresh \in OptionU64Values : \E arg_refresh_attempt \in 0..2 : \E arg_credential_generation \in 0..2 : \E arg_credential_published_at_millis \in OptionU64Values : \E arg_restored_oauth_membership_observed \in BOOLEAN : auth_machine_RestoreCredentialLifecycleSnapshotRefreshing(arg_lifecycle_phase, arg_expires_at, arg_last_refresh, arg_refresh_attempt, TRUE, arg_credential_generation, arg_credential_published_at_millis, arg_restored_oauth_membership_observed))
    /\ WF_vars(\E arg_lifecycle_phase \in OptionAuthLifecyclePhaseValues : \E arg_expires_at \in OptionU64Values : \E arg_last_refresh \in OptionU64Values : \E arg_refresh_attempt \in 0..2 : \E arg_credential_generation \in 0..2 : \E arg_credential_published_at_millis \in OptionU64Values : \E arg_restored_oauth_membership_observed \in BOOLEAN : auth_machine_RestoreCredentialLifecycleSnapshotExpired(arg_lifecycle_phase, arg_expires_at, arg_last_refresh, arg_refresh_attempt, TRUE, arg_credential_generation, arg_credential_published_at_millis, arg_restored_oauth_membership_observed))
    /\ WF_vars(\E arg_lifecycle_phase \in OptionAuthLifecyclePhaseValues : \E arg_expires_at \in OptionU64Values : \E arg_last_refresh \in OptionU64Values : \E arg_refresh_attempt \in 0..2 : \E arg_credential_generation \in 0..2 : \E arg_credential_published_at_millis \in OptionU64Values : \E arg_restored_oauth_membership_observed \in BOOLEAN : auth_machine_RestoreCredentialLifecycleSnapshotReauthRequired(arg_lifecycle_phase, arg_expires_at, arg_last_refresh, arg_refresh_attempt, TRUE, arg_credential_generation, arg_credential_published_at_millis, arg_restored_oauth_membership_observed))
    ...
    /\ WF_vars(\E arg_lifecycle_phase \in OptionAuthLifecyclePhaseValues : \E arg_expires_at \in OptionU64Values : \E arg_last_refresh \in OptionU64Values : \E arg_refresh_attempt \in 0..2 : \E arg_credential_present \in BOOLEAN : \E arg_credential_generation \in 0..2 : \E arg_credential_published_at_millis \in OptionU64Values : auth_machine_RestoreCredentialLifecycleSnapshotNoCredentialWithoutOAuth(arg_lifecycle_phase, arg_expires_at, arg_last_refresh, arg_refresh_attempt, arg_credential_present, arg_credential_generation, arg_credential_published_at_millis, FALSE))
...
WitnessFairness_auth_lease_lifecycle_publication_round_trip_4 ==
    ...
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthBrowserFlowAbsentValid(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthBrowserFlowAbsentExpiring(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthBrowserFlowAbsentExpired(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthBrowserFlowAbsentRefreshing(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthBrowserFlowAbsentReauthRequired(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthBrowserFlowReleased(arg_flow_id))
...
WitnessFairness_auth_lease_lifecycle_publication_round_trip_5 ==
    ...
    /\ WF_vars(\E arg_observed_global_outstanding_flows \in 0..2 : \E arg_max_outstanding_flows \in 0..2 : auth_machine_ConfirmOAuthDurableAdmissionReleased(arg_observed_global_outstanding_flows, arg_max_outstanding_flows))
...
WitnessFairness_auth_lease_lifecycle_publication_round_trip_6 ==
    ...
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_FinishOAuthDevicePollReleased(arg_flow_id))
    ...
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthDeviceFlowAbsentValid(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthDeviceFlowAbsentExpiring(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthDeviceFlowAbsentExpired(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthDeviceFlowAbsentRefreshing(arg_flow_id))
    /\ WF_vars(\E arg_flow_id \in StringValues : auth_machine_ExpireOAuthDeviceFlowAbsentReauthRequired(arg_flow_id))
...
WitnessFairness_auth_lease_lifecycle_publication_round_trip_7 ==
    ...
    /\ WF_vars(\E arg_refresh_allowed \in BOOLEAN : auth_machine_ResolveOAuthLoginCredentialDispositionUseCachedValid(TRUE, FALSE, arg_refresh_allowed))
    /\ WF_vars(\E arg_credential_present \in BOOLEAN : \E arg_force_refresh \in BOOLEAN : auth_machine_ResolveOAuthLoginCredentialDispositionRefreshValidValid(arg_credential_present, arg_force_refresh, TRUE))
    /\ WF_vars(\E arg_credential_present \in BOOLEAN : \E arg_force_refresh \in BOOLEAN : auth_machine_ResolveOAuthLoginCredentialDispositionRefreshDisallowedValidValid(arg_credential_present, arg_force_refresh, FALSE))
    /\ WF_vars(\E arg_credential_present \in BOOLEAN : \E arg_force_refresh \in BOOLEAN : auth_machine_ResolveOAuthLoginCredentialDispositionRefreshNonValidExpiring(arg_credential_present, arg_force_refresh, TRUE))
    /\ WF_vars(\E arg_credential_present \in BOOLEAN : \E arg_force_refresh \in BOOLEAN : auth_machine_ResolveOAuthLoginCredentialDispositionRefreshNonValidExpired(arg_credential_present, arg_force_refresh, TRUE))
...
WitnessFairness_auth_release_oauth_flow_drain_round_trip_1 ==
    /\ WF_vars(\E arg_expires_at_ts \in OptionU64Values : \E arg_credential_published_at_millis \in 0..2 : auth_machine_Acquire(arg_expires_at_ts, arg_credential_published_at_millis))
    /\ WF_vars(auth_machine_MarkExpiring)
    /\ WF_vars(\E arg_now_ts \in 0..2 : \E arg_refresh_window_secs \in 0..2 : auth_machine_ObserveCredentialFreshnessValid(arg_now_ts, arg_refresh_window_secs))
    /\ WF_vars(\E arg_now_ts \in 0..2 : \E arg_refresh_window_secs \in 0..2 : auth_machine_ObserveCredentialFreshnessExpiringFromValid(arg_now_ts, arg_refresh_window_secs))
...
WitnessSpec_auth_release_oauth_flow_drain_round_trip ==
    /\ WitnessInit_auth_release_oauth_flow_drain_round_trip
    /\ [] [WitnessNext_auth_release_oauth_flow_drain_round_trip]_vars
    /\ WitnessFairness_auth_release_oauth_flow_drain_round_trip_1
    /\ WitnessFairness_auth_release_oauth_flow_drain_round_trip_2
    /\ WitnessFairness_auth_release_oauth_flow_drain_round_trip_3
    /\ WitnessFairness_auth_release_oauth_flow_drain_round_trip_4
...
THEOREM Spec => []NoFeedbackWithoutObligation_auth_machine_auth_release_oauth_flow_drain
