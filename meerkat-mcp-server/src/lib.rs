...
pub struct MeerkatMcpState {
    ...
    /// Tracked comms drain handles for host_mode sessions.
    #[cfg(feature = "comms")]
    comms_drain_handles: Arc<Mutex<HashMap<meerkat::SessionId, tokio::task::JoinHandle<()>>>>,
    #[cfg(feature = "comms")]
...
impl MeerkatMcpState {
    ...
    async fn new_with_bootstrap_options_and_llm(
        ...
        Ok(Self {
            ...
            runtime_adapter,
            #[cfg(feature = "comms")]
            comms_drain_handles: Arc::new(Mutex::new(HashMap::new())),
            #[cfg(feature = "comms")]
