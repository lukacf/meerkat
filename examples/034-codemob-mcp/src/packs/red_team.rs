...
impl Pack for RedTeamPack {
    ...
    fn definition(
        ...
        profiles.insert(
            ProfileName::from("advocate"),
            turn_driven_profile(
                resolve_model(overrides, "advocate", "gemini-3.1-flash-lite-preview"),
                "advocate-skill",
        ...
        skills.insert(
            "advocate-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/advocate.md").into(),
            },
        );
        skills.insert(
            "adversary-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/adversary.md").into(),
            },
        );
        skills.insert(
            "judge-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/judge.md").into(),
            },
        );
        ...
        mob_definition(
            ...
            skills,
            flows,
            identity_spawn_policy(&["advocate", "adversary", "judge"]),
        )
    }
}
