...
class MobEventsResult:
    ...
    events: list[WireMobEvent]


@dataclass
class WireMobAgentRuntimeId:
...
@dataclass
class WireMobMemberSpawnedEvent:
...
class WireMobRun:
    ...
    failure_ledger: Optional[list[WireMobFailureLedgerEntry]] = None
    flow_authority_inputs: Optional[list[Any]] = None
    frames: Optional[dict[str, Any]] = None
    loop_iteration_ledger: Optional[list[WireMobLoopIterationLedgerEntry]] = None
    loop_iteration_outputs: Optional[dict[str, list[dict[str, Any]]]] = None
    loops: Optional[dict[str, Any]] = None
    root_step_outputs: Optional[dict[str, Any]] = None
    schema_version: Optional[int] = None
    step_ledger: Optional[list[WireMobStepLedgerEntry]] = None


@dataclass
class WireMobStepLedgerEntry:
...
@dataclass
class WireMobFailureLedgerEntry:
...
@dataclass
class WireMobLoopIterationLedgerEntry:
...
class ScheduleUpdateRequest:
    """Request payload for REST schedule update."""
    description: Optional[str] = None
...
# Request payload for schedule/call.
class ScheduleToolCallParamsMeerkatScheduleCreate(TypedDict, total=False):
    arguments: Required[dict[str, Any]]
    name: Required[Literal['meerkat_schedule_create']]

class ScheduleToolCallParamsMeerkatScheduleGet(TypedDict, total=False):
    arguments: Required[dict[str, str]]
    name: Required[Literal['meerkat_schedule_get']]

class ScheduleToolCallParamsMeerkatScheduleList(TypedDict, total=False):
    arguments: NotRequired[dict[str, Any]]
    name: Required[Literal['meerkat_schedule_list']]

class ScheduleToolCallParamsMeerkatScheduleUpdate(TypedDict, total=False):
    arguments: Required[dict[str, Any]]
    name: Required[Literal['meerkat_schedule_update']]

class ScheduleToolCallParamsMeerkatSchedulePause(TypedDict, total=False):
    arguments: Required[dict[str, str]]
    name: Required[Literal['meerkat_schedule_pause']]

class ScheduleToolCallParamsMeerkatScheduleResume(TypedDict, total=False):
    arguments: Required[dict[str, str]]
    name: Required[Literal['meerkat_schedule_resume']]

class ScheduleToolCallParamsMeerkatScheduleDelete(TypedDict, total=False):
    arguments: Required[dict[str, str]]
    name: Required[Literal['meerkat_schedule_delete']]

class ScheduleToolCallParamsMeerkatScheduleOccurrences(TypedDict, total=False):
    arguments: Required[dict[str, str]]
    name: Required[Literal['meerkat_schedule_occurrences']]

ScheduleToolCallParams = ScheduleToolCallParamsMeerkatScheduleCreate | ScheduleToolCallParamsMeerkatScheduleGet | ScheduleToolCallParamsMeerkatScheduleList | ScheduleToolCallParamsMeerkatScheduleUpdate | ScheduleToolCallParamsMeerkatSchedulePause | ScheduleToolCallParamsMeerkatScheduleResume | ScheduleToolCallParamsMeerkatScheduleDelete | ScheduleToolCallParamsMeerkatScheduleOccurrences
...
WIRE_LIVE_ADAPTER_OBSERVATION_TAGS: tuple[str, ...] = (
    'ready',
...
class Occurrence:
    ...
    phase: Literal['pending', 'claimed', 'dispatching', 'awaiting_completion', 'completed', 'skipped', 'misfired', 'superseded', 'delivery_failed']
    schedule_id: str
    schedule_revision: int
    target_snapshot: dict[str, Any]
    trigger_snapshot: dict[str, Any]
    attempt_count: Optional[int] = None
    claimed_at_utc: Optional[str] = None
    claimed_by: Optional[str] = None
    completed_at_utc: Optional[str] = None
    delivery_correlation_id: Optional[str] = None
    dispatched_at_utc: Optional[str] = None
    failure_class: Optional[Literal['target_materialization_failed', 'target_missing', 'target_busy', 'runtime_rejected', 'mob_rejected', 'lease_lost', 'transport_error', 'internal_error']] = None
    failure_detail: Optional[str] = None
    last_receipt: Optional[dict[str, Any]] = None
    lease_expires_at_utc: Optional[str] = None
    runtime_outcome: Optional[dict[str, Any]] = None
    superseded_by_revision: Optional[int] = None


@dataclass
class ScheduleToolDescriptor:
    """Generated schedule tool descriptor."""
    description: str
    inputSchema: Any
    name: Literal['meerkat_schedule_create', 'meerkat_schedule_get', 'meerkat_schedule_list', 'meerkat_schedule_update', 'meerkat_schedule_pause', 'meerkat_schedule_resume', 'meerkat_schedule_delete', 'meerkat_schedule_occurrences']


@dataclass
class ScheduleToolsResult:
    """Response payload for schedule/tools."""
    tools: list[ScheduleToolDescriptor]
...
# Response payload for schedule/call.
ScheduleToolCallResult = Schedule | ScheduleListResult | ScheduleOccurrencesResult
...
MobEnsureMemberOutcomeWire = dict[str, MobSpawnReceiptWire] | dict[str, MobMemberListEntryWire]
...
class WireMobEventKindMobCreated(TypedDict, total=False):
    definition: Required[Any]
    type: Required[Literal['mob_created']]

class WireMobEventKindMobCompleted(TypedDict, total=False):
    type: Required[Literal['mob_completed']]

class WireMobEventKindMobDestroying(TypedDict, total=False):
    type: Required[Literal['mob_destroying']]

class WireMobEventKindMobDestroyStorageFinalizing(TypedDict, total=False):
    type: Required[Literal['mob_destroy_storage_finalizing']]

class WireMobEventKindMobReset(TypedDict, total=False):
    type: Required[Literal['mob_reset']]

class WireMobEventKindMemberSpawned(TypedDict, total=False):
    agent_identity: Required[str]
    agent_runtime_id: Required[WireMobAgentRuntimeId]
    fence_token: Required[int]
    generation: Required[int]
    labels: NotRequired[dict[str, str]]
    role: Required[str]
    runtime_mode: NotRequired[WireMobRuntimeMode]
    type: Required[Literal['member_spawned']]

class WireMobEventKindMemberRetired(TypedDict, total=False):
    agent_identity: Required[str]
    generation: Required[int]
    role: Required[str]
    type: Required[Literal['member_retired']]

class WireMobEventKindMemberReset(TypedDict, total=False):
    agent_identity: Required[str]
    agent_runtime_id: Required[WireMobAgentRuntimeId]
    fence_token: Required[int]
    new_generation: Required[int]
    previous_generation: Required[int]
    type: Required[Literal['member_reset']]

class WireMobEventKindMemberKickoffUpdated(TypedDict, total=False):
    kickoff: Required[Any]
    member: Required[str]
    type: Required[Literal['member_kickoff_updated']]

class WireMobEventKindMembersWired(TypedDict, total=False):
    a: Required[str]
    b: Required[str]
    type: Required[Literal['members_wired']]

class WireMobEventKindMembersUnwired(TypedDict, total=False):
    a: Required[str]
    b: Required[str]
    type: Required[Literal['members_unwired']]

class WireMobEventKindExternalPeerWired(TypedDict, total=False):
    local: Required[str]
    spec: Required[Any]
    type: Required[Literal['external_peer_wired']]

class WireMobEventKindExternalPeerUnwired(TypedDict, total=False):
    local: Required[str]
    peer_name: Required[str]
    type: Required[Literal['external_peer_unwired']]

class WireMobEventKindTaskCreated(TypedDict, total=False):
    blocked_by: Required[list[str]]
    description: Required[str]
    subject: Required[str]
    task_id: Required[str]
    type: Required[Literal['task_created']]

class WireMobEventKindTaskUpdated(TypedDict, total=False):
    owner: NotRequired[str]
    status: Required[WireMobTaskStatus]
    task_id: Required[str]
    type: Required[Literal['task_updated']]

class WireMobEventKindFlowStarted(TypedDict, total=False):
    flow_id: Required[str]
    params: Required[Any]
    run_id: Required[str]
    type: Required[Literal['flow_started']]

class WireMobEventKindFlowCompleted(TypedDict, total=False):
    flow_id: Required[str]
    run_id: Required[str]
    structured_output: NotRequired[Any]
    type: Required[Literal['flow_completed']]

class WireMobEventKindFlowFailed(TypedDict, total=False):
    flow_id: Required[str]
    reason: Required[str]
    run_id: Required[str]
    type: Required[Literal['flow_failed']]

class WireMobEventKindFlowCanceled(TypedDict, total=False):
    flow_id: Required[str]
    run_id: Required[str]
    type: Required[Literal['flow_canceled']]

class WireMobEventKindStepDispatched(TypedDict, total=False):
    run_id: Required[str]
    step_id: Required[str]
    target: Required[WireMobAgentRuntimeId]
    type: Required[Literal['step_dispatched']]

class WireMobEventKindStepTargetCompleted(TypedDict, total=False):
    run_id: Required[str]
    step_id: Required[str]
    target: Required[WireMobAgentRuntimeId]
    type: Required[Literal['step_target_completed']]

class WireMobEventKindStepTargetFailed(TypedDict, total=False):
    error: NotRequired[dict[str, Any]]
    error_report: NotRequired[dict[str, Any]]
    reason: Required[str]
    run_id: Required[str]
    step_id: Required[str]
    target: Required[WireMobAgentRuntimeId]
    type: Required[Literal['step_target_failed']]

class WireMobEventKindStepCompleted(TypedDict, total=False):
    run_id: Required[str]
    step_id: Required[str]
    type: Required[Literal['step_completed']]

class WireMobEventKindStepFailed(TypedDict, total=False):
    reason: Required[str]
    run_id: Required[str]
    step_id: Required[str]
    type: Required[Literal['step_failed']]

class WireMobEventKindStepSkipped(TypedDict, total=False):
    reason: Required[str]
    run_id: Required[str]
    step_id: Required[str]
    type: Required[Literal['step_skipped']]

class WireMobEventKindTopologyViolation(TypedDict, total=False):
    from_role: Required[str]
    to_role: Required[str]
    type: Required[Literal['topology_violation']]

class WireMobEventKindSupervisorEscalation(TypedDict, total=False):
    escalated_to: Required[str]
    run_id: Required[str]
    step_id: Required[str]
    type: Required[Literal['supervisor_escalation']]

class WireMobEventKindOperatorActionRecorded(TypedDict, total=False):
    audit_invocation_id: NotRequired[str]
    caller_provenance: NotRequired[Any]
    principal_token: Required[Any]
    tool_name: Required[str]
    type: Required[Literal['operator_action_recorded']]

WireMobEventKind = WireMobEventKindMobCreated | WireMobEventKindMobCompleted | WireMobEventKindMobDestroying | WireMobEventKindMobDestroyStorageFinalizing | WireMobEventKindMobReset | WireMobEventKindMemberSpawned | WireMobEventKindMemberRetired | WireMobEventKindMemberReset | WireMobEventKindMemberKickoffUpdated | WireMobEventKindMembersWired | WireMobEventKindMembersUnwired | WireMobEventKindExternalPeerWired | WireMobEventKindExternalPeerUnwired | WireMobEventKindTaskCreated | WireMobEventKindTaskUpdated | WireMobEventKindFlowStarted | WireMobEventKindFlowCompleted | WireMobEventKindFlowFailed | WireMobEventKindFlowCanceled | WireMobEventKindStepDispatched | WireMobEventKindStepTargetCompleted | WireMobEventKindStepTargetFailed | WireMobEventKindStepCompleted | WireMobEventKindStepFailed | WireMobEventKindStepSkipped | WireMobEventKindTopologyViolation | WireMobEventKindSupervisorEscalation | WireMobEventKindOperatorActionRecorded

# Flow run lifecycle states.
WireMobRunStatus = Literal['pending', 'running', 'completed', 'failed', 'canceled']

# Step execution states.
WireMobStepRunStatus = Literal['dispatched', 'completed', 'failed', 'skipped', 'canceled']

# Task lifecycle states emitted by the mob event log.
WireMobTaskStatus = Literal['open', 'in_progress', 'completed', 'cancelled']
...
class WireTranscriptReplacementMessage(TypedDict, total=False):
    message: Required[WireSessionMessage]
