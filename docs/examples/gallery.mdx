...
All 32 examples (including single-feature demos and hello-world starters) are in `examples/` in the [repository](https://github.com/lukacf/meerkat/tree/main/examples).
