...
[`mobkit/console/inspect_identity`](/mobkit/api/rpc#mobkit%2Fconsole%2Finspect_identity)
...
[timeline SSE contract](/mobkit/api/sse#console-timeline-stream) for event envelopes
...
auth policy. See [authentication](/mobkit/guides/authentication) for details.
...
[RPC reference](/mobkit/api/rpc#mobkit-specific-error-codes).
