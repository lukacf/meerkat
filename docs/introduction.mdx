...
[MobKit](/mobkit/introduction) is Meerkat's companion application and orchestration layer. Use it when you need to turn the runtime into an operated multi-agent product with durable identities, routing, scheduling, approval gates, memory, a visual flow editor, and an embedded console.

<Card title="Explore MobKit" icon="boxes-stacked" href="/mobkit/introduction">
  Bootstrap and operate coordinated groups of Meerkat agents.
</Card>
