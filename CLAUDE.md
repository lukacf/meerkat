...
- `int-heavy` ×3 / `int-rest` ×3 — integration tests split by build scope (`-p meerkat-integration-tests` vs `--workspace --exclude` it), so shards don't all link every integration binary
