...
mob_SpawnRunning(arg_agent_identity, arg_agent_runtime_id, arg_fence_token, arg_generation, arg_external_addressable) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ mob_active_run_count' = 0
       /\ mob_pending_spawn_count' = 0
       /\ UNCHANGED << meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
...
mob_DestroyMob ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, mob_externally_addressable_runtime_ids, witness_current_script_input, witness_remaining_script_inputs >>
