...
function writeRootBuild(fastTestLabels, e2eSystemTestLabels, surfaceFeatureMatrixLabels) {
  const lines = [
    ...
    `    16, 21, 22, 27, 28, 30, 44, 47, 48, 49, 50, 51, 52,`,
    `    53, 54, 55, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81,`,
    ...
    `    ("conditional_skip_inside_body_loop", "e2e_flow_runtime_conditional_skip_inside_body_loop_smoke"),`,
    `    ("three_way_branch_loop_audit", "e2e_flow_runtime_three_way_branch_loop_audit_smoke"),`,
    ...
    `    ("persisted_three_sibling_loops_join", "e2e_flow_runtime_persisted_three_sibling_loops_join_smoke"),`,
