...
fn state_from_inner(inner: InnerState) -> State {
    State {
        ...
        trigger_key: inner.trigger_key,
        target_binding_key: inner.target_binding_key,
        misfire_policy: inner.misfire_policy,
        overlap_policy: inner.overlap_policy,
        missing_target_policy: inner.missing_target_policy,
...
fn state_to_inner(state: &State) -> InnerState {
    InnerState {
        ...
        misfire_policy: state.misfire_policy,
        overlap_policy: state.overlap_policy,
        missing_target_policy: state.missing_target_policy,
