...
//!   schema DDL; stores apply their [`ledger`] domain after opening.
...
//!   typed [`SqliteStoreError::SchemaFromTheFuture`] refusal.
...
pub use ledger::{LedgerReport, Migration, SchemaDomain, apply_domain_migrations, domain_version};
pub use profile::{
    ConnectionProfile, OpenOptions, SHARED_BUSY_TIMEOUT, begin_immediate, open, open_with,
};
