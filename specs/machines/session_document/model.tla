...
ClassifyLiveObservationRewrite(observations_present, full_context_replacement) ==
    /\ phase = "Ready"
    /\ phase' = "Ready"
    /\ model_step_count' = model_step_count + 1
    /\ UnchangedFrame_afcdf325669eb17c
...
ObserveLiveAssistantPlaybackSnapshot(session_id, channel_id, interaction_id, response_id, item_id, content_index, snapshot_chars, snapshot_digest, canonical_chars, canonical_digest, prefix_matches_snapshot, observation_only, canonical_message_cursor) ==
    /\ phase = "Ready"
...
Next ==
    ...
    \/ \E observations_present \in BOOLEAN : \E full_context_replacement \in BOOLEAN : ClassifyLiveObservationRewrite(observations_present, full_context_replacement)
    ...
    \/ \E session_id \in SessionIdValues : \E channel_id \in StringValues : \E interaction_id \in StringValues : \E response_id \in StringValues : \E item_id \in StringValues : \E content_index \in 0..2 : \E snapshot_chars \in 0..2 : \E snapshot_digest \in StringValues : \E canonical_chars \in 0..2 : \E canonical_digest \in StringValues : \E prefix_matches_snapshot \in BOOLEAN : \E observation_only \in BOOLEAN : \E canonical_message_cursor \in 0..2 : ObserveLiveAssistantPlaybackSnapshot(session_id, channel_id, interaction_id, response_id, item_id, content_index, snapshot_chars, snapshot_digest, canonical_chars, canonical_digest, prefix_matches_snapshot, observation_only, canonical_message_cursor)
