...
| `runtime/realtime_attachment_status` | Runtime | Read runtime-backed realtime attachment status for a session |
| `runtime/realtime_attachment_statuses` | Runtime | Batch read realtime attachment statuses for many sessions |
...
```json Response
{
  ...
  "result": {
    ...
    "methods": [
      ...
      "runtime/state", "runtime/realtime_attachment_status", "runtime/realtime_attachment_statuses", "runtime/accept", "runtime/retire", "runtime/reset",
