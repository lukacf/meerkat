...
second surface-local execution loop. Callback tool results are staged through
the canonical session/runtime seam before resume admission; MCP does not patch
