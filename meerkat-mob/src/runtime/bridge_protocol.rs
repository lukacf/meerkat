...
pub use meerkat_contracts::wire::supervisor_bridge::{
    ...
    BridgePeerWiringPayload, BridgeProtocolVersion, BridgeRejectionCause, BridgeRejectionClass,
    BridgeRejectionReply, BridgeReply, BridgeRetireResponse, BridgeSupervisorPayload,
