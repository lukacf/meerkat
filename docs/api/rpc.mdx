...
| `mob/member_live_observations` | Mob | `MobMemberLiveObservationsParams` | `MobMemberLiveObservationsResult` | Read retained Live observation records without an active channel; ReadHistory scope (mob feature) |
...
```json Response
{
  ...
  "id": 8,
  "result": {
    "contract_version": {"major": 0, "minor": 8, "patch": 37},
    "capabilities": [
      {
        "id": "sessions",
