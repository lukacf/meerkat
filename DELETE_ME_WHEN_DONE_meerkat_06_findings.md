...
- 📌 Remaining: A4, A5 (DSL-schema migration), A10 (rest), B6, C5 — all tracked, all require regression coverage per the "extensive regression tests" standard. Priority order:
    ...
    - P1 (API hygiene / migration correctness): A10 (MobSpawnParams drops 5 remaining spec fields).
