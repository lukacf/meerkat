...
- 📌 Remaining: A2, A3, A4, A5, A8, A10 (rest), B3, B4, B6, B8, C1, C4, C5, C7 — all tracked, all require regression coverage per the "extensive regression tests" standard. Priority order:
    ...
    - P2 (surface completeness): A8, B4, B8, C4, C5, C7.
