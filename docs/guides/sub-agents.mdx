...
<Accordion title="Source file index">
| File | Description |
|------|-------------|
...
| `meerkat-tools/src/builtin/sub_agent/runner.rs` | spawn_sub_agent(), session creation |
| `meerkat-tools/src/builtin/sub_agent/state.rs` | SubAgentToolState (shared state) |
