...
meerkat = "0.6.0"
  ...
  <Tab title="CLI">
    ...
    cargo install rkat
    ```
    <Note>For source-built reduced CLI profiles such as `rkat-mini`, see [Mini surfaces](/guides/mini-surfaces).</Note>
  </Tab>
</Tabs>
...
- [Mini surfaces](/guides/mini-surfaces) -- shipped RPC mini and source-build guidance
