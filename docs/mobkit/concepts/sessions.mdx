...
- [Configuration](/mobkit/reference/configuration) -- session store settings, storage layout, durability classes
- [RPC API](/mobkit/api/rpc) -- `session_store.*` methods, `mobkit/storage/doctor`
