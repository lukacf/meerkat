...
// Derived mechanically from `MeerkatMachine` `ClassifyTurnTerminalCauseClass` / `ResolveTurnSurfaceResult` transitions.
...
fn classify_cause(cause_kind: Option<TurnTerminalCauseKind>) -> TerminalCauseClass {
    match cause_kind {
        ...
        Some(TurnTerminalCauseKind::HookDenied) => TerminalCauseClass::OtherFailure,
        Some(TurnTerminalCauseKind::HookFailure) => TerminalCauseClass::OtherFailure,
        Some(TurnTerminalCauseKind::LlmFailure) => TerminalCauseClass::OtherFailure,
        Some(TurnTerminalCauseKind::ToolFailure) => TerminalCauseClass::OtherFailure,
        ...
        Some(TurnTerminalCauseKind::TurnLimitReached) => TerminalCauseClass::OtherFailure,
        Some(TurnTerminalCauseKind::RuntimeApplyFailure) => TerminalCauseClass::OtherFailure,
        Some(TurnTerminalCauseKind::FatalFailure) => TerminalCauseClass::OtherFailure,
    }
}
