...
// Durable marker source fields: phase->new_state, expires_at->expires_at, generation->credential_generation, credential_published_at_millis->credential_published_at_millis
