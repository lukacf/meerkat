...
impl Pack for BrainstormPack {
    ...
    fn definition(
        ...
        skills.insert(
            "ideator-a-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/ideator_a.md").into(),
            },
        );
        skills.insert(
            "ideator-b-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/ideator_b.md").into(),
            },
        );
        skills.insert(
            "ideator-c-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/ideator_c.md").into(),
            },
        );
        skills.insert(
            "synthesizer-skill".into(),
            SkillSource::Inline {
                content: include_str!("../../skills/synthesizer.md").into(),
            },
        );
        ...
        steps.insert(
            StepId::from("ideate_a"),
            flow_step("ideator_a", ideate_msg.clone(), &[], 300_000),
        );
        steps.insert(
            StepId::from("ideate_b"),
            flow_step("ideator_b", ideate_msg.clone(), &[], 300_000),
        );
        steps.insert(
            StepId::from("ideate_c"),
            flow_step("ideator_c", ideate_msg, &[], 300_000),
        );
