...
| FREEZE-002 | Every external assumption is explicitly `HYPOTHESIS` and has a real Phase 0 live test path. | Review [02-external-contract-matrix.md](./02-external-contract-matrix.md). |
