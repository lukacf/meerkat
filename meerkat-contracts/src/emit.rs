...
pub fn emit_all_schemas(output_dir: &std::path::Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let wire_types = serde_json::json!({
        ...
        "MobMemberLiveObservationsResult": schema_for!(crate::wire::MobMemberLiveObservationsResult),
    ...
    let params = serde_json::json!({
        ...
        "MobMemberLiveObservationsParams": schema_for!(crate::wire::MobMemberLiveObservationsParams),
