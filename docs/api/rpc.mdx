...
<ParamField body="turn_metadata" type="RuntimeTurnMetadata | null" default="null">
  Canonical per-turn metadata carrier. Put turn-scoped model/provider/provider_params, skill_references, flow_tool_overlay, additional_instructions, keep_alive, and render metadata inside this object; split top-level turn fields are rejected.
</ParamField>
