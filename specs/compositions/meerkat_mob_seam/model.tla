...
meerkat_ReconfigureSessionLlmIdentityAttached(arg_model, arg_provider, arg_provider_params) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "ReconfigureSessionLlmIdentity"
       /\ packet.payload.model = arg_model
       /\ packet.payload.provider = arg_provider
       /\ packet.payload.provider_params = arg_provider_params
       /\ ~HigherPriorityReady("meerkat_kernel")
...
meerkat_ReconfigureSessionLlmIdentityRunning(arg_model, arg_provider, arg_provider_params) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "ReconfigureSessionLlmIdentity"
       /\ packet.payload.model = arg_model
...
meerkat_SetPeerIngressContextIdle(arg_keep_alive) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_active_work_id, meerkat_wake_pending, meerkat_process_pending, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_requested_witnesses, meerkat_filter_witnesses, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, meerkat_committed_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_Destroy ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_process_pending' = FALSE
       /\ meerkat_drain_running' = FALSE
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_peer_ingress_configured, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_requested_witnesses, meerkat_filter_witnesses, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, meerkat_committed_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
...
meerkat_RecycleFromIdleOrRetired ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_peer_ingress_configured' = FALSE
       /\ meerkat_drain_running' = FALSE
       /\ UNCHANGED << meerkat_session_id, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_requested_witnesses, meerkat_filter_witnesses, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, meerkat_committed_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
CoreNext ==
    ...
    \/ \E arg_model \in OptionStringValues : \E arg_provider \in OptionStringValues : \E arg_provider_params \in OptionJsonValueValues : meerkat_ReconfigureSessionLlmIdentityAttached(arg_model, arg_provider, arg_provider_params)
    \/ \E arg_model \in OptionStringValues : \E arg_provider \in OptionStringValues : \E arg_provider_params \in OptionJsonValueValues : meerkat_ReconfigureSessionLlmIdentityRunning(arg_model, arg_provider, arg_provider_params)
