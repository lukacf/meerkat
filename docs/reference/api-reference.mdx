...
| `meerkat_core::AgentBuilder` | `meerkat_core` | Low-level primitive builder, available for explicit standalone construction only through the standalone core feature |
