...
pub fn emit_all_schemas(output_dir: &std::path::Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let wire_types = serde_json::json!({
        ...
        "JobSummary": schema_for!(crate::wire::JobSummary),
        "JobReceipt": schema_for!(crate::wire::JobReceipt),
        "JobsGetParams": schema_for!(crate::wire::JobsGetParams),
        "JobsGetResult": schema_for!(crate::wire::JobsGetResult),
        "JobsListParams": schema_for!(crate::wire::JobsListParams),
        "JobsListResult": schema_for!(crate::wire::JobsListResult),
        "JobsCancelParams": schema_for!(crate::wire::JobsCancelParams),
        "JobsCancelResult": schema_for!(crate::wire::JobsCancelResult),
        "JobsProgressParams": schema_for!(crate::wire::JobsProgressParams),
        "JobsProgressResult": schema_for!(crate::wire::JobsProgressResult),
        "JobsResultParams": schema_for!(crate::wire::JobsResultParams),
        "JobsResultResult": schema_for!(crate::wire::JobsResultResult),
        "JobsArtifactsParams": schema_for!(crate::wire::JobsArtifactsParams),
        "JobsArtifactsResult": schema_for!(crate::wire::JobsArtifactsResult),
        "JobsRetryParams": schema_for!(crate::wire::JobsRetryParams),
        "JobsRetryResult": schema_for!(crate::wire::JobsRetryResult),
        "JobsHealthParams": schema_for!(crate::wire::JobsHealthParams),
        "JobsHealthResult": schema_for!(crate::wire::JobsHealthResult),
        "MonitorsStartParams": schema_for!(crate::wire::MonitorsStartParams),
        "MonitorsStartResult": schema_for!(crate::wire::MonitorsStartResult),
        "JobsSubscribeParams": schema_for!(crate::wire::JobsSubscribeParams),
        "JobsSubscribeResult": schema_for!(crate::wire::JobsSubscribeResult),
        "JobsUnsubscribeParams": schema_for!(crate::wire::JobsUnsubscribeParams),
        "JobsUnsubscribeResult": schema_for!(crate::wire::JobsUnsubscribeResult),
        "CallbackJobStartParams": schema_for!(crate::wire::CallbackJobStartParams),
        "CallbackJobStartResult": schema_for!(crate::wire::CallbackJobStartResult),
        "CallbackJobReconcileParams": schema_for!(crate::wire::CallbackJobReconcileParams),
        "CallbackJobReconcileResult": schema_for!(crate::wire::CallbackJobReconcileResult),
        "CallbackJobCancelParams": schema_for!(crate::wire::CallbackJobCancelParams),
        "CallbackJobCancelResult": schema_for!(crate::wire::CallbackJobCancelResult),
        "MobkitJobHeartbeatParams": schema_for!(crate::wire::MobkitJobHeartbeatParams),
        "MobkitJobProgressParams": schema_for!(crate::wire::MobkitJobProgressParams),
        "MobkitJobCheckpointParams": schema_for!(crate::wire::MobkitJobCheckpointParams),
        "MobkitJobCompleteParams": schema_for!(crate::wire::MobkitJobCompleteParams),
        ...
        "WireMemberToolDeclaration": schema_for!(crate::wire::WireMemberToolDeclaration),
        "WireIdentityConvergenceMode": schema_for!(crate::wire::WireIdentityConvergenceMode),
        "WireIdentityConvergenceStatus": schema_for!(crate::wire::WireIdentityConvergenceStatus),
        "MobMemberToolDeclarationParams": schema_for!(crate::wire::MobMemberToolDeclarationParams),
        "MobMemberToolDeclarationResult": schema_for!(crate::wire::MobMemberToolDeclarationResult),
        "MobApplyMemberToolDeclarationParams": schema_for!(crate::wire::MobApplyMemberToolDeclarationParams),
        "MobApplyMemberToolDeclarationResult": schema_for!(crate::wire::MobApplyMemberToolDeclarationResult),
        "MobAdoptMemberIdentityDeclarationParams": schema_for!(crate::wire::MobAdoptMemberIdentityDeclarationParams),
        "MobAdoptMemberIdentityDeclarationResult": schema_for!(crate::wire::MobAdoptMemberIdentityDeclarationResult),
        "MobResolveIdentityConvergenceBlockParams": schema_for!(crate::wire::MobResolveIdentityConvergenceBlockParams),
        "MobResolveIdentityConvergenceBlockResult": schema_for!(crate::wire::MobResolveIdentityConvergenceBlockResult),
        ...
        "WireWorkExecutionLifecyclePhase": schema_for!(crate::wire::WireWorkExecutionLifecyclePhase),
        "WireWorkGraphFlowExecutionBinding": schema_for!(crate::wire::WireWorkGraphFlowExecutionBinding),
        "WireWorkGraphFlowWorkRef": schema_for!(crate::wire::WireWorkGraphFlowWorkRef),
        ...
        "MobBoundedHelperResult": schema_for!(crate::wire::MobBoundedHelperResult),
        "MobBoundedHelperResultStatus": schema_for!(crate::wire::MobBoundedHelperResultStatus),
        ...
        "WireMemberRunState": schema_for!(crate::wire::WireMemberRunState),
        ...
        "MobConcludeObjectiveResult": schema_for!(crate::wire::MobConcludeObjectiveResult),
        ...
        "BridgeDirectMemberFence": schema_for!(crate::wire::BridgeDirectMemberFence),
        "BridgeDirectMemberFenceEvidence": schema_for!(crate::wire::BridgeDirectMemberFenceEvidence),
        "BridgeDirectMemberIncarnation": schema_for!(crate::wire::BridgeDirectMemberIncarnation),
        "BridgeDirectRuntimeSessionToken": schema_for!(crate::wire::BridgeDirectRuntimeSessionToken),
        ...
        "BridgeRetireOutcome": schema_for!(crate::wire::BridgeRetireOutcome),
        "BridgeRetirePayload": schema_for!(crate::wire::BridgeRetirePayload),
    ...
    let rest_contract_types = serde_json::json!({
        ...
        "SystemPromptUpdateRequest": schema_for!(meerkat_core::SystemPromptUpdateRequest),
        "SystemPromptUpdateResult": schema_for!(meerkat_core::SystemPromptUpdateResult),
        ...
        "RestAdoptMemberIdentityDeclarationRequest": schema_for!(crate::wire::RestAdoptMemberIdentityDeclarationRequest),
        "RestApplyMemberToolDeclarationRequest": schema_for!(crate::wire::RestApplyMemberToolDeclarationRequest),
        "RestResolveIdentityConvergenceBlockRequest": schema_for!(crate::wire::RestResolveIdentityConvergenceBlockRequest),
