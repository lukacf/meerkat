...
- REST: `GET /workgraph/items`, `/workgraph/ready`, `/workgraph/snapshot`,
  `/workgraph/events`, plus narrow `POST /workgraph/goal/*` and
  `/workgraph/attention/*` host-control routes
- RPC: `workgraph/get`, `workgraph/list`, `workgraph/ready`,
  `workgraph/snapshot`, `workgraph/events`, plus narrow
  `workgraph/goal/*` and `workgraph/attention/*` host-control methods
