...
- realtime/runtime helpers: `session_realtime_attachment_status(...)`, `session_realtime_attachment_statuses(...)`, `realtime_open_info(...)`, `realtime_status(...)`, `realtime_capabilities(...)`
