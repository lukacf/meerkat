...
| `turn/interrupt` | Turn | `InterruptParams` | `Value` | Cancel in-flight turn |
...
| `workgraph/list` | WorkGraph | `WorkItemFilter` | `WorkGraphItemsResponse` | List WorkGraph items (workgraph feature) |
| `workgraph/ready` | WorkGraph | `ReadyWorkFilter` | `WorkGraphItemsResponse` | List ready WorkGraph items (workgraph feature) |
...
| `workgraph/events` | WorkGraph | `WorkGraphEventFilter` | `WorkGraphEventsResponse` | Read WorkGraph event history (workgraph feature) |
