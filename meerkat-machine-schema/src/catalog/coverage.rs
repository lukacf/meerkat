        ...
        machine_manifest_from_schema(
            ...
            &[
                ...
                scenario(
                    ...
                    "abort, wait, abort all, request cancellation at boundary, completion produced/resolved, wait all satisfied, collect completed result, recover op record, recover ops completion cursor, evict completed op, collect completed op, submit op event, notify op watcher, reject surface call, retain or evict completed terminal records",
                ),
                scenario(
