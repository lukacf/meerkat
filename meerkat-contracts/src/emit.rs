...
pub fn emit_all_schemas(output_dir: &std::path::Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let wire_types = serde_json::json!({
        ...
        "MobTemporaryCouncilRunResult": schema_for!(crate::wire::MobTemporaryCouncilRunResult),
        "MobTemporaryCouncilGetResult": schema_for!(crate::wire::MobTemporaryCouncilGetResult),
        "MobTemporaryCouncilRecoverResult": schema_for!(crate::wire::MobTemporaryCouncilRecoverResult),
        "WireTemporaryCouncilAcquisition": schema_for!(crate::wire::WireTemporaryCouncilAcquisition),
        "WireTemporaryCouncilArtifactClaim": schema_for!(crate::wire::WireTemporaryCouncilArtifactClaim),
        "WireTemporaryCouncilBounds": schema_for!(crate::wire::WireTemporaryCouncilBounds),
        "WireTemporaryCouncilCapabilityProvenance": schema_for!(crate::wire::WireTemporaryCouncilCapabilityProvenance),
        "WireTemporaryCouncilCleanup": schema_for!(crate::wire::WireTemporaryCouncilCleanup),
        "WireTemporaryCouncilCleanupDebt": schema_for!(crate::wire::WireTemporaryCouncilCleanupDebt),
        "WireTemporaryCouncilCleanupStatus": schema_for!(crate::wire::WireTemporaryCouncilCleanupStatus),
        "WireTemporaryCouncilClaimDetail": schema_for!(crate::wire::WireTemporaryCouncilClaimDetail),
        "WireTemporaryCouncilConflictDetail": schema_for!(crate::wire::WireTemporaryCouncilConflictDetail),
        "WireTemporaryCouncilDurabilityDetail": schema_for!(crate::wire::WireTemporaryCouncilDurabilityDetail),
        "WireTemporaryCouncilFailureDetail": schema_for!(crate::wire::WireTemporaryCouncilFailureDetail),
        "WireTemporaryCouncilFailureKind": schema_for!(crate::wire::WireTemporaryCouncilFailureKind),
        "WireTemporaryCouncilDeadline": schema_for!(crate::wire::WireTemporaryCouncilDeadline),
        "WireTemporaryCouncilDurability": schema_for!(crate::wire::WireTemporaryCouncilDurability),
        "WireTemporaryCouncilExchange": schema_for!(crate::wire::WireTemporaryCouncilExchange),
        "WireTemporaryCouncilExchangeOutcome": schema_for!(crate::wire::WireTemporaryCouncilExchangeOutcome),
        "WireTemporaryCouncilExitReason": schema_for!(crate::wire::WireTemporaryCouncilExitReason),
        "WireTemporaryCouncilMergeBack": schema_for!(crate::wire::WireTemporaryCouncilMergeBack),
        "WireTemporaryCouncilMergeOutcome": schema_for!(crate::wire::WireTemporaryCouncilMergeOutcome),
        "WireTemporaryCouncilMergePolicyKind": schema_for!(crate::wire::WireTemporaryCouncilMergePolicyKind),
        "WireTemporaryCouncilOwnerRoute": schema_for!(crate::wire::WireTemporaryCouncilOwnerRoute),
        "WireTemporaryCouncilParticipant": schema_for!(crate::wire::WireTemporaryCouncilParticipant),
        "WireTemporaryCouncilParticipantCustody": schema_for!(crate::wire::WireTemporaryCouncilParticipantCustody),
        "WireTemporaryCouncilParticipantProvenance": schema_for!(crate::wire::WireTemporaryCouncilParticipantProvenance),
        "WireTemporaryCouncilRecord": schema_for!(crate::wire::WireTemporaryCouncilRecord),
        "WireTemporaryCouncilRecoveryReport": schema_for!(crate::wire::WireTemporaryCouncilRecoveryReport),
        "WireTemporaryCouncilRequest": schema_for!(crate::wire::WireTemporaryCouncilRequest),
        "WireTemporaryCouncilResult": schema_for!(crate::wire::WireTemporaryCouncilResult),
        "WireTemporaryCouncilReusePolicy": schema_for!(crate::wire::WireTemporaryCouncilReusePolicy),
        "WireTemporaryCouncilScope": schema_for!(crate::wire::WireTemporaryCouncilScope),
        "WireTemporaryCouncilSelectedExchange": schema_for!(crate::wire::WireTemporaryCouncilSelectedExchange),
        "WireTemporaryCouncilSourceProvenance": schema_for!(crate::wire::WireTemporaryCouncilSourceProvenance),
        "WireTemporaryCouncilStructuredContract": schema_for!(crate::wire::WireTemporaryCouncilStructuredContract),
        "WireTemporaryCouncilStructuredContractIdentity": schema_for!(crate::wire::WireTemporaryCouncilStructuredContractIdentity),
    ...
    let params = serde_json::json!({
        ...
        "MobTemporaryCouncilRunParams": schema_for!(crate::wire::MobTemporaryCouncilRunParams),
        "MobTemporaryCouncilGetParams": schema_for!(crate::wire::MobTemporaryCouncilGetParams),
