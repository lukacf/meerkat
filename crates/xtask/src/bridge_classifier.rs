...
const BRIDGE_CLASSIFIER_FILES: [&str; 15] = [
    ...
    "crates/meerkat-mob/src/runtime/spec_compiler.rs",
    ...
    "crates/meerkat-mob/src/runtime/host_materialize.rs",
    // Member-side upcall lane (sends MemberOperatorRequest, decodes
    // MemberOperatorReply) + controlling-side upcall responder.
    "crates/meerkat-mob/src/runtime/member_upcall.rs",
    "crates/meerkat-mob/src/runtime/member_operator_forwarder.rs",
    "crates/meerkat-mob/src/runtime/upcall_responder.rs",
    ...
    "crates/meerkat-mob/src/runtime/event_pump.rs",
    "crates/meerkat-mob/src/runtime/member_history_proxy.rs",
    "crates/meerkat-mob/src/runtime/remote_flow_ticket.rs",
    // Phase-6b controlling-side live proxy (ADJ-P6B-17 consolidated lead
    // edit): decodes the four member-live BridgeReply shapes.
    "crates/meerkat-mob/src/runtime/member_live_proxy.rs",
];
