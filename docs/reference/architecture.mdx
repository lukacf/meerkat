...
Meerkat is a library-first agent runtime. The same execution substrate powers the CLI, source-built mini CLI profile, REST, JSON-RPC, mini RPC, MCP, Rust embedding, Python/TypeScript SDKs layered on top of `rkat-rpc`, and the browser/WASM runtime.
