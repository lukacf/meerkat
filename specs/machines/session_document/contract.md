...
- `ResolveRealtimeAssistantPlaybackSnapshot`(target_matches: Bool, snapshot_present: Bool, response_discarded: Bool, item_materialized: Bool, requested_lane: RealtimeTranscriptLaneKind)
...
- `ObserveLiveAssistantPlaybackSnapshot`(session_id: SessionId, channel_id: String, interaction_id: String, response_id: String, item_id: String, content_index: u64, snapshot_chars: u64, snapshot_digest: String, canonical_chars: u64, canonical_digest: String, prefix_matches_snapshot: Bool, observation_only: Bool)
...
## Effects
- `RealtimeAssistantSnapshotMaterializationAuthorized`(lane: RealtimeTranscriptLaneKind)
...
- From: `Ready`
- On: `ResolveRealtimeAssistantPlaybackSnapshot`(target_matches, snapshot_present, response_discarded, item_materialized, requested_lane)
- Guards:
  - ``
- Emits: `RealtimeAssistantSnapshotMaterializationAuthorized`
- To: `Ready`
...
- From: `Ready`
- On: `ObserveLiveAssistantPlaybackSnapshot`(session_id, channel_id, interaction_id, response_id, item_id, content_index, snapshot_chars, snapshot_digest, canonical_chars, canonical_digest, prefix_matches_snapshot, observation_only)
- Guards:
  - ``
- Emits: `LiveAssistantPlaybackTerminalResolved`
- To: `Ready`
