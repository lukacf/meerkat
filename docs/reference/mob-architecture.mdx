...
| Area | Source |
| --- | --- |
| Mob actor | `crates/meerkat-mob/src/runtime/actor.rs` |
| Mob handle | `crates/meerkat-mob/src/runtime/handle.rs` |
| Member identity | `crates/meerkat-mob/src/ids.rs` |
| Storage | `crates/meerkat-mob/src/store/` |
| Agent-facing tools | `crates/meerkat-mob-mcp/src/agent_tools.rs` |
| Supervisor bridge | `crates/meerkat-mob/src/runtime/supervisor_bridge.rs` |
| Member-host materialization | `crates/meerkat-mob/src/runtime/host_materialize.rs` |
| Host binding authority | `crates/meerkat-mob/src/machines/mob_host_binding_authority.rs` |
| Shared host acceptor | `crates/meerkat-comms/src/host_acceptor.rs` |
| Mobpack | `crates/meerkat-mob-pack/` |
