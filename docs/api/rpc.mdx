...
```json Response
{
  ...
  "result": {
    ...
    "methods": [
      ...
      "session/archive", "session/external_event", "turn/start", "turn/interrupt",
      ...
      "mob/members", "mob/spawn", "mob/retire", "mob/respawn",
      ...
      "mob/flow_status", "mob/flow_cancel", "mob/tools", "mob/call",
