            ...
            SpawnMemberSpec::new("maker", AgentIdentity::from("maker"))
                ...
                .with_additional_instructions(vec![
                    "When asked to run the generated-image comms smoke, use tools before prose. \
                     If a user says 'Turn 1', your only valid tool action is one generate_image tool call; \
                     after that tool returns, reply exactly MAKER-GENERATED-IMAGE-TURN1-DONE. \
    ...
    maker
        .send(
            ...
            "Turn 1 of the generated-image comms smoke. \
             ...
             quality low, format png, count 1. After the tool returns, reply exactly \
