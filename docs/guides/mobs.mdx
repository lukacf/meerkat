...
A **mob** is a team of agents that work together. Each agent has a role (profile), agents communicate over signed channels (wiring), and work is coordinated through declarative flows (DAGs). Mobs are Meerkat's answer to "how do I build a system with more than one agent?"
