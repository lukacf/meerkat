...
fn suite_spec(name: &str) -> Option<&'static Spec> {
    match name {
        ...
        "surface-rkat-rpc-deterministic" => Some(&Spec {
            id: None,
            lane: Lane::Build,
            title: "Build lane: rkat-rpc deterministic runtime-backed ingress",
            timeout_secs: 600,
            required_env: &[],
            required_bins: &["cargo"],
            cwd: ".",
            ...
            command: CommandSpec::Raw {
                argv: &[
                    ...
                    "meerkat-rpc",
                    "--test",
                    "runtime_backed_ingress",
                    "runtime_backed_ingress_red_ok_rpc_session_create_and_turn_start_roundtrip",
                    "--",
                    "--ignored",
                    "--nocapture",
                ],
        ...
        "surface-rkat-rest-deterministic" => Some(&Spec {
            id: None,
            lane: Lane::Build,
            title: "Build lane: rkat-rest deterministic resume metadata",
            timeout_secs: 600,
            required_env: &[],
            required_bins: &["cargo"],
            cwd: ".",
            ...
            command: CommandSpec::Raw {
                argv: &[
                    ...
                    "--test",
                    "system_rest_resume",
                    "integration_real_rest_resume_metadata",
                    "--",
                    "--ignored",
                    "--nocapture",
                ],
        ...
        "surface-rkat-mcp-deterministic" => Some(&Spec {
            id: None,
            lane: Lane::Build,
            title: "Build lane: rkat-mcp deterministic run/resume",
            timeout_secs: 600,
            required_env: &[],
            required_bins: &["cargo"],
            cwd: ".",
            ...
            command: CommandSpec::Raw {
                argv: &[
                    ...
                    "--test",
                    "runtime_backed_ingress",
                    "runtime_backed_ingress_red_ok_mcp_run_and_resume_reuse_the_same_runtime_session",
                    "--",
                    "--ignored",
                    "--nocapture",
                ],
